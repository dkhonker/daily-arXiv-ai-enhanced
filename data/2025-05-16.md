...
### [46] [Next Word Suggestion using Graph Neural Network](https://arxiv.org/abs/2505.09649)
*Abisha Thapa Magar,Anup Shakya*

Main category: cs.CL

TL;DR: This project proposes an approach using Graph Convolution operation in GNNs for context embedding to predict the next word in language modeling. It was tested on a custom Wikipedia text corpus with limited resources and showed good performance.


<details>
  <summary>Details</summary>
Motivation: To address an important sub-task in language modeling, i.e., context embedding, with a more cost-effective method compared to massive models with billions of parameters.

Method: Using Graph Convolution operation in GNNs to encode the context and use it in coalition with LSTMs to predict the next word.

Result: The approach worked fairly well to predict the next word when tested on the custom Wikipedia text corpus.

Conclusion: This project demonstrates that the proposed approach can be a cost-effective alternative for context embedding in language modeling.
...
### [47] [DRA-GRPO: Exploring Diversity-Aware Reward Adjustment for R1-Zero-Like Training of Large Language Models](https://arxiv.org/abs/2505.09655)
*Xiwen Chen,Wenhui Zhu,Peijie Qiu,Xuanzhao Dong,Hao Wang,Haiyu Wu,Huayu Li,Aristeidis Sotiras,Yalin Wang,Abolfazl Razi*

Main category: cs.CL

TL;DR: This paper introduces Diversity-aware Reward Adjustment (DRA) to improve the performance of reinforcement learning methods like GRPO and DR. GRPO by incorporating semantic diversity into reward computation, achieving state-of-the-art results on mathematical reasoning benchmarks.


<details>
  <summary>Details</summary>
Motivation: To address the diversity-quality inconsistency issue in existing reinforcement learning methods for language model post-training.

Method: Proposes Diversity-aware Reward Adjustment (DRA) which uses Submodular Mutual Information (SMI) to adjust rewards based on semantic diversity.

Result: Improves performance on five mathematical reasoning benchmarks, achieving 58.2% average accuracy with limited resources.

Conclusion: DRA can be seamlessly integrated with GRPO and DR. GRPO, leading to enhanced performance in low-resource settings.
...
### [48] [Large Language Models Are More Persuasive Than Incentivized Human Persuaders](https://arxiv.org/abs/2505.09662)
*Philipp Schoenegger,Francesco Salvi,Jiacheng Liu,Xiaoli Nan,Ramit Debnath,Barbara Fasolo,Evelina Leivada,Gabriel Recchia,Fritz Günther,Ali Zarifhonarvar,Joe Kwon,Zahoor Ul Islam,Marco Dehnert,Daryl Y. H. Lee,Madeline G. Reinecke,David G. Kamper,Mert Kobaş,Adam Sandford,Jonas Kgomo,Luke Hewitt,Shreya Kapoor,Kerem Oktar,Eyup Engin Kucuk,Bo Feng,Cameron R. Jones,Izzy Gainsburg,Sebastian Olschewski,Nora Heinzelmann,Francisco Cruz,Ben M. Tappin,Tao Ma,Peter S. Park,Rayan Onyonka,Arthur Hjorth,Peter Slattery,Qingcheng Zeng,Lennart Finke,Igor Grossmann,Alessandro Salatiello,Ezra Karger*

Main category: cs.CL

TL;DR: This study compares the persuasion skills of a large language model (Claude Sonnet 3.5) with incentivized human persuaders using an interactive quiz. It shows that the LLM outperforms humans in both truthful and deceptive persuasion, improving or worsening quiz takers' accuracy accordingly.


<details>
  <summary>Details</summary>
Motivation: To investigate whether AI has surpassed human persuasion abilities in various contexts.

Method: Preregistered, large-scale incentivized experiment involving quiz takers and persuaders (humans or LLMs).

Result: LLM persuaders achieved higher compliance rates than humans in both truthful and deceptive persuasion. They improved quiz takers' accuracy when steering towards correct answers and decreased it when steering towards incorrect ones.

Conclusion: AI's persuasion capabilities already exceed those of humans with financial incentives, emphasizing the need for new alignment and governance frameworks.
...
### [49] [System Prompt Optimization with Meta-Learning](https://arxiv.org/abs/2505.09666)
*Yumin Choi,Jinheon Baek,Sung Ju Hwang*

Main category: cs.CL

TL;DR: This paper introduces the problem of bilevel system prompt optimization for Large Language Models, proposing a meta-learning framework to optimize system prompts that are robust and transferable. Experiments show the approach generalizes well to diverse user prompts and enables rapid adaptation to unseen tasks.


<details>
  <summary>Details</summary>
Motivation: Existing prompt optimization work has focused on user prompts, neglecting the system prompt which is applicable across different tasks and domains. This paper aims to address this gap.

Method: A meta-learning framework is proposed that optimizes the system prompt over various user prompts across multiple datasets, while iteratively updating the user prompts for synergy.

Result: The approach shows effective generalization to diverse user prompts and enables rapid adaptation to unseen tasks with improved performance.

Conclusion: The proposed method demonstrates the importance of optimizing system prompts and its potential for improving LLMs' performance across tasks and domains.
...
### [50] [VeriFact: Enhancing Long-Form Factuality Evaluation with Refined Fact Extraction and Reference Facts](https://arxiv.org/abs/2505.09701)
*Xin Liu,Lechen Zhang,Sheza Munir,Yiyang Gu,Lu Wang*

Main category: cs.CL

TL;DR: VeriFact is a new method for checking if large language models produce factual information correctly, focusing on both what's right and what's missed in their long answers.


<details>
  <summary>Details</summary>
Motivation: Existing methods struggle to evaluate the factuality of long text outputs from large language models because they often miss important context or relationships between facts.

Method: VeriFact improves fact extraction by identifying and fixing incomplete or missing facts, leading to better verification outcomes.

Result: Tests show VeriFact improves fact completeness and retains complex relational facts, making evaluations more accurate. A new benchmark, FactRBench, reveals that while bigger models tend to be more precise and recall facts better, high precision doesn't guarantee good recall.

Conclusion: VeriFact and FactRBench highlight the need for comprehensive factuality checks in evaluating large language models.
...
### [51] [An AI-Powered Research Assistant in the Lab: A Practical Guide for Text Analysis Through Iterative Collaboration with LLMs](https://arxiv.org/abs/2505.09724)
*Gino Carmona-Díaz,William Jiménez-Leal,María Alejandra Grisales,Chandra Sripada,Santiago Amaya,Michael Inzlicht,Juan Pablo Bermúdez*

Main category: cs.CL

TL;DR: This paper provides a step-by-step tutorial on using LLMs to create and apply taxonomies for analyzing unstructured data, demonstrating the process with personal goals as an example.


<details>
  <summary>Details</summary>
Motivation: Text analysis is time-consuming and prone to bias, but LLMs can be used to improve efficiency and quality.

Method: Developing, testing, and applying taxonomies through an iterative and collaborative process between researchers and LLMs.

Result: The authors demonstrate the process using personal goals as an example, showing how to review datasets, generate a taxonomy, refine it, test it, and apply it with high intercoder reliability.

Conclusion: LLMs are promising tools for text analysis, but their use has limitations that need to be considered.
...
### [52] [Achieving Tokenizer Flexibility in Language Models through Heuristic Adaptation and Supertoken Learning](https://arxiv.org/abs/2505.09738)
*Shaurya Sharthak,Vinayak Pahalwan,Adithya Kamath,Adarsh Shirawalmath*

Main category: cs.CL

TL;DR: Pretrained language models (LLMs) face inefficiencies due to fixed tokenization schemes, especially in multilingual or specialized contexts. This study introduces Tokenadapt, a model-agnostic method for tokenizer transplantation, and Supertokens for enhanced compression. Tokenadapt uses a hybrid heuristic combining local and global estimates to initialize unique token embeddings, reducing retraining needs while preserving semantics. Experiments show Tokenadapt outperforms other methods in perplexity reduction.


<details>
  <summary>Details</summary>
Motivation: The inefficiencies and performance limitations of LLMs caused by fixed tokenization schemes, especially in multilingual or specialized applications.

Method: Tokenadapt, a model-agnostic tokenizer transplantation method, and pre-tokenization learning for multi-word Supertokens.

Result: Tokenadapt successfully initializes unique tokens, outperforming conventional and sophisticated methods. Supertokens achieve notable compression gains. TokenAdapt reduces perplexity ratios significantly compared to baselines.

Conclusion: Tokenadapt effectively addresses tokenizer lock-in issues, minimizing retraining requirements while preserving semantic nuances and enhancing compression efficiency.
...
### [53] [Automated Detection of Clinical Entities in Lung and Breast Cancer Reports Using NLP Techniques](https://arxiv.org/abs/2505.09794)
*J. Moreno-Casanova,J. M. Auñón,A. Mártinez-Pérez,M. E. Pérez-Martínez,M. E. Gas-López*

Main category: cs.CL

TL;DR: This study investigates the application of NLP techniques to automate the extraction of relevant data from electronic health records for lung and breast cancer.
...
Method: Utilized GMV's NLP tool uQuery and fine-tuned the bsc-bio-ehr-en3 model to perform Named Entity Recognition (NER) on a dataset of 200 annotated breast cancer and 400 lung cancer reports.

Result: The results showed strong overall performance in identifying entities like MET and PAT, but there were challenges with less frequent entities like EVOL.

Conclusion: This study demonstrates the potential of NLP techniques in enhancing the accuracy and efficiency of data extraction from EHRs for lung and breast cancer.
...
### [54] [Exploring the generalization of LLM truth directions on conversational formats](https://arxiv.org/abs/2505.09807)
*Timour Ichmoukhamedov,David Martens*

Main category: cs.CL

TL;DR: LLMs have a universal truth direction where true and false statements are linearly separable. This study explores the generalization of this truth direction between different conversational formats.


<details>
  <summary>Details</summary>
Motivation: To investigate the generalization of the truth direction in LLMs across different conversational formats.

Method: The researchers analyzed short and long conversations where lies were present and tested the generalization of linear probes trained on a single hidden state.

Result: Good generalization was found between short conversations ending with a lie, but poor generalization was observed in longer formats where the lie appeared earlier in the input prompt.

Conclusion: Adding a fixed key phrase at the end of each conversation can significantly improve the generalization of LLM lie detectors.
...
### [55] [KRISTEVA: Close Reading as a Novel Task for Benchmarking Interpretive Reasoning](https://arxiv.org/abs/2505.09825)
*Peiqi Sui,Juan Diego Rodriguez,Philippe Laban,Dean Murphy,Joseph P. Dexter,Richard Jean So,Samuel Baker,Pramit Chaudhuri*

Main category: cs.CL

TL;DR: 首次推出KRISTEVA，这是一个评估文学解读推理的新基准，发现当前最先进的LLMs在文学理解与推理上虽有一定能力，但仍逊色于人类评估者。


<details>
  <summary>Details</summary>
Motivation: 虽然细读被认为是批判性思维的基础，并且广泛作为大学课程的必要组成部分被采用，但它从未在大型语言模型上进行过评估，而多学科基准如MMLU也不包括文学作为主题。

Method: 提出并测试了KRISTEVA，这是一个由1331个多项选择题组成的细读基准，这些题目改编自课堂数据，并提出了三个逐步更困难的任务集来模拟细读过程的不同元素。

Result: 基线结果显示，最先进的LLMs在我们11项任务中的10项上的表现仍然落后于有经验的人类评估者，准确率在49.7%到69.7%之间。

Conclusion: 尽管最先进的大型语言模型（LLMs）在文学作品的理解和推理方面展现出了某些大学水平的细读能力，但它们的表现仍落后于有经验的人类评估者。
...
### [56] [Do Large Language Models Know Conflict? Investigating Parametric vs. Non-Parametric Knowledge of LLMs for Conflict Forecasting](https://arxiv.org/abs/2505.09852)
*Apollinaire Poli Nemkova,Sarath Chandra Lingareddy,Sagnik Ray Choudhury,Mark V. Albert*

Main category: cs.CL

TL;DR: Large Language Models (LLMs) were explored for predicting violent conflict escalation and fatalities using only pretrained weights or with additional external data. The study found that while LLMs have some predictive power based on pretrained knowledge, incorporating current, structured information improves forecasting accuracy.


<details>
  <summary>Details</summary>
Motivation: The ability of LLMs to predict violent conflict has been underexplored despite their success in natural language tasks. This knowledge could be crucial for early warning systems, humanitarian planning, and policy-making.

Method: Two settings were compared: parametric (relying solely on pretrained weights) and non-parametric (using external data like conflict datasets and recent news via RAG). A two-part evaluation framework was used spanning 2020-2024 across conflict-prone regions.

Result: LLMs showed some capability to predict conflict trends and fatalities using only pretrained knowledge, but performance improved significantly when supplemented with external, structured information.

Conclusion: LLMs can utilize parametric knowledge for conflict prediction, but adding external context enhances their effectiveness.
...
### [57] [Crossing Borders Without Crossing Boundaries: How Sociolinguistic Awareness Can Optimize User Engagement with Localized Spanish AI Models Across Hispanophone Countries](https://arxiv.org/abs/2505.09902)
*Martin Capdevila,Esteban Villa Turek,Ellen Karina Chumbe Fernandez,Luis Felipe Polo Galvez,Luis Cadavid,Andrea Marroquin,Rebeca Vargas Quesada,Johanna Crew,Nicole Vallejo Galarraga,Christopher Rodriguez,Diego Gutierrez,Radhi Datla*

Main category: cs.CL

TL;DR: This paper argues for the importance of region-specific large language models for Spanish, highlighting significant differences in written Spanish across regions that create sociolinguistic barriers. It suggests that locale-sensitive AI models can bridge these gaps and improve inclusivity and user growth.


<details>
  <summary>Details</summary>
Motivation: To emphasize the critical need for regional localized models due to significant differences in written Spanish across regions causing sociolinguistic dissonances.

Method: Examining primary differences between variants of written Spanish across Latin America and Spain with sociocultural and linguistic contextualization.

Result: Locale-sensitive AI models would play a pivotal role in bridging sociolinguistic divides and inform better localization strategies.

Conclusion: Implementing at least five sub-variants of Spanish addresses user trust, reliance on AI models, and reflects cultural awareness positively.
...
### [58] [From Trade-off to Synergy: A Versatile Symbiotic Watermarking Framework for Large Language Models](https://arxiv.org/abs/2505.09924)
*Yidan Wang,Yubing Ren,Yanan Cao,Binxing Fang*

Main category: cs.CL

TL;DR: We propose a versatile symbiotic watermarking framework with three strategies: serial, parallel, and hybrid, which adaptively embeds watermarks to optimize the balance between detectability, robustness, text quality, and security.


<details>
  <summary>Details</summary>
Motivation: Concerns about the misuse of AI-generated text make watermarking a promising solution.

Method: Integrating logits-based and sampling-based schemes, we propose a symbiotic watermarking framework with three strategies: serial, parallel, and hybrid, which uses token entropy and semantic entropy to adaptively embed watermarks.

Result: Our method outperforms existing baselines and achieves state-of-the-art (SOTA) performance.

Conclusion: This framework provides novel insights into diverse watermarking paradigms.
...
### [59] [Rethinking Prompt Optimizers: From Prompt Merits to Optimization](https://arxiv.org/abs/2505.09930)
*Zixiao Zhu,Hanzhang Zhou,Zijian Feng,Tianjiao Li,Chua Jia Jim Deryl,Mak Lee Onn,Gee Wah Ng,Kezhi Mao*

Main category: cs.CL

TL;DR: MePO是一种基于解释性设计的轻量级本地可部署提示优化器，通过学习明确且可解释的优点，在各种任务和模型类型上实现了更好的结果。


<details>
  <summary>Details</summary>
Motivation: 现有的提示优化方法通常依赖于高级大型语言模型（如GPT-4）来生成优化提示，但这些提示可能无法很好地适应轻量级推理模型。

Method: MePO通过识别一组与模型无关的提示质量优点并训练在由轻量级LLM生成的与优点对齐的提示构建的偏好数据集上来实现提示优化。

Result: 实验表明，MePO在不同任务和模型类型上都取得了更好的结果。

Conclusion: MePO提供了一种可扩展且健壮的解决方案，用于实际部署，同时避免了在线优化的依赖，降低了成本和隐私问题。
...
### [60] [Interim Report on Human-Guided Adaptive Hyperparameter Optimization with Multi-Fidelity Sprints](https://arxiv.org/abs/2505.09792)
*Michael Kamfonas*

Main category: cs.CL

TL;DR: This case study compares different multitask natural language model variants using a phased hyperparameter optimization process with learning rate scheduling and optimizer parameter grouping.


<details>
  <summary>Details</summary>
Motivation: To optimize hyperparameters efficiently and improve the performance of multitask natural language models.

Method: A phased hyperparameter optimization process with multi-fidelity, hyperparameter space pruning, progressive halving, and human guidance.

Result: Efficient low-fidelity sprints were used to prune the hyperparameter space, followed by subsequent sprints that increased model fidelity and employed hyperband pruning.

Conclusion: The proposed method can be applied to various variants of the 2021 Joint Entity and Relation Extraction model.
...
### [61] [Personalizing Large Language Models using Retrieval Augmented Generation and Knowledge Graph](https://arxiv.org/abs/2505.09945)
*Deeksha Prahlad,Chanhee Lee,Dongha Kim,Hokeun Kim*

Main category: cs.CL

TL;DR: This paper introduces an approach using retrieval augmented generation (RAG) with knowledge graphs (KGs) to improve personalized response generation in large language models (LLMs), focusing on calendar data, which shows better understanding of personal information and more accurate responses than baseline LLMs.


<details>
  <summary>Details</summary>
Motivation: To address the problem of overfitting and hallucination in LLMs due to lack of timely, factual, and personalized information.

Method: Introducing retrieval augmented generation (RAG) using knowledge graphs (KGs) to assist LLMs in personalized response generation.

Result: Our approach shows significantly better understanding of personal information and generates more accurate responses compared to baseline LLMs using personal data as text inputs, with a moderate reduction in response time.

Conclusion: The proposed method effectively improves personalized response generation in LLMs by incorporating KGs.
...
### [62] [DIF: A Framework for Benchmarking and Verifying Implicit Bias in LLMs](https://arxiv.org/abs/2505.10013)
*Lake Yin,Fan Huang*

Main category: cs.CL

TL;DR: This paper introduces DIF (Demographic Implicit Fairness), a method to evaluate the implicit bias in Large Language Models (LLMs) using sociodemographic personas.


<details>
  <summary>Details</summary>
Motivation: Concern over potential biases in LLMs inherited from training data, especially implicit bias which affects their ability to handle extraneous information.

Method: Developing a benchmark method named DIF to statistically validate implicit bias in LLMs by analyzing existing logic and math problem datasets with sociodemographic personas.

Result: DIF method successfully demonstrates an inverse relationship between question answering accuracy and implicit bias in LLMs.

Conclusion: Implicit bias in LLMs is both an ethical and technical issue, and the newly proposed DIF benchmark can help in validating and understanding this bias.
...
### [63] [CAFE: Retrieval Head-based Coarse-to-Fine Information Seeking to Enhance Multi-Document QA Capability](https://arxiv.org/abs/2505.10063)
*Han Peng,Jinhao Jiang,Zican Dong,Wayne Xin Zhao,Lei Fang*

Main category: cs.CL

TL;DR: A new method called CAFE is introduced to improve multi-document question-answering by using a two-stage approach that refines document selection.


<details>
  <summary>Details</summary>
Motivation: Existing LLMs struggle with retrieval and reasoning in long-context inputs despite using prompt strategies and retrieval heads.

Method: Two-stage coarse-to-fine method: coarse-grained filtering and fine-grained steering.

Result: CAFE improves performance significantly, with up to 22.1% and 13.7% SubEM improvements over SFT and RAG methods respectively.

Conclusion: The proposed CAFE method effectively enhances multi-document question-answering capabilities by reducing reliance on irrelevant documents.
...
### [64] [Dark LLMs: The Growing Threat of Unaligned AI Models](https://arxiv.org/abs/2505.10066)
*Michael Fire,Yitzhak Elbazis,Adi Wasenstein,Lior Rokach*

Main category: cs.CL

TL;DR: Jailbreaking poses a significant threat to large language models (LLMs), which can be exploited to produce harmful outputs, despite safety controls. A universal jailbreak attack compromising several state-of-the-art models has been identified, yet many remain vulnerable.


<details>
  <summary>Details</summary>
Motivation: To investigate the growing threat of dark LLMs and deliberate jailbreak techniques that bypass ethical guardrails.

Method: Uncovered a universal jailbreak attack that compromises multiple models, enabling them to answer any question and produce harmful outputs upon request.

Result: Many tested LLMs were still vulnerable to the attack even after its publication. Industry responses to responsible disclosures were often inadequate, showing a gap in AI safety practices.

Conclusion: LLMs are susceptible to jailbreaking due to unfiltered training data. Without intervention, the risk of misuse will increase with more accessible and cheaper model training.
...
### [65] [Designing and Contextualising Probes for African Languages](https://arxiv.org/abs/2505.10081)
*Wisdom Aduah,Francois Meyer*

Main category: cs.CL

TL;DR: This paper presents the first systematic investigation into probing pretrained language models for linguistic knowledge about African languages.


<details>
  <summary>Details</summary>
Motivation: To understand the reasons behind the continuous improvement of pretrained language models for African languages.
...
Result: PLMs adapted for African languages encode more linguistic information about target languages than massively multilingual PLMs. Token-level syntactic information concentrates in middle-to-last layers, while sentence-level semantic information is distributed across all layers. Performance reflects the internal knowledge of PLMs rather than probe memorisation.

Conclusion: Our study applies established interpretability techniques to African-language PLMs and highlights the internal mechanisms underlying the success of strategies like active learning and multilingual adaptation.
...
### [66] [XRAG: Cross-lingual Retrieval-Augmented Generation](https://arxiv.org/abs/2505.10089)
*Wei Liu,Sony Trenous,Leonardo F. R. Ribeiro,Bill Byrne,Felix Hieber*

Main category: cs.CL

TL;DR: A new benchmark called XRAG is proposed to assess the cross-lingual Retrieval-Augmented Generation (RAG) abilities of large language models (LLMs). XRAG is constructed from recent news articles and includes relevancy annotations for each retrieved document. The dataset's construction pipeline results in questions requiring complex reasoning.


<details>
  <summary>Details</summary>
Motivation: To evaluate the cross-lingual RAG abilities of LLMs in situations where the user language differs from the retrieval results.

Method: Constructing a new benchmark named XRAG from recent news articles.

Result: XRAG reveals two challenges in cross-lingual RAG: maintaining response language correctness in monolingual retrieval and reasoning across languages in multilingual retrieval.

Conclusion: XRAG serves as a valuable benchmark for studying LLM reasoning abilities in cross-lingual RAG settings.
...
### [67] [What Does Neuro Mean to Cardio? Investigating the Role of Clinical Specialty Data in Medical LLMs](https://arxiv.org/abs/2505.10113)
*Xinlan Yan,Di Wu,Yibin Lei,Christof Monz,Iacer Calixto*

Main category: cs.CL

TL;DR: This paper presents S-MedQA, an English medical QA dataset, and evaluates the effectiveness of knowledge injection in medical QA using large language models.


<details>
  <summary>Details</summary>
Motivation: To benchmark large language models in fine-grained clinical specialties and test a popular hypothesis related to knowledge injection in medical QA.

Method: Training large language models on S-MedQA and analyzing their performance on different specialties.

Result: Training on a specialty data does not guarantee best performance on that specialty, and token probabilities of clinically relevant terms increase consistently regardless of the specialty fine-tuned on.

Conclusion: Improvement gains in medical QA mostly come from domain shifting rather than knowledge injection, suggesting a need to rethink the role of fine-tuning data in the medical domain.
...
### [68] [GE-Chat: A Graph Enhanced RAG Framework for Evidential Response Generation of LLMs](https://arxiv.org/abs/2505.10143)
*Longchao Da,Parth Mitesh Shah,Kuan-Ru Liou,Jiaxing Zhang,Hua Wei*

Main category: cs.CL

TL;DR: GE-Chat, a knowledge Graph enhanced retrieval-augmented generation framework, provides evidence-based response generation for Large Language Models.


<details>
  <summary>Details</summary>
Motivation: To address the problem of LLMs making mistakes and generating hallucinated responses, which creates complications and raises trust issues among users.

Method: Create a knowledge graph from uploaded material documents, enhance the agent's responses with additional knowledge, and use Chain-of-Thought logic generation, n-hop sub-graph searching, and entailment-based sentence generation to realize accurate evidence retrieval.

Result: The proposed method improves the existing models' performance in identifying the exact evidence in a free-form context.

Conclusion: GE-Chat provides a reliable way to examine the resources of LLM's conclusion and help with the judgment of the trustworthiness.
...
### [69] [Mining Hidden Thoughts from Texts: Evaluating Continual Pretraining with Synthetic Data for LLM Reasoning](https://arxiv.org/abs/2505.10182)
*Yoichi Ishibashi,Taro Yano,Masafumi Oyamada*

Main category: cs.CL

TL;DR: This study evaluates Reasoning CPT, which uses synthetic data to reconstruct hidden thought processes, showing consistent performance improvement across domains, especially on challenging problems.
...
Result: Performance improvement across all evaluated domains, effective transfer of reasoning skills across domains, performance gap with conventional methods widens as problem difficulty increases, gains of up to 8 points on the most challenging problems, and models trained with hidden thoughts learn to adjust the depth of their reasoning according to problem difficulty.

Conclusion: Reasoning CPT consistently improves performance across all evaluated domains.
...
### [70] [The CoT Encyclopedia: Analyzing, Predicting, and Controlling how a Reasoning Model will Think](https://arxiv.org/abs/2505.10185)
*Seongyun Lee,Seungone Kim,Minju Seo,Yongrae Jo,Dongyoung Go,Hyeonbin Hwang,Jinho Park,Xiang Yue,Sean Welleck,Graham Neubig,Moontae Lee,Minjoon Seo*

Main category: cs.CL

TL;DR: Analyze model reasoning through the CoT Encyclopedia, which extracts reasoning criteria from model-generated CoTs, clusters them into categories, and demonstrates its application in predicting and guiding model reasoning strategies.


<details>
  <summary>Details</summary>
Motivation: Understand the reasoning strategies underlying the effective usage of modern large language models.

Method: Introduce the CoT Encyclopedia, a bottom-up framework that automatically extracts, embeds, clusters reasoning criteria, and derives contrastive rubrics.

Result: Produces more interpretable and comprehensive analyses than existing methods and shows that training data format impacts reasoning behavior more than data domain.

Conclusion: This understanding allows performance gains by predicting and guiding model reasoning strategies, emphasizing the importance of format-aware model design.
...
### [71] [VQ-Logits: Compressing the Output Bottleneck of Large Language Models via Vector Quantized Logits](https://arxiv.org/abs/2505.10202)
*Jintian Shao,Hongyi Huang,Jiayi Wu,YiMing Cheng,ZhiYu Wu,You Shan,MingKai Zheng*

Main category: cs.CL

TL;DR: Propose VQ-Logits, a novel approach that leverages Vector Quantization (VQ) to drastically reduce the parameter count and computational load of the LLM output layer.


<details>
  <summary>Details</summary>
Motivation: Reduce the parameter count and computational load of the LLM output layer.

Method: Leveraging Vector Quantization (VQ) to replace the large V * dmodel output embedding matrix with a small, shared codebook of K embedding vectors.

Result: Up to 99% parameter reduction in the output layer and 6x speedup in logit computation, with only a marginal 4% increase in perplexity compared to full softmax baselines.

Conclusion: VQ-Logits can achieve up to 99% parameter reduction in the output layer and 6x speedup in logit computation.
...
### [72] [RAIDEN-R1: Improving Role-awareness of LLMs via GRPO with Verifiable Reward](https://arxiv.org/abs/2505.10218)
*Zongsheng Wang,Kaili Sun,Bowen Wu,Qun Yu,Ying Li,Baoxun Wang*

Main category: cs.CL

TL;DR: This paper presents RAIDEN-R1, a new reinforcement learning framework with Verifiable Role-Awareness Reward for role-playing conversational agents to maintain role consistency. It also builds a high-quality dataset via multi-LLM collaboration and shows superior performance.


<details>
  <summary>Details</summary>
Motivation: To solve the problem of maintaining role consistency in role-playing conversational agents.

Method: Integrates Verifiable Role-Awareness Reward (VRAR) and introduces singular and multi-term mining strategies. Constructs a high-quality dataset through multi-LLM collaboration.

Result: The 14B-GRPO model achieved 88.04% and 88.65% accuracy on Script-Based Knowledge and Conversation Memory metrics respectively, outperforming baseline models.

Conclusion: This work fills the non-quantifiability gap in RPCA training and provides insights into role-aware reasoning patterns.
...
### [73] [Comparing LLM Text Annotation Skills: A Study on Human Rights Violations in Social Media Data](https://arxiv.org/abs/2505.10260)
*Poli Apollinaire Nemkova,Solomon Ubani,Mark V. Albert*

Main category: cs.CL

TL;DR: 研究评估了多个顶级大型语言模型在多语言人权侵害文本识别任务中的表现，强调了模型的可靠性、适用性以及跨语言处理能力的重要性。


<details>
  <summary>Details</summary>
Motivation: 随着自然语言处理系统变得越来越复杂，大型语言模型展现出在各种应用中的巨大潜力，特别是那些需要细致文本理解和上下文推理的任务。本研究旨在探索这些模型在多语言背景下处理敏感、特定领域任务的能力，尤其是对于涉及人权侵害的文本内容识别任务。

Method: 使用GPT-3.5、GPT-4、LLAMA3、Mistral 7B和Claude-2等最先进的大型语言模型对包含俄语和乌克兰语社交媒体帖子的复杂文本数据集进行零样本和少量样本标注。评估模型在不同提示条件下（英文和俄文提示）的表现，并分析模型间的错误模式和分歧。

Result: 研究发现，不同模型在处理俄语和乌克兰语数据时表现出不同的性能水平和错误模式。某些模型在特定语言提示下表现更好，而其他模型则显示出较强的跨语言适应能力。所有模型的性能都通过与人工标注的黄金标准进行比较来量化。

Conclusion: 研究对比了多种最先进的大型语言模型在处理多语言复杂文本数据集中的表现，特别是在识别涉及人权侵害的引用这一二元分类任务上的表现。通过与人工标注的黄金标准进行比较，揭示了这些模型在不同提示条件下的性能，并分析了它们的错误模式和分歧情况，这为理解大型语言模型在多语言敏感领域任务中的可靠性和适用性提供了重要见解。
...
### [74] [The Evolving Landscape of Generative Large Language Models and Traditional Natural Language Processing in Medicine](https://arxiv.org/abs/2505.10261)
*Rui Yang,Huitao Li,Matthew Yu Heng Wong,Yuhe Ke,Xin Li,Kunyu Yu,Jingchi Liao,Jonathan Chong Kai Liew,Sabarinath Vinod Nair,Jasmine Chiat Ling Ong,Irene Li,Douglas Teodoro,Chuan Hong,Daniel Shu Wei Ting,Nan Liu*

Main category: cs.CL

TL;DR: This study analyzes 19,123 studies on the application of natural language processing (NLP) and generative large language models (LLMs) in medicine, revealing that generative LLMs excel in open-ended tasks whereas traditional NLP outperforms in information extraction and analysis tasks.


<details>
  <summary>Details</summary>
Motivation: To explore the differences between NLP and generative LLMs across various medical tasks.

Method: Analyzed 19,123 studies.
...
Conclusion: Ethical use of these technologies is crucial for realizing their potential in medical applications.
...
### [75] [From Questions to Clinical Recommendations: Large Language Models Driving Evidence-Based Clinical Decision Making](https://arxiv.org/abs/2505.10282)
*Dubai Li,Nan Jiang,Kangping Huang,Ruiqi Tu,Shuyu Ouyang,Huayu Yu,Lin Qiao,Chen Yu,Tianshu Zhou,Danyang Tong,Qian Wang,Mengtao Li,Xiaofeng Zeng,Yu Tian,Xinping Tian,Jingsong Li*

Main category: cs.CL

TL;DR: This study introduces Quicker, an evidence-based clinical decision support system using large language models to automate evidence synthesis and generate clinical recommendations.


<details>
  <summary>Details</summary>
Motivation: Clinical evidence integration into real-time practice is challenging due to workload, complexity, and time constraints.

Method: Quicker automates evidence synthesis and generates recommendations modeled after clinical guideline processes.

Result: Quicker showed strong performance in question decomposition, retrieval sensitivity, literature screening, and evidence assessment, reducing recommendation development time.

Conclusion: Quicker has the potential to assist physicians in making quicker and more reliable evidence-based clinical decisions.
...
### [76] [J1: Incentivizing Thinking in LLM-as-a-Judge via Reinforcement Learning](https://arxiv.org/abs/2505.10320)
*Chenxi Whitehouse,Tianlu Wang,Ping Yu,Xian Li,Jason Weston,Ilia Kulikov,Swarnadeep Saha*

Main category: cs.CL

TL;DR: A reinforcement learning approach named J1 is introduced to train LLM-as-a-Judge models for better evaluation.


<details>
  <summary>Details</summary>
Motivation: To improve the judgment ability of AI models through stronger chain-of-thought reasoning.

Method: Converting prompts to judgment tasks with verifiable rewards using reinforcement learning.

Result: J1 outperforms other existing models of similar size and even some larger models on certain benchmarks.

Conclusion: Training LLM-as-a-Judge models with reinforcement learning can lead to improved judgment ability.
...
### [77] [LDIR: Low-Dimensional Dense and Interpretable Text Embeddings with Relative Representations](https://arxiv.org/abs/2505.10354)
*Yile Wang,Zhanyu Shen,Hui Huang*

Main category: cs.CL

TL;DR: 提出一种低维密集且可解释的文本嵌入方法（LDIR），该方法通过最远点采样生成相对表示，数值维度值表示与不同锚文本的语义相关性，在多个语义文本相似度、检索和聚类任务上验证了其性能，接近黑盒基准模型且优于其他可解释嵌入基准模型。


<details>
  <summary>Details</summary>
Motivation: 现有的文本嵌入方法虽然表现出色，但维度值难以追溯和解释；稀疏可解释嵌入表现不佳；Benara等人的方法虽提供可解释性，但维度较高。因此，需要一种低维、密集且可解释的文本嵌入方法。

Method: 提出LDIR方法，利用最远点采样的相对表示，使维度数值指示与不同锚文本的语义相关性。

Result: 在多个任务上验证了LDIR的有效性，其性能接近黑盒基准模型，并且优于其他可解释嵌入基准模型，同时具有更少的维度。

Conclusion: 提出的LDIR方法在保持高性能的同时实现了低维度和可解释性，展示了在自然语言处理中的潜力。
...
### [78] [Coherent Language Reconstruction from Brain Recordings with Flexible Multi-Modal Input Stimuli](https://arxiv.org/abs/2505.10356)
*Chunyu Ye,Shaonan Wang*

Main category: cs.CL

TL;DR: A new method for reconstructing coherent language from brain recordings elicited by diverse input modalities.


<details>
  <summary>Details</summary>
Motivation: Human thought is inherently multimodal, but previous studies on decoding thoughts from brain activity were limited to single-modality inputs.

Method: Proposes a unified and flexible framework that uses modality-specific experts to jointly interpret information across modalities based on visual-language models.

Result: Achieves performance comparable to state-of-the-art systems while remaining adaptable and extensible.

Conclusion: This work advances toward more ecologically valid and generalizable mind decoding.
...
### [79] [Multi-domain Multilingual Sentiment Analysis in Industry: Predicting Aspect-based Opinion Quadruples](https://arxiv.org/abs/2505.10389)
*Benjamin White,Anastasia Shimorina*

Main category: cs.CL

TL;DR: This paper presents a quadruple opinion extraction system using large language models to handle multiple domains and languages simultaneously.


<details>
  <summary>Details</summary>
Motivation: To develop an aspect-based sentiment analysis system using LLMs for real-world applications.

Method: Fine-tuning a single model to handle multiple domain-specific taxonomies.

Result: The combined multi-domain model performs as well as specialized single-domain models but with less operational complexity.

Conclusion: Developing LLM-based systems for structured prediction tasks requires addressing non-extractive predictions and various failure modes.
...
### [80] [Rethinking Repetition Problems of LLMs in Code Generation](https://arxiv.org/abs/2505.10402)
*Yihong Dong,Yuchen Liu,Xue Jiang,Zhi Jin,Ge Li*

Main category: cs.CL

TL;DR: This paper proposes an efficient decoding approach called RPG to alleviate the repetition problems in code generation for LLMs.


<details>
  <summary>Details</summary>
Motivation: The problem of repetitions during the generation process, especially structural repetition, continues to linger in neural language models' code generation.
...
Result: RPG substantially outperforms the best-performing baselines on CodeRepetEval dataset as well as HumanEval and MBPP benchmarks.

Conclusion: RPG effectively reduces repetitions and enhances the quality of generated code.
...
### [81] [Are LLM-generated plain language summaries truly understandable? A large-scale crowdsourced evaluation](https://arxiv.org/abs/2505.10409)
*Yue Guo,Jae Ho Sohn,Gondy Leroy,Trevor Cohen*

Main category: cs.CL

TL;DR: 本研究通过大规模众包评估发现，虽然大型语言模型生成的患者友好型摘要在主观评价中看似不错，但其在提升读者理解方面不如人工撰写的好，且现有的自动化评价指标无法准确反映人类判断。


<details>
  <summary>Details</summary>
Motivation: 为了评估大型语言模型生成的患者友好型摘要的有效性，尤其是它们在支持健康信息理解方面的表现。

Method: 使用Amazon Mechanical Turk平台对150名参与者进行了大规模众包评估，包括主观Likert量表评分（关注简洁性、信息量、连贯性和忠实性）和客观的多项选择题理解与回忆测试。此外，还检查了10种自动化评价指标与人类判断之间的对齐情况。

Result: 虽然大型语言模型生成的患者友好型摘要在主观评价中看似与人工撰写的摘要没有区别，但人工撰写的摘要更能显著提高读者的理解能力。同时，自动化评价指标未能反映人类的判断，这质疑了其用于评估患者友好型摘要的适用性。

Conclusion: 需要超越表面质量的评估框架，并开发明确优化面向普通读者理解的生成方法。
...
### [82] [Hierarchical Document Refinement for Long-context Retrieval-augmented Generation](https://arxiv.org/abs/2505.10413)
*Jiajie Jin,Xiaoxi Li,Guanting Dong,Yuyao Zhang,Yutao Zhu,Yongkang Wu,Zhonghua Li,Qi Ye,Zhicheng Dou*

Main category: cs.CL

TL;DR: This paper introduces LongRefiner, an efficient system designed to handle long-context inputs in RAG applications by reducing redundant information and noise, achieving better performance with significantly lower computational costs.


<details>
  <summary>Details</summary>
Motivation: To address the issues of high inference costs and reduced performance caused by redundant information and noise in long-context RAG applications.

Method: Proposes LongRefiner which uses dual-level query analysis, hierarchical document structuring, and multi-task learning on a single foundation model for adaptive refinement.

Result: Demonstrates competitive performance across seven QA datasets with 10x less computational costs and latency compared to the best baseline.

Conclusion: LongRefiner proves to be scalable, efficient, and effective, offering valuable insights for real-world long-text RAG applications.
...
### [83] [Reinforcing the Diffusion Chain of Lateral Thought with Diffusion Language Models](https://arxiv.org/abs/2505.10446)
*Zemin Huang,Zhiyang Chen,Zijun Wang,Tiancheng Li,Guo-Jun Qi*

Main category: cs.CL

TL;DR: Introducing DCoLT, a novel reasoning framework for diffusion language models that improves reasoning accuracy on various tasks.


<details>
  <summary>Details</summary>
Motivation: To develop a reasoning framework for diffusion language models that allows bidirectional, non-linear reasoning with no strict rule on grammatical correctness amid its intermediate steps of thought.

Method: Optimizing the entire reasoning trajectory to maximize the reward on the correctness of the final answer with outcome-based Reinforcement Learning (RL).

Result: Experiments on both math and code generation tasks show that using only public data and 16 H800 GPUs, DCoLT-reinforced DLMs outperform other DLMs trained by SFT or RL or even both.

Conclusion: DCoLT-reinforced DLMs outperform other DLMs trained by SFT or RL or even both.
...
### [84] [CL-RAG: Bridging the Gap in Retrieval-Augmented Generation with Curriculum Learning](https://arxiv.org/abs/2505.10493)
*Shaohan Wang,Licheng Zhang,Zheren Fu,Zhendong Mao*

Main category: cs.CL

TL;DR: 提出了一种基于课程学习的多阶段检索增强生成系统训练框架CL-RAG，在四个开放域问答数据集上性能提升2%-4%。


<details>
  <summary>Details</summary>
Motivation: 现有的RAG系统方法直接利用top-k检索文档，但文档的有效性因用户查询而异，阻碍了检索器和生成器的适应性。受人类认知学习的启发，作者引入了课程学习范式来优化RAG系统的训练。

Method: 提出多阶段CL-RAG框架，通过样本演化构建不同难度等级的训练数据，并基于课程学习方法分阶段训练模型。

Result: 在四个开放域问答数据集上，CL-RAG框架相比多种先进方法性能提升了2%-4%。

Conclusion: 提出的CL-RAG框架有效提升了RAG系统的整体性能和泛化能力。
...
### [85] [Can You Really Trust Code Copilots? Evaluating Large Language Models from a Code Security Perspective](https://arxiv.org/abs/2505.10494)
*Yutao Mou,Xiao Deng,Yuxiao Luo,Shikun Zhang,Wei Ye*

Main category: cs.CL

TL;DR: CoV-Eval is a multi-task benchmark for evaluating LLM code security, including tasks like code completion, vulnerability repair, and detection. VC-Judge is an improved model for reviewing LLM-generated programs for vulnerabilities.


<details>
  <summary>Details</summary>
Motivation: Current code security benchmarks lack comprehensive assessment across multiple dimensions.

Method: Proposed CoV-Eval benchmark and VC-Judge model.

Result: Most LLMs identify vulnerable codes well but struggle with generating secure codes and repairing specific vulnerabilities.

Conclusion: The study reveals challenges and optimization directions for future LLM code security research.
...
### [86] [The Devil Is in the Word Alignment Details: On Translation-Based Cross-Lingual Transfer for Token Classification Tasks](https://arxiv.org/abs/2505.10507)
*Benedikt Ebing,Goran Glavaš*

Main category: cs.CL

TL;DR: This work revisits word aligners for label projection in translation-based XLT, investigates their low-level design decisions, and introduces a new projection strategy that outperforms marker-based projection.


<details>
  <summary>Details</summary>
Motivation: Although word aligners (WAs) are commonly used for label projection, the low-level design decisions for applying them to translation-based XLT have not been systematically investigated. Moreover, recent marker-based methods, which project labeled spans by inserting tags around them before (or after) translation, claim to outperform WAs in label projection for XLT.

Method: Systematically investigating the effects of low-level design decisions on token-level XLT: (i) the algorithm for projecting labels between (multi-)token spans, (ii) filtering strategies to reduce the number of noisily mapped labels, and (iii) the pre-tokenization of the translated sentences.

Result: All of these substantially impact translation-based XLT performance and show that, with optimized choices, XLT with WA offers performance at least comparable to that of marker-based methods.

Conclusion: With optimized choices, XLT with WA offers performance at least comparable to that of marker-based methods. The proposed ensembling also reduces sensitivity to low-level WA design choices, resulting in more robust XLT for token classification tasks.
...
### [87] [Multi-Token Prediction Needs Registers](https://arxiv.org/abs/2505.10518)
*Anastasios Gerontopoulos,Spyros Gidaris,Nikos Komodakis*

Main category: cs.CL

TL;DR: MuToR is a simple and effective method for multi-token prediction that can be easily integrated into pretrained language models for various tasks like fine-tuning and pretraining.


<details>
  <summary>Details</summary>
Motivation: Existing multi-token prediction methods have not consistently improved performance in fine-tuning settings.

Method: MuToR introduces learnable register tokens into the input sequence to predict future targets.

Result: MuToR shows effectiveness and versatility across different tasks including supervised fine-tuning, PEFT, and pretraining in language and vision domains.

Conclusion: MuToR is compatible with off-the-shelf pretrained models and aligns with the next-token pretraining objective.
...
### [88] [WorldPM: Scaling Human Preference Modeling](https://arxiv.org/abs/2505.10527)
*Binghai Wang,Runji Lin,Keming Lu,Le Yu,Zhenru Zhang,Fei Huang,Chujie Zheng,Kai Dang,Yang Fan,Xingzhang Ren,An Yang,Binyuan Hui,Dayiheng Liu,Tao Gui,Qi Zhang,Xuanjing Huang,Yu-Gang Jiang,Bowen Yu,Jingren Zhou,Junyang Lin*

Main category: cs.CL

TL;DR: World Preference Modeling (WorldPM) demonstrates scaling laws in preference modeling, showing that adversarial and objective metrics improve with larger models and more training data, while subjective metrics do not. WorldPM enhances generalization performance across various human preference datasets and improves results in reinforcement learning from human feedback (RLHF) pipelines.


<details>
  <summary>Details</summary>
Motivation: Scaling laws in language modeling suggest similar laws exist in preference modeling, motivating the study of how preference data scales with model and dataset sizes.

Method: Collecting preference data from public forums and conducting extensive training using models of varying sizes (1.5B to 72B parameters).

Result: Adversarial and objective metrics scale up with increased training data and model size; subjective metrics do not show scaling trends. WorldPM improves generalization performance and shows effectiveness in RLHF pipelines.

Conclusion: WorldPM has scalability potential and can be used as a foundation for preference fine-tuning, enhancing performance across different human preference datasets and RLHF evaluations.
...
### [89] [Beyond 'Aha!': Toward Systematic Meta-Abilities Alignment in Large Reasoning Models](https://arxiv.org/abs/2505.10554)
*Zhiyuan Hu,Yibo Wang,Hanze Dong,Yuhui Xu,Amrita Saha,Caiming Xiong,Bryan Hooi,Junnan Li*

Main category: cs.CL

TL;DR: Large reasoning models (LRMs) have latent capacity for long chain-of-thought reasoning. This study moves beyond prompts and coincidental 'aha moments' by aligning models with three meta-abilities: deduction, induction, and abduction. The three-stage pipeline boosts performance by over 10% relative to instruction-tuned baselines.


<details>
  <summary>Details</summary>
Motivation: Prior work has shown that outcome-based reinforcement learning can elicit advanced reasoning behaviors, but the timing and consistency of these behaviors remain unpredictable and uncontrollable, limiting scalability and reliability of LRMs' reasoning capabilities. This study aims to address these limitations.

Method: This study explicitly aligns models with three meta-abilities using automatically generated, self-verifiable tasks. The three-stage pipeline includes individual alignment, parameter-space merging, and domain-specific reinforcement learning.

Result: The three-stage pipeline boosts performance by over 10% relative to instruction-tuned baselines. Domain-specific RL from the aligned checkpoint yields an additional 2% average gain in the performance ceiling across math, coding, and science benchmarks.

Conclusion: Explicit meta-ability alignment offers a scalable and dependable foundation for reasoning in large reasoning models.
...
### [90] [Large Language Models for Cancer Communication: Evaluating Linguistic Quality, Safety, and Accessibility in Generative AI](https://arxiv.org/abs/2505.10472)
*Agnik Saha,Victoria Churchill,Anny D. Rodriguez,Ugur Kursuncu,Muhammed Y. Idris*

Main category: cs.CL

TL;DR: 研究探讨了大型语言模型在癌症相关健康信息生成中的能力与局限性，发现通用型语言模型在语言质量上优于医学专用型语言模型，后者在沟通可及性上表现更好，但前者在安全性与可信度方面更具优势。


<details>
  <summary>Details</summary>
Motivation: 乳腺癌和宫颈癌的有效交流仍然是一个持续存在的健康挑战，公众对癌症预防、筛查和治疗的理解存在显著差距，可能导致诊断延迟和治疗不足。本研究旨在评估大型语言模型在生成准确、安全和易于理解的癌症相关信息方面的潜力和局限性，以支持患者理解。

Method: 采用混合方法评估框架，评估五种通用型和三种医学专用型大型语言模型在语言质量、安全性与可信度以及沟通可及性和有效性方面的表现。评估方法包括定量指标、专家定性评分以及Welch方差分析、Games-Howell检验和Hedges' g统计分析。

Result: 通用型语言模型在语言质量和沟通有效性方面表现较好，而医学专用型语言模型在沟通可及性方面表现更佳。然而，医学专用型语言模型可能表现出更高的潜在危害、毒性及偏见，从而影响其安全性与可信度。

Conclusion: 研究结论表明，大型语言模型在生成准确、安全和易访问的癌症相关信息方面具有潜力，但存在一定的局限性。通用型语言模型在语言质量和沟通有效性方面表现更好，而医学专用型语言模型则在沟通可及性方面表现更佳。然而，医学专用型语言模型可能存在更高的潜在危害、毒性及偏见，这降低了其安全性与可信度。因此，研究指出，在健康传播领域，需要平衡专业知识与安全性，并对模型设计进行有意图的改进，特别是在减少危害和偏见、提升安全性和有效性方面。这项研究为提高AI生成的健康内容提供了重要的见解，并为未来开发准确、安全且易于获取的数字健康工具提供了指导。
...
### [91] [A Computational Pipeline for Advanced Analysis of 4D Flow MRI in the Left Atrium](https://arxiv.org/abs/2505.09746)
...
### [92] [Dyadic Mamba: Long-term Dyadic Human Motion Synthesis](https://arxiv.org/abs/2505.09827)
...
### [93] [BoundarySeg:An Embarrassingly Simple Method To Boost Medical Image Segmentation Performance for Low Data Regimes](https://arxiv.org/abs/2505.09829)
...
### [94] [Mission Balance: Generating Under-represented Class Samples using Video Diffusion Models](https://arxiv.org/abs/2505.09858)
...
### [95] [Few-Shot Learning of Visual Compositional Concepts through Probabilistic Schema Induction](https://arxiv.org/abs/2505.09859)
...
### [96] [Large-Scale Gaussian Splatting SLAM](https://arxiv.org/abs/2505.09915)
...
### [97] [AdaptCLIP: Adapting CLIP for Universal Visual Anomaly Detection](https://arxiv.org/abs/2505.09926)
...
### [98] [DDFP: Data-dependent Frequency Prompt for Source Free Domain Adaptation of Medical Image Segmentation](https://arxiv.org/abs/2505.09927)
...
### [99] [VRU-CIPI: Crossing Intention Prediction at Intersections for Improving Vulnerable Road Users Safety](https://arxiv.org/abs/2505.09935)
...
### [100] [Non-Registration Change Detection: A Novel Change Detection Task and Benchmark Dataset](https://arxiv.org/abs/2505.09939)
...
### [101] [CSPENet: Contour-Aware and Saliency Priors Embedding Network for Infrared Small Target Detection](https://arxiv.org/abs/2505.09943)
...
### [102] [MambaControl: Anatomy Graph-Enhanced Mamba ControlNet with Fourier Refinement for Diffusion-Based Disease Trajectory Prediction](https://arxiv.org/abs/2505.09965)
...
### [103] [TKFNet: Learning Texture Key Factor Driven Feature for Facial Expression Recognition](https://arxiv.org/abs/2505.09967)
*Liqian Deng*
...
### [104] [APCoTTA: Continual Test-Time Adaptation for Semantic Segmentation of Airborne LiDAR Point Clouds](https://arxiv.org/abs/2505.09971)
...
### [105] [High Quality Underwater Image Compression with Adaptive Correction and Codebook-based Augmentation](https://arxiv.org/abs/2505.09986)
...
### [106] [PointArena: Probing Multimodal Grounding Through Language-Guided Pointing](https://arxiv.org/abs/2505.09990)
...
### [107] [Descriptive Image-Text Matching with Graded Contextual Similarity](https://arxiv.org/abs/2505.09997)
...
### [108] [From Air to Wear: Personalized 3D Digital Fashion with AR/VR Immersive 3D Sketching](https://arxiv.org/abs/2505.09998)
...
### [109] [Application of YOLOv8 in monocular downward multiple Car Target detection](https://arxiv.org/abs/2505.10016)
*Shijie Lyu*
...
### [110] [ORL-LDM: Offline Reinforcement Learning Guided Latent Diffusion Model Super-Resolution Reconstruction](https://arxiv.org/abs/2505.10027)
*Shijie Lyu*
...
### [111] [DeepSeqCoco: A Robust Mobile Friendly Deep Learning Model for Detection of Diseases in Cocos nucifera](https://arxiv.org/abs/2505.10030)
...
### [112] [UOD: Universal One-shot Detection of Anatomical Landmarks](https://arxiv.org/abs/2306.07615)
...
### [113] [Exploring the Deep Fusion of Large Language Models and Diffusion Transformers for Text-to-Image Synthesis](https://arxiv.org/abs/2505.10046)
...
### [114] [Advances in Radiance Field for Dynamic Scene: From Neural Field to Gaussian Field](https://arxiv.org/abs/2505.10049)
...
### [115] [PsOCR: Benchmarking Large Multimodal Models for Optical Character Recognition in Low-resource Pashto Language](https://arxiv.org/abs/2505.10055)
...
### [116] [ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars](https://arxiv.org/abs/2505.10072)
...
### [117] [MMRL++: Parameter-Efficient and Interaction-Aware Representation Learning for Vision-Language Models](https://arxiv.org/abs/2505.10088)
...
### [118] [Why 1 + 1 < 1 in Visual Token Pruning: Beyond Naive Integration via Multi-Objective Balanced Covering](https://arxiv.org/abs/2505.10118)
...
### [119] [IMITATE: Image Registration with Context for unknown time frame recovery](https://arxiv.org/abs/2505.10124)
...
### [120] [Multi-Source Collaborative Style Augmentation and Domain-Invariant Learning for Federated Domain Generalization](https://arxiv.org/abs/2505.10152)
*Yikang Wei*
...
### [121] [Modeling Saliency Dataset Bias](https://arxiv.org/abs/2505.10169)
...
### [122] [VolE: A Point-cloud Framework for Food 3D Reconstruction and Volume Estimation](https://arxiv.org/abs/2505.10205)
...
### [123] [Data-Agnostic Augmentations for Unknown Variations: Out-of-Distribution Generalisation in MRI Segmentation](https://arxiv.org/abs/2505.10223)
...
### [124] [On the Interplay of Human-AI Alignment,Fairness, and Performance Trade-offs in Medical Imaging](https://arxiv.org/abs/2505.10231)
...
### [125] [MTVCrafter: 4D Motion Tokenization for Open-World Human Image Animation](https://arxiv.org/abs/2505.10238)
*Yanbo Ding*
...
### [126] [ADHMR: Aligning Diffusion-based Human Mesh Recovery via Direct Preference Optimization](https://arxiv.org/abs/2505.10250)
...
### [127] [Sage Deer: A Super-Aligned Driving Generalist Is Your Copilot](https://arxiv.org/abs/2505.10257)
...
### [128] [Inferring Driving Maps by Deep Learning-based Trail Map Extraction](https://arxiv.org/abs/2505.10258)
...
### [129] [HandReader: Advanced Techniques for Efficient Fingerspelling Recognition](https://arxiv.org/abs/2505.10267)
...
### [130] [MFogHub: Bridging Multi-Regional and Multi-Satellite Data for Global Marine Fog Detection and Forecasting](https://arxiv.org/abs/2505.10281)
...
### [131] [MSCI: Addressing CLIP's Inherent Limitations for Compositional Zero-Shot Learning](https://arxiv.org/abs/2505.10289)
...
### [132] [StoryReasoning Dataset: Using Chain-of-Thought for Scene Understanding and Grounded Story Generation](https://arxiv.org/abs/2505.10292)
...
### [133] [MIPHEI-ViT: Multiplex Immunofluorescence Prediction from H&E Images using ViT Foundation Models](https://arxiv.org/abs/2505.10294)
...
### [134] [A Unified and Scalable Membership Inference Method for Visual Self-supervised Encoder via Part-aware Capability](https://arxiv.org/abs/2505.10351)
...
### [135] [SpikeVideoFormer: An Efficient Spike-Driven Video Transformer with Hamming Attention and $\mathcal{O}(T)$ Complexity](https://arxiv.org/abs/2505.10352)
...
### [136] [Learned Lightweight Smartphone ISP with Unpaired Data](https://arxiv.org/abs/2505.10420)
...
### [137] [Vision language models have difficulty recognizing virtual objects](https://arxiv.org/abs/2505.10453)
...
### [138] [Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting](https://arxiv.org/abs/2505.10473)
...
### [139] [Logos as a Well-Tempered Pre-train for Sign Language Recognition](https://arxiv.org/abs/2505.10481)
...
### [140] [UniEval: Unified Holistic Evaluation for Unified Multimodal Understanding and Generation](https://arxiv.org/abs/2505.10483)
...
### [141] [CheXGenBench: A Unified Benchmark For Fidelity, Privacy and Utility of Synthetic Chest Radiographs](https://arxiv.org/abs/2505.10496)
...
### [142] [MorphGuard: Morph Specific Margin Loss for Enhancing Robustness to Face Morphing Attacks](https://arxiv.org/abs/2505.10497)
...
### [143] [Enhancing Multi-Image Question Answering via Submodular Subset Selection](https://arxiv.org/abs/2505.10533)
...
### [144] [Exploring Implicit Visual Misunderstandings in Multimodal Large Language Models through Attention Analysis](https://arxiv.org/abs/2505.10541)
...
### [145] [Does Feasibility Matter? Understanding the Impact of Feasibility on Synthetic Training Data](https://arxiv.org/abs/2505.10551)
...
### [146] [MathCoder-VL: Bridging Vision and Code for Enhanced Multimodal Mathematical Reasoning](https://arxiv.org/abs/2505.10557)
...
### [147] [End-to-End Vision Tokenizer Tuning](https://arxiv.org/abs/2505.10562)
...
### [148] [Depth Anything with Any Prior](https://arxiv.org/abs/2505.10565)
...
### [149] [3D-Fixup: Advancing Photo Editing with 3D Priors](https://arxiv.org/abs/2505.10566)
...
### [150] [A Computational Pipeline for Advanced Analysis of 4D Flow MRI in the Left Atrium](https://arxiv.org/abs/2505.09746)
*Xabier Morales,Ayah Elsayed,Debbie Zhao,Filip Loncaric,Ainhoa Aguado,Mireia Masias,Gina Quill,Marc Ramos,Ada Doltra,Ana Garcia,Marta Sitges,David Marlevi,Alistair Young,Martyn Nash,Bart Bijnens,Oscar Camara*

Main category: cs.CV

TL;DR: This study presents an open-source computational framework for analyzing 4D Flow MRI data of the left atrium, which provides accurate automated segmentations and assesses potential prognostic biomarkers for various heart disorders.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of left atrial hemodynamics and overcome limitations of conventional ultrasound analysis.

Method: Developing an open-source computational framework for analyzing 4D Flow MRI data of the left atrium.

Result: The framework proved robust to data from different centers, producing high-accuracy automated segmentations. It also conducted the first comprehensive assessment of energy, vorticity, and pressure parameters in the left atrium across a spectrum of disorders.

Conclusion: This study introduces a new tool that can be used to improve the understanding of left atrial hemodynamics and potentially identify prognostic biomarkers for heart disorders.
...
### [151] [Dyadic Mamba: Long-term Dyadic Human Motion Synthesis](https://arxiv.org/abs/2505.09827)
*Julian Tanke,Takashi Shibuya,Kengo Uchida,Koichi Saito,Yuki Mitsufuji*

Main category: cs.CV

TL;DR: A novel approach called Dyadic Mamba uses State-Space Models (SSMs) to generate high-quality dyadic human motion of any length from text descriptions.
...
Method: Dyadic Mamba employs a simple architecture facilitating information flow between motion sequences through concatenation, without complex cross-attention mechanisms.

Result: Dyadic Mamba performs competitively on short-term benchmarks and outperforms transformers on longer sequences.

Conclusion: SSM-based architectures show promise for long-term dyadic human motion synthesis from text descriptions.
...
### [152] [BoundarySeg:An Embarrassingly Simple Method To Boost Medical Image Segmentation Performance for Low Data Regimes](https://arxiv.org/abs/2505.09829)
*Tushar Kataria,Shireen Y. Elhabian*

Main category: cs.CV

TL;DR: 提出了一种新的多任务框架 BoundarySeg，通过增加器官边界的预测作为辅助任务来提高分割精度，尤其是在低数据情况下，该方法无需未标注的数据或增加计算需求。


<details>
  <summary>Details</summary>
Motivation: 由于严格的隐私法规和数据保护政策，获取大规模标注或未标注的医疗数据具有挑战性。此外，注释医学图像是一个耗时且昂贵的过程。因此，为了克服半监督方法对未标注数据依赖的限制，提出了一种新的方法。

Method: BoundarySeg 是一个多任务框架，它将器官边界预测作为一个辅助任务加入到完整的器官分割中，并利用这两个任务预测之间的一致性提供额外的监督。

Result: BoundarySeg 在低数据情况下提高了分割准确性，并且在性能上可以与最先进的半监督方法相媲美甚至超过它们，同时不需要未标注的数据或增加计算需求。

Conclusion: BoundarySeg 提出了一种新的方法，通过增加器官边界的预测作为辅助任务来提高分割精度，尤其是在低数据情况下。这种方法不需要未标注的数据或增加计算需求，且在性能上可以与最先进的半监督方法相媲美甚至超过它们。
...
### [153] [Mission Balance: Generating Under-represented Class Samples using Video Diffusion Models](https://arxiv.org/abs/2505.09858)
*Danush Kumar Venkatesh,Isabel Funke,Micha Pfeiffer,Fiona Kolbinger,Hanna Maria Schmeiser,Juergen Weitz,Marius Distler,Stefanie Speidel*

Main category: cs.CV

TL;DR: We present a novel method to synthesize surgical videos, addressing data imbalance and enhancing model performance in surgical video analysis tasks.
...
Method: A unique two-stage, text-conditioned diffusion-based method that decouples spatial and temporal modeling and introduces a rejection sampling strategy.

Result: The incorporation of synthetic videos from our approach significantly improves model performance in surgical action recognition and intra-operative event prediction tasks.

Conclusion: Our method successfully addresses the data imbalance issue in surgical video datasets by synthesizing high-fidelity surgical videos.
...
### [154] [Few-Shot Learning of Visual Compositional Concepts through Probabilistic Schema Induction](https://arxiv.org/abs/2505.09859)
*Andrew Jun Lee,Taylor Webb,Trevor Bihl,Keith Holyoak,Hongjing Lu*

Main category: cs.CV

TL;DR: Introduces a deep learning model called PSI that learns new visual concepts from limited examples by using structured representations and analogical mapping.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this research is to explore the ability to learn new visual concepts from limited examples, which is a hallmark of human cognition.

Method: Probabilistic Schema Induction (PSI) employs deep learning to perform analogical mapping over structured representations of only a handful of examples, forming a compositional concept called a schema.

Result: PSI produces human-like learning performance and outperforms two controls: a prototype model that uses unstructured feature vectors and a variant of PSI with weaker structured representations.

Conclusion: This study shows that structured representations and analogical mapping are crucial for modeling rapid human-like learning of compositional visual concepts.
...
### [155] [Large-Scale Gaussian Splatting SLAM](https://arxiv.org/abs/2505.09915)
*Zhe Xin,Chenyang Wu,Penghui Huang,Yanyong Zhang,Yinian Mao,Guoquan Huang*

Main category: cs.CV

TL;DR: Introduces LSG-SLAM, a large-scale 3D Gaussian Splatting based visual SLAM system using stereo cameras for outdoor environments.


<details>
  <summary>Details</summary>
Motivation: To address the limitation of existing NeRF and 3DGS methods that require RGBD sensors and are suitable only for indoor environments.

Method: Uses multi-modality strategy for pose estimation under large view changes, feature-alignment warping constraints, continuous Gaussian Splatting submaps for scalability, and place recognition for loop detection.

Result: Achieves better performance than existing neural, 3DGS-based, and traditional approaches on EuRoc and KITTI datasets.

Conclusion: LSG-SLAM demonstrates robustness and effectiveness in large-scale outdoor visual SLAM tasks.
...
### [156] [AdaptCLIP: Adapting CLIP for Universal Visual Anomaly Detection](https://arxiv.org/abs/2505.09926)
*Bin-Bin Gao,Yue Zhu,Jiangtao Yan,Yuezhi Cai,Weixi Zhang,Meng Wang,Jun Liu,Yong Liu,Lei Wang,Chengjie Wang*

Main category: cs.CV

TL;DR: 提出一种名为AdaptCLIP的新方法，通过交替学习视觉和文本表示以及在查询和正常图像提示之间引入上下文和对齐残差特征来改进异常检测。该方法无需额外微调且表现优异。


<details>
  <summary>Details</summary>
Motivation: 现有的视觉异常检测方法在设计提示模板、处理复杂令牌交互或需要额外微调时存在局限性，限制了其灵活性。

Method: AdaptCLIP通过添加三个简单的适配器（视觉适配器、文本适配器和提示-查询适配器）来扩展CLIP模型，支持跨领域的零样本/少量样本泛化，并且在目标域上无需训练。

Result: AdaptCLIP在工业和医疗领域的12个异常检测基准测试中达到了最先进的性能，显著优于现有竞争方法。

Conclusion: AdaptCLIP提供了一种简单有效的解决方案，能够在开放场景中实现无额外微调的新型或未见视觉域异常检测。
...
### [157] [DDFP: Data-dependent Frequency Prompt for Source Free Domain Adaptation of Medical Image Segmentation](https://arxiv.org/abs/2505.09927)
*Siqi Yin,Shaolei Liu,Manning Wang*

Main category: cs.CV

TL;DR: This paper proposes a novel source-free domain adaptation (SFDA) framework for medical datasets, introducing preadaptation and data-dependent frequency prompts to generate high-quality pseudo-labels and enhance target model performance.


<details>
  <summary>Details</summary>
Motivation: Existing SFDA methods face challenges such as limited access to labeled source data and inefficiency under limited supervision. This work aims to address these issues by improving pseudo-label quality and adaptation efficiency.

Method: The method includes preadaptation for generating an initial model, data-dependent frequency prompts for style translation, and style-related layer fine-tuning for training the target model.

Result: Experiments on abdominal and cardiac SFDA segmentation tasks show superior performance compared to existing methods.

Conclusion: The proposed SFDA framework improves adaptation efficiency and achieves better results on medical segmentation tasks.
...
### [158] [VRU-CIPI: Crossing Intention Prediction at Intersections for Improving Vulnerable Road Users Safety](https://arxiv.org/abs/2505.09935)
*Ahmed S. Abdelrahman,Mohamed Abdel-Aty,Quoc Dai Tran*

Main category: cs.CV

TL;DR: Propose VRU-CIPI framework to predict VRU crossing intentions at intersections with high accuracy and real-time performance.


<details>
  <summary>Details</summary>
Motivation: Misinterpretation of VRU crossing intentions may lead to dangerous conflicts with oncoming vehicles.

Method: Use GRU to capture temporal dynamics and multi-head Transformer self-attention mechanism to encode contextual and spatial dependencies.

Result: Achieve state-of-the-art performance with 96.45% accuracy and real-time inference speed.

Conclusion: VRU-CIPI framework can enhance intersection safety through I2V communication.
...
### [159] [Non-Registration Change Detection: A Novel Change Detection Task and Benchmark Dataset](https://arxiv.org/abs/2505.09939)
*Zhe Shan,Lei Zhou,Liu Mao,Shaofan Chen,Chuanqiu Ren,Xia Xie*

Main category: cs.CV

TL;DR: This study introduces non-registration change detection to handle emergencies by proposing scenarios and transforming datasets, showing advanced methods can be severely affected.


<details>
  <summary>Details</summary>
Motivation: Addressing emergencies like natural disasters, anthropogenic accidents, and military strikes with an increased focus on non-registration change detection.

Method: Developing image transformation schemes to convert registration change detection datasets into non-registration versions.

Result: Eight real-world scenarios that might lead to non-registration issues have been proposed and a method to transform existing datasets has been developed.

Conclusion: Non-registration change detection is shown to cause significant damage to advanced methods.
...
### [160] [CSPENet: Contour-Aware and Saliency Priors Embedding Network for Infrared Small Target Detection](https://arxiv.org/abs/2505.09943)
*Jiakun Deng,Kexuan Li,Xingye Cui,Jiaxuan Li,Chang Long,Tian Pu,Zhenming Peng*

Main category: cs.CV

TL;DR: This paper introduces a new method called CSPENet for detecting small infrared targets, which improves target localization and contour perception in cluttered environments.


<details>
  <summary>Details</summary>
Motivation: Existing methods struggle with accurately localizing dim targets and perceiving contour information in dense clutter environments, which limits their detection performance.

Method: The proposed method includes a surround-convergent prior extraction module (SCPEM) for extracting saliency and structural priors, a dual-branch priors embedding architecture (DBPEA) for feature fusion, and an attention-guided feature enhancement module (AGFEM) for refining feature representations.

Result: Experiments on three public datasets show that CSPENet outperforms other state-of-the-art methods in detection performance.

Conclusion: CSPENet is an effective method for infrared small target detection, particularly in challenging environments.
...
### [161] [MambaControl: Anatomy Graph-Enhanced Mamba ControlNet with Fourier Refinement for Diffusion-Based Disease Trajectory Prediction](https://arxiv.org/abs/2505.09965)
*Hao Yang,Tao Tan,Shuai Tan,Weiqin Yang,Kunyan Cai,Calvin Chen,Yue Sun*

Main category: cs.CV

TL;DR: MambaControl is a novel framework integrating selective state-space modelling with diffusion processes for high-fidelity prediction of medical image trajectories in Alzheimer's disease.


<details>
  <summary>Details</summary>
Motivation: Existing methods struggle with longitudinal dependencies and structural consistency in progressive disorders. The need for capturing complex spatio-temporal dynamics while preserving anatomical integrity in precision medicine drives the development of MambaControl.

Method: MambaControl combines Mamba-based long-range modelling with graph-guided anatomical control, and introduces Fourier-enhanced spectral graph representations to capture spatial coherence and multiscale detail.

Result: Quantitative and regional evaluations demonstrate improved progression prediction quality and anatomical fidelity.

Conclusion: MambaControl achieves state-of-the-art performance in Alzheimer's disease prediction, highlighting its potential for personalised prognosis and clinical decision support.
...
### [162] [TKFNet: Learning Texture Key Factor Driven Feature for Facial Expression Recognition](https://arxiv.org/abs/2505.09967)
*Liqian Deng*

Main category: cs.CV

TL;DR: This paper presents a novel framework for facial expression recognition in unconstrained environments by focusing on Texture Key Driver Factors (TKDF), which are localized texture regions with strong discriminative power across emotional categories.


<details>
  <summary>Details</summary>
Motivation: The subtle and localized nature of expression-related features, along with complex variations in facial appearance, make facial expression recognition in the wild a challenging task.

Method: The proposed framework includes a Texture-Aware Feature Extractor (TAFE) and Dual Contextual Information Filtering (DCIF). TAFE uses a ResNet-based backbone enhanced with multi-branch attention to extract fine-grained texture representations, while DCIF refines these features by filtering context through adaptive pooling and attention mechanisms.

Result: Experimental results on RAF-DB and KDEF datasets show that the proposed method achieves state-of-the-art performance, demonstrating the effectiveness and robustness of incorporating TKDFs into FER pipelines.

Conclusion: Incorporating Texture Key Driver Factors into facial expression recognition pipelines can significantly improve performance in challenging conditions.
...
### [163] [APCoTTA: Continual Test-Time Adaptation for Semantic Segmentation of Airborne LiDAR Point Clouds](https://arxiv.org/abs/2505.09971)
*Yuan Gao,Shaobo Xia,Sheng Nie,Cheng Wang,Xiaohuan Xi,Bisheng Yang*

Main category: cs.CV

TL;DR: APCoTTA是一种针对ALS点云语义分割的连续测试时适应方法，通过动态可训练层选择模块和熵一致性损失减少遗忘和误差积累，并通过随机参数插值机制平衡目标适配与源知识保留。同时构建了两个基准数据集ISPRSC和H3DC。


<details>
  <summary>Details</summary>
Motivation: 解决因环境变化、传感器类型变化或传感器退化导致的域偏移问题，提高模型在未知目标域上的性能。

Method: 提出动态可训练层选择模块、熵一致性损失以及随机参数插值机制。

Result: 在ISPRSC和H3DC两个基准上，mIoU分别提高了约9%和14%。

Conclusion: APCoTTA是首个针对ALS点云语义分割的连续测试时适应方法，有助于缓解遗忘和误差积累问题，同时提供了新的基准数据集和代码。
...
### [164] [High Quality Underwater Image Compression with Adaptive Correction and Codebook-based Augmentation](https://arxiv.org/abs/2505.09986)
*Yimin Zhou,Yichong Xia,Sicheng Pan,Bin Chen,Baoyi An,Haoqian Wang,Zhi Wang,Yaowei Wang,Zikun Zhou*

Main category: cs.CV

TL;DR: Introduces HQUIC, a novel method for compressing underwater images by exploiting their unique features.


<details>
  <summary>Details</summary>
Motivation: Contemporary underwater image compression algorithms do not fully use the unique characteristics of underwater images, leading to less than optimal performance.

Method: HQUIC uses an ALTC module for predicting attenuation coefficients and global light information, a codebook for extracting common objects, and dynamic weighting for multi-scale frequency components.

Result: HQUIC demonstrates superior performance over existing methods on various underwater datasets.

Conclusion: HQUIC surpasses state-of-the-art methods in compressing underwater images by utilizing specific features such as adaptive attenuation coefficient prediction, common object extraction, and dynamic multi-scale frequency weighting.
...
### [165] [PointArena: Probing Multimodal Grounding Through Language-Guided Pointing](https://arxiv.org/abs/2505.09990)
*Long Cheng,Jiafei Duan,Yi Ru Wang,Haoquan Fang,Boyang Li,Yushan Huang,Elvis Wang,Ainaz Eftekhar,Jason Lee,Wentao Yuan,Rose Hendrix,Noah A. Smith,Fei Xia,Dieter Fox,Ranjay Krishna*

Main category: cs.CV

TL;DR: PointArena是一个综合平台，用于评估多模态指针在不同推理场景中的表现。它包含三个部分：Point-Bench数据集，Point-Battle交互式网络竞技场和Point-Act机器人操作系统。实验显示Molmo-72B模型性能最佳，而特定于指针任务的监督训练显著提高模型性能。


<details>
  <summary>Details</summary>
Motivation: 现有基准主要集中在参照物体定位任务上，缺乏对多模态指针在多样化推理场景下的全面评估。

Method: 开发了PointArena平台，包括Point-Bench数据集，Point-Battle竞技场和Point-Act操作系统。并对多种多模态模型进行了广泛的评估。

Result: Molmo-72B模型在各种评估中表现最佳，特定的指针任务监督训练显著提高了模型性能。并且发现精确的指针能力对于连接抽象推理与实际世界行动至关重要。

Conclusion: PointArena提供了一个全面的评估框架，揭示了多模态指针任务的关键性以及特定训练的重要性。
...
### [166] [Descriptive Image-Text Matching with Graded Contextual Similarity](https://arxiv.org/abs/2505.09997)
*Jinhyun Jang,Jiyeong Lee,Kwanghoon Sohn*

Main category: cs.CV

TL;DR: DITM提出了一种描述性图文匹配方法，通过探索语言的描述灵活性来学习图像和文本之间的分级上下文相似性，从而改进了现有方法仅使用稀疏二元监督的问题。该方法利用句子描述性来学习鲁棒的图文匹配，包括动态放松正负对之间的连接以及按一般到具体的顺序对齐相关句子集。实验表明，与最先进的方法相比，DITM在表示复杂的图文关系方面更有效，并增强了模型的分层推理能力。


<details>
  <summary>Details</summary>
Motivation: 现有方法忽视了图像和文本之间内在的多对多对应关系，且没有利用从一般到具体描述的隐式联系，而这些联系构成了视觉和语言之间多对多关系的基础。

Method: 提出了DITM方法，通过探索语言的描述灵活性来学习图像和文本之间的分级上下文相似性，采用累积TF-IDF来平衡句子对之间的相似性，并利用句子描述性动态放松正负对之间的连接以及对齐相关句子集。

Result: 在MS-COCO、Flickr30K和CxC数据集上的广泛实验证明了DITM方法在表示复杂的图文关系方面的有效性，同时在HierarCaps基准上增强了模型的分层推理能力。

Conclusion: DITM突破了严格的二元监督限制，提高了发现最佳匹配和潜在正样本对的能力。
...
### [167] [From Air to Wear: Personalized 3D Digital Fashion with AR/VR Immersive 3D Sketching](https://arxiv.org/abs/2505.09998)
*Ying Zang,Yuanqi Hu,Xinyu Chen,Yuxia Xu,Suhui Wang,Chunan Yu,Lanyun Zhu,Deyi Ji,Xin Xu,Tianrun Chen*

Main category: cs.CV

TL;DR: This paper presents a 3D sketch-driven garment generation framework that allows non-expert users to create high-quality digital clothes via simple 3D sketches.


<details>
  <summary>Details</summary>
Motivation: To make 3D garment design accessible to everyday users by overcoming technical barriers and data limitations.

Method: Combining a conditional diffusion model, a shared latent space sketch encoder, and an adaptive curriculum learning strategy.

Result: The method outperforms existing baselines in terms of fidelity and usability, validated by extensive experiments and user studies.

Conclusion: The proposed framework demonstrates potential for democratizing fashion design on AR/VR platforms.
...
### [168] [Application of YOLOv8 in monocular downward multiple Car Target detection](https://arxiv.org/abs/2505.10016)
*Shijie Lyu*

Main category: cs.CV

TL;DR: This paper introduces an improved autonomous target detection network based on YOLOv8 to enhance object detection in autonomous driving systems.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of current technologies like radar, cameras, and vehicle sensor networks which face notable challenges including high costs, vulnerability to weather and lighting conditions, and limited resolution.

Method: An improved autonomous target detection network based on YOLOv8 was presented by integrating structural reparameterization technology, a bidirectional pyramid structure network model, and a novel detection pipeline into the YOLOv8 framework.

Result: Experimental results show that the enhanced model can achieve highly efficient and precise detection of multi-scale, small, and remote objects.

Conclusion: The enhanced model can effectively detect both large and small objects with a detection accuracy of 65%, showcasing significant advancements over traditional methods.
...
### [169] [ORL-LDM: Offline Reinforcement Learning Guided Latent Diffusion Model Super-Resolution Reconstruction](https://arxiv.org/abs/2505.10027)
*Shijie Lyu*

Main category: cs.CV

TL;DR: 提出一种基于强化学习的LDM微调方法用于遥感图像超分辨率，相比基线模型在多个指标上均有显著提升。


<details>
  <summary>Details</summary>
Motivation: 现有深度学习方法在处理复杂场景和保留图像细节方面仍面临局限性。

Method: 基于强化学习的潜在扩散模型(LDM)微调方法

Result: 在RESISC45数据集上的实验显示，相较于基线模型，PSNR提高了3-4dB，SSIM提升了0.08-0.11，LPIPS降低了0.06-0.10，特别是在结构化和复杂的自然场景中表现优异。

Conclusion: 实验结果表明，所提出的方法在提高超分辨率质量和场景适应性方面表现出显著效果。
...
### [170] [DeepSeqCoco: A Robust Mobile Friendly Deep Learning Model for Detection of Diseases in Cocos nucifera](https://arxiv.org/abs/2505.10030)
*Miit Daga,Dhriti Parikh,Swarna Priya Ramu*

Main category: cs.CV

TL;DR: DeepSeqCoco是一种基于深度学习的模型，用于从椰子树图像中自动识别疾病，其准确率达到99.5%，比现有模型高出5%，同时在训练时间和预测时间上分别减少了18%和85%。


<details>
  <summary>Details</summary>
Motivation: 椰子树疾病对农业产量构成严重威胁，尤其是在发展中国家，传统的种植方式限制了早期诊断和干预，而现有的疾病识别方法既费时又费力且不可扩展。

Method: 提出了一种名为DeepSeqCoco的深度学习模型，用于准确且自动地识别椰子树疾病。该模型经过不同优化器设置（如SGD、Adam和混合配置）的测试，以确定精度、损失最小化和计算成本之间的最佳平衡。

Result: 实验结果显示，DeepSeqCoco能够达到99.5%的准确率，并且在使用SGD-Adam混合配置时验证损失最低为2.81%，此外还显示训练时间和预测时间分别减少18%和85%。

Conclusion: DeepSeqCoco展示了通过基于AI的可扩展且高效的疾病监控系统来改善精准农业的潜力。
...
### [171] [UOD: Universal One-shot Detection of Anatomical Landmarks](https://arxiv.org/abs/2306.07615)
*Heqin Zhu,Quan Quan,Qingsong Yao,Zaiyi Liu,S. Kevin Zhou*

Main category: cs.CV

TL;DR: This paper introduces UOD, a domain-adaptive one-shot landmark detection framework for multi-domain medical images. It has two stages with universal models combining domain-specific and domain-shared modules. UOD can generate pseudo labels and eliminate domain preference. It achieves state-of-the-art performance on three X-ray datasets.


<details>
  <summary>Details</summary>
Motivation: To address the issue of domain preference in multi-domain unlabeled data and the lack of robustness in one-shot learning methods.

Method: Developing a domain-adaptive one-shot landmark detection framework called UOD, which consists of two stages with universal models combining domain-specific and domain-shared modules. Self-supervised learning is used in the first stage to generate pseudo landmark labels, while a domain-adaptive transformer is designed in the second stage to eliminate domain preference and build global context.

Result: UOD achieved state-of-the-art performances on three widely-used public X-ray datasets in different anatomical domains (head, hand, chest).

Conclusion: UOD is a robust and accurate one-shot landmark detection framework that can handle multi-domain medical images.
...
### [172] [Exploring the Deep Fusion of Large Language Models and Diffusion Transformers for Text-to-Image Synthesis](https://arxiv.org/abs/2505.10046)
*Bingda Tang,Boyang Zheng,Xichen Pan,Sayak Paul,Saining Xie*

Main category: cs.CV

TL;DR: This paper explores the design space of combining large language models and diffusion transformers for text-to-image synthesis, providing detailed comparisons, analyzing design choices, and offering a reproducible training recipe.


<details>
  <summary>Details</summary>
Motivation: To address the gaps in previous studies focusing more on overall system performance rather than detailed comparisons and design details for text-to-image synthesis methods.

Method: Empirical study on text-to-image generation with controlled comparisons to baselines and analysis of design choices.

Result: Provides a clear, reproducible recipe for training at scale.

Conclusion: Offers meaningful data points and practical guidelines for future research in multi-modal generation.
...
### [173] [Advances in Radiance Field for Dynamic Scene: From Neural Field to Gaussian Field](https://arxiv.org/abs/2505.10049)
*Jinlong Fan,Xuepu Zeng,Jing Zhang,Mingming Gong,Yuxiang Yang,Dacheng Tao*

Main category: cs.CV

TL;DR: This survey provides a comprehensive analysis of over 200 papers on dynamic scene representation using radiance fields, categorizing and evaluating them based on various critical aspects.


<details>
  <summary>Details</summary>
Motivation: To systematically analyze the advancements in dynamic scene representation and reconstruction methods, particularly focusing on radiance fields.

Method: Categorization and evaluation of works related to motion representation paradigms, reconstruction techniques, auxiliary information integration strategies, and regularization approaches.

Result: Significant enhancements in the quality of motion representation and dynamic scene reconstruction due to innovations in differentiable volumetric rendering.

Conclusion: The survey aims to serve as a definitive reference for researchers and practitioners in the field of dynamic scene reconstruction.
...
TL;DR: This paper evaluates large multimodal models (LMMs) on Optical Character Recognition (OCR) in the low-resource Pashto language. It introduces PsOCR, a synthetic Pashto OCR dataset with one million images, and finds that Gemini performs best overall, while Qwen-7B excels among open-source models.


<details>
  <summary>Details</summary>
Motivation: Developing effective Natural Language Processing (NLP) in Pashto is challenging due to its cursive script and lack of structured datasets. The paper aims to address these challenges by creating a synthetic OCR dataset for Pashto.

Method: A synthetic Pashto OCR dataset called PsOCR was created, containing one million images annotated with bounding boxes at various levels. Benchmarking was done using seven open-source and four closed-source LMMs.

Result: Gemini achieved the highest performance overall, while Qwen-7B performed best among open-source models.

Conclusion: This study provides valuable insights into the capabilities and limitations of LMMs for Pashto OCR, setting a foundation for future research in Pashto OCR and similar languages like Arabic, Persian, and Urdu.
...
### [175] [ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars](https://arxiv.org/abs/2505.10072)
*Rui-Yang Ju,Sheng-Yen Huang,Yi-Ping Hung*

Main category: cs.CV

TL;DR: This paper proposes an efficient two-stage framework called ToonifyGB that extends Toonify to synthesize diverse stylized 3D head avatars using Gaussian blendshapes.


<details>
  <summary>Details</summary>
Motivation: Extend Toonify for synthesizing diverse stylized 3D head avatars using Gaussian blendshapes.

Method: An efficient two-stage framework, ToonifyGB, is proposed. Stage 1 generates stylized video, and Stage 2 learns a stylized neutral head model and a set of expression blendshapes.

Result: ToonifyGB can efficiently render stylized avatars with arbitrary expressions.

Conclusion: ToonifyGB is effective for synthesizing diverse stylized 3D head avatars.
...
### [176] [MMRL++: Parameter-Efficient and Interaction-Aware Representation Learning for Vision-Language Models](https://arxiv.org/abs/2505.10088)
*Yuncheng Guo,Xiaodong Gu*

Main category: cs.CV

TL;DR: Proposes Multi-Modal Representation Learning (MMRL) and its extension MMRL++ to improve the generalization of pre-trained Vision-Language Models when adapted with few-shot data.


<details>
  <summary>Details</summary>
Motivation: Adapting large-scale pre-trained VLMs with limited few-shot data often leads to overfitting, hindering their ability to generalize to new tasks.

Method: Introducing a shared, learnable, modality-agnostic representation space; optimizing class and representation features jointly; introducing a regularization term; proposing a decoupling strategy at inference; extending to MMRL++ for parameter efficiency and enhanced interactions.

Result: MMRL and MMRL++ outperform state-of-the-art methods on 15 datasets.

Conclusion: MMRL and MMRL++ show superior performance in balancing task-specific adaptation and generalization.
...
### [177] [Why 1 + 1 < 1 in Visual Token Pruning: Beyond Naive Integration via Multi-Objective Balanced Covering](https://arxiv.org/abs/2505.10118)
*Yangfu Li,Hongjian Zhan,Tianyi Chen,Qi Liu,Yue Lu*

Main category: cs.CV

TL;DR: This paper introduces Multi-Objective Balanced Covering (MoB), a method for visual token pruning that improves performance consistency across different tasks.


<details>
  <summary>Details</summary>
Motivation: Current visual token pruning methods have inconsistent performance due to static strategies that don't account for task-specific importance variations.

Method: Deriving an error bound based on Hausdorff distance and reformulating pruning as a bi-objective covering problem with greedy radius trading.

Result: MoB maintains high performance while significantly reducing the number of visual tokens needed, offering scalable solutions for various models and tasks.

Conclusion: The proposed MoB method achieves superior performance preservation and efficiency improvements in multiple large language models and vision-language tasks.
...
### [178] [IMITATE: Image Registration with Context for unknown time frame recovery](https://arxiv.org/abs/2505.10124)
*Ziad Kheil,Lucas Robinet,Laurent Risser,Soleakhena Ken*

Main category: cs.CV

TL;DR: This paper presents a new image registration method that uses a conditional U-Net architecture to estimate unknown condition-related images from known ones and their conditions. It is applied to moving tumors for radiotherapy treatment using 4D-CT scans, achieving artifact-free volumes.


<details>
  <summary>Details</summary>
Motivation: To develop a method for estimating unknown condition-related images from known images and their conditions, especially for complex applications like moving tumors in radiotherapy treatment.

Method: A novel image registration formalism is formulated and modeled using a new conditional U-Net architecture. This method fully considers conditional information and does not require any fixed image.

Result: The method was successfully applied to moving tumors for radiotherapy treatment using 4D-CT scans, resulting in artifact-free volumes.

Conclusion: The proposed method can accurately estimate unknown condition-related images and has potential applications in complex medical imaging scenarios.
...
### [179] [Multi-Source Collaborative Style Augmentation and Domain-Invariant Learning for Federated Domain Generalization](https://arxiv.org/abs/2505.10152)
*Yikang Wei*

Main category: cs.CV

TL;DR: 提出一种在联邦领域泛化中的多源协作风格增强与领域不变学习方法(MCSAD)，通过生成更广风格空间的数据和跨域特征对齐来提高模型泛化能力，实验表明该方法显著优于现有的联邦领域泛化方法。


<details>
  <summary>Details</summary>
Motivation: 现有风格增强方法在去中心化场景下探索的数据风格有限，导致模型泛化能力不足。

Method: 提出多源协作风格增强模块生成更广风格空间的数据，并通过跨域特征对齐和类别关系集成蒸馏实现领域不变学习。

Result: 该方法在多个领域泛化数据集上的实验表明其性能显著优于最先进的联邦领域泛化方法。

Conclusion: 提出的方法在联邦领域泛化任务中表现出色，能够有效提升模型的泛化能力。
...
### [180] [Modeling Saliency Dataset Bias](https://arxiv.org/abs/2505.10169)
*Matthias Kümmerer,Harneet Khanuja,Matthias Bethge*

Main category: cs.CV

TL;DR: This paper discusses the challenge of predicting fixations across different saliency datasets due to dataset bias, proposes a novel architecture to address this issue, and demonstrates its effectiveness.


<details>
  <summary>Details</summary>
Motivation: To overcome the inter-dataset gap caused by dataset-specific biases in saliency prediction.

Method: Proposing a novel architecture that extends a mostly dataset-agnostic encoder-decoder structure with fewer than 20 dataset-specific parameters to govern interpretable mechanisms.

Result: The proposed model sets a new state-of-the-art on all three datasets of the MIT/Tuebingen Saliency Benchmark, achieving over 75% of the generalization gap with as few as 50 samples.

Conclusion: The model not only improves the performance of saliency prediction but also provides valuable insights into spatial saliency properties.
...
### [181] [VolE: A Point-cloud Framework for Food 3D Reconstruction and Volume Estimation](https://arxiv.org/abs/2505.10205)
*Umair Haroon,Ahmad AlMughrabi,Thanasis Zoumpekas,Ricardo Marques,Petia Radeva*

Main category: cs.CV

TL;DR: VolE uses mobile device-driven 3D reconstruction for food volume estimation, surpassing other methods with a 2.22% MAPE.


<details>
  <summary>Details</summary>
Motivation: Accurate food volume estimation is crucial for medical nutrition management and health monitoring applications.

Method: VolE, a novel framework that leverages mobile device-driven 3D reconstruction to estimate food volume.

Result: VolE outperforms the existing volume estimation techniques across multiple datasets by achieving 2.22 % MAPE.

Conclusion: VolE shows superior performance in food volume estimation.
...
### [182] [Data-Agnostic Augmentations for Unknown Variations: Out-of-Distribution Generalisation in MRI Segmentation](https://arxiv.org/abs/2505.10223)
*Puru Vaish,Felix Meister,Tobias Heimann,Christoph Brune,Jelmer M. Wolterink*

Main category: cs.CV

TL;DR: This study examines the effectiveness of MixUp and Auxiliary Fourier Augmentation in improving the out-of-distribution generalization and robustness of medical image segmentation models, particularly in cardiac cine MRI and prostate MRI segmentation.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the performance degradation of medical image segmentation models when deployed in real-world clinical settings due to mismatches between training and test distributions.

Method: The methods used are MixUp and Auxiliary Fourier Augmentation, which promote separability and compactness of learned feature representations.

Result: These augmentation methods significantly improve out-of-distribution generalization and robustness to imaging variations across a wide range of transformations.

Conclusion: Integrating these augmentation techniques into nnU-Net training pipelines offers an easy-to-implement solution for enhancing the reliability of medical segmentation models in real-world applications.
...
### [183] [On the Interplay of Human-AI Alignment,Fairness, and Performance Trade-offs in Medical Imaging](https://arxiv.org/abs/2505.10231)
*Haozhe Luo,Ziyu Zhou,Zixin Shu,Aurélie Pahud de Mortanges,Robert Berke,Mauricio Reyes*

Main category: cs.CV

TL;DR: This paper systematically explores Human-AI alignment and fairness in deep neural networks for medical imaging, showing that integrating human insights reduces fairness gaps and improves out-of-domain generalization.


<details>
  <summary>Details</summary>
Motivation: To address fairness issues across demographic groups in medical imaging AI due to biases.

Method: Systematically investigates Human-AI alignment and its impact on fairness and generalization in medical imaging AI.

Result: Incorporating human insights reduces fairness gaps and enhances out-of-domain generalization, but excessive alignment may cause performance trade-offs.

Conclusion: Human-AI alignment is a promising strategy for creating fair, robust, and generalizable medical AI systems.
...
### [184] [MTVCrafter: 4D Motion Tokenization for Open-World Human Image Animation](https://arxiv.org/abs/2505.10238)
*Yanbo Ding*

Main category: cs.CV

TL;DR: MTVCrafter is a novel framework that uses 4D motion tokens to improve human image animation, achieving superior performance and generalization compared to previous methods.


<details>
  <summary>Details</summary>
Motivation: Existing methods rely largely on 2D-rendered pose images for motion guidance, which limits generalization and discards essential 3D information for open-world animation.

Method: The proposed method introduces 4DMoT to quantize 3D motion sequences into 4D motion tokens and designs MV-DiT with unique motion attention and 4D positional encodings.

Result: MTVCrafter achieves state-of-the-art results with an FID-VID of 6.98, surpassing the second-best by 65%, and demonstrates good generalization ability to diverse open-world characters.

Conclusion: MTVCrafter is the first framework that directly models raw 3D motion sequences for human image animation, achieving state-of-the-art results and demonstrating good generalization ability.
...
### [185] [ADHMR: Aligning Diffusion-based Human Mesh Recovery via Direct Preference Optimization](https://arxiv.org/abs/2505.10250)
*Wenhao Shen,Wanqi Yin,Xiaofeng Yang,Cheng Chen,Chaoyue Song,Zhongang Cai,Lei Yang,Hao Wang,Guosheng Lin*

Main category: cs.CV

TL;DR: ADHMR提出了一种基于扩散模型的人体网格恢复框架，通过偏好优化方法对模型进行校准。该方法使用一个评估模型HMR-Scorer创建了一个偏好数据集，并用于微调基础模型，同时帮助现有HMR模型的数据清洗。实验表明ADHMR优于当前最先进的方法。


<details>
  <summary>Details</summary>
Motivation: 解决传统概率方法在人体网格恢复中的深度模糊和遮挡问题，提高模型对真实图像的鲁棒性。

Method: 使用HMR-Scorer评估预测并创建偏好数据集，然后通过直接偏好优化微调基础模型。

Result: ADHMR在多个实验中表现优于当前最先进的方法。

Conclusion: ADHMR提供了一种有效的方法来解决单幅图像中人体网格恢复的问题，具有较高的准确性和鲁棒性。
...
### [186] [Sage Deer: A Super-Aligned Driving Generalist Is Your Copilot](https://arxiv.org/abs/2505.10257)
*Hao Lu,Jiaqi Tang,Jiyao Wang,Yunfan LU,Xu Cao,Qingyong Hu,Yin Wang,Yuting Zhang,Tianxin Xie,Yunpeng Zhang,Yong Chen,Jiayu. Gao,Bin Huang,Dengbo He,Shuiguang Deng,Hao Chen,Ying-Cong Chen*

Main category: cs.CV

TL;DR: This paper introduces SAGE DeeR, an intelligent driving cockpit agent that aligns with users' preferences, understands multi-modal inputs, and elicits implicit thoughts for improved performance.
...
Method: Developing a Super-Aligned and GEneralist DRiving agent called SAGE DeeR with super alignment, generalist, and self-eliciting capabilities.

Result: Achieved three highlights: super alignment, generalist understanding, and self-eliciting thought chains. Built a large-scale benchmark to measure perceptual decision-making ability and super alignment accuracy.

Conclusion: SAGE DeeR demonstrates potential in enhancing user experience in intelligent driving through its advanced capabilities.
...
### [187] [Inferring Driving Maps by Deep Learning-based Trail Map Extraction](https://arxiv.org/abs/2505.10258)
*Michael Hubbertz,Pascal Colling,Qi Han,Tobias Meisen*

Main category: cs.CV

TL;DR: This paper proposes an offline mapping approach that uses transformer-based models to integrate trails into HD map creation, providing better generalization and performance than current online mapping techniques.


<details>
  <summary>Details</summary>
Motivation: High-definition (HD) maps are crucial for autonomous driving systems. Automation of map creation is needed to avoid extensive manual labeling efforts.

Method: We aggregate trail data from the ego vehicle and other traffic participants to construct a comprehensive global map using transformer-based deep learning models.

Result: Our method shows better performance than existing online mapping approaches and provides continuous updates while remaining sensor-agnostic.

Conclusion: Our proposed method demonstrates superior performance compared to state-of-the-art online mapping approaches, achieving improved generalization to previously unseen environments and sensor configurations.
...
### [188] [HandReader: Advanced Techniques for Efficient Fingerspelling Recognition](https://arxiv.org/abs/2505.10267)
*Pavel Korotaev,Petr Surovtsev,Alexander Kapitanov,Karina Kvanchiani,Aleksandr Nagaev*

Main category: cs.CV

TL;DR: This paper presents HandReader, a new approach for fingerspelling recognition using three different architectures, showing superior performance across multiple datasets.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the accuracy of fingerspelling recognition approaches which have traditionally focused on processing the temporal dimension of videos.

Method: The method includes HandReader_RGB which uses TSAM to process RGB video features, HandReader_KP which is based on TPE operating on keypoints as tensors, and HandReader_RGB+KP which has a joint encoder to utilize both RGB and keypoint modalities.

Result: The result is that each HandReader model shows distinct advantages and achieves top performance on the mentioned datasets.

Conclusion: The paper introduces HandReader, a set of three architectures that achieve state-of-the-art results on the ChicagoFSWild and ChicagoFSWild+ datasets, and high performance on the newly introduced Znaki dataset for Russian fingerspelling.
...
### [189] [MFogHub: Bridging Multi-Regional and Multi-Satellite Data for Global Marine Fog Detection and Forecasting](https://arxiv.org/abs/2505.10281)
*Mengqiu Xu,Kaixin Chen,Heng Guo,Yixiang Huang,Ming Wu,Zhenwei Shi,Chuang Zhang,Jun Guo*

Main category: cs.CV

TL;DR: A new multi-regional and multi-satellite dataset called MFogHub is introduced to improve marine fog detection and forecasting.


<details>
  <summary>Details</summary>
Motivation: Limited availability of open-source datasets focusing on single regions or satellites hinders evaluating model performance across diverse conditions and exploring marine fog characteristics.

Method: Developed MFogHub by integrating annotated marine fog observations from 15 coastal fog-prone regions and six geostationary satellites.

Result: Experiments with 16 baseline models showed MFogHub could reveal generalization fluctuations due to regional and satellite differences while being useful for developing fog prediction techniques.

Conclusion: MFogHub aims to enhance practical monitoring and scientific understanding of marine fog globally.
...
### [190] [MSCI: Addressing CLIP's Inherent Limitations for Compositional Zero-Shot Learning](https://arxiv.org/abs/2505.10289)
*Yue Wang,Shuai Xu,Xuelin Zhu,Yicong Li*

Main category: cs.CV

TL;DR: This paper proposes the Multi-Stage Cross-modal Interaction (MSCI) model to improve fine-grained local feature extraction in Compositional Zero-Shot Learning (CZSL) using CLIP.


<details>
  <summary>Details</summary>
Motivation: Existing CZSL methods relying on CLIP often overlook its limitations in capturing fine-grained local features due to architectural and training paradigm constraints.

Method: Designing two self-adaptive aggregators to extract and integrate local and global visual information, progressively incorporating them into textual representations via stage-by-stage interaction.

Result: The MSCI model shows enhanced perception capabilities for fine-grained local visual information and demonstrates flexibility in adjusting attention weights for diverse scenarios.

Conclusion: The proposed MSCI model outperforms existing approaches in CZSL tasks on three widely used datasets.
...
### [191] [StoryReasoning Dataset: Using Chain-of-Thought for Scene Understanding and Grounded Story Generation](https://arxiv.org/abs/2505.10292)
*Daniel A. P. Oliveira,David Martins de Matos*

Main category: cs.CV

TL;DR: A new dataset named StoryReasoning with 4,178 stories from 52,016 movie images was introduced to improve visual storytelling consistency.


<details>
  <summary>Details</summary>
Motivation: To address referential hallucination issues in visual storytelling by grounding characters, objects, and other entities on visual elements.

Method: Using cross-frame object re-identification via visual similarity and face recognition, chain-of-thought reasoning, and a grounding scheme that links textual to visual entities across frames.

Result: The proposed method reduced hallucinations from 4.06 to 3.56 (-12.3%) per story compared to a non-fine-tuned model.

Conclusion: Fine-tuning Qwen2.5-VL 7B improves visual storytelling consistency and reduces hallucinations.
...
### [192] [MIPHEI-ViT: Multiplex Immunofluorescence Prediction from H&E Images using ViT Foundation Models](https://arxiv.org/abs/2505.10294)
*Guillaume Balezo,Roger Trullo,Albert Pla Planas,Etienne Decenciere,Thomas Walter*

Main category: cs.CV

TL;DR: MIPHEI, a U-Net-inspired architecture, predicts multiplex immunofluorescence signals from Hematoxylin and Eosin images, achieving accurate cell-type classification across various markers.


<details>
  <summary>Details</summary>
Motivation: To enable cell-type-aware analysis of large-scale Hematoxylin and Eosin datasets by predicting multiplex immunofluorescence signals, bridging the gap between cost-effective Hematoxylin and Eosin staining and precise cell type identification via proteomic markers.

Method: Developing MIPHEI, which uses state-of-the-art ViT foundation models as encoders to predict multiplex immunofluorescence signals from Hematoxylin and Eosin images.

Result: MIPHEI achieves high F1 scores for Pan-CK, CD3e, SMA, CD68, and CD20, outperforming a state-of-the-art baseline and a random classifier for most markers.

Conclusion: MIPHEI effectively captures complex relationships between nuclear morphologies and molecular markers, offering a promising approach for cell-type-aware analysis of large-scale Hematoxylin and Eosin datasets.
...
### [193] [A Unified and Scalable Membership Inference Method for Visual Self-supervised Encoder via Part-aware Capability](https://arxiv.org/abs/2505.10351)
*Jie Zhu,Jirong Zha,Ding Li,Leye Wang*

Main category: cs.CV

TL;DR: This paper presents PartCrop, a unified membership inference method for visual self-supervised models under black-box settings. It also evaluates defense strategies and studies scaling impacts.


<details>
  <summary>Details</summary>
Motivation: To address privacy concerns in visual self-supervised learning by performing membership inference in a more realistic black-box setting.

Method: Proposes PartCrop which crops parts of objects in an image to query responses in representation space.

Result: Verifies the effectiveness and generalization of PartCrop through extensive attacks on various models and datasets.

Conclusion: Defends against PartCrop using early stop, differential privacy, and proposes shrinking crop scale range. Also introduces PartCrop-v2 with structural improvements.
...
### [194] [SpikeVideoFormer: An Efficient Spike-Driven Video Transformer with Hamming Attention and $\mathcal{O}(T)$ Complexity](https://arxiv.org/abs/2505.10352)
*Shihao Zou,Qingfeng Li,Wei Ji,Jingjing Li,Yongkui Yang,Guoqi Li,Chao Dong*

Main category: cs.CV

TL;DR: An efficient spike-driven video Transformer named SpikeVideoFormer is proposed, featuring linear temporal complexity O(T). Spike-driven Hamming attention (SDHA) is designed and various spike-driven space-time attention designs are analyzed.


<details>
  <summary>Details</summary>
Motivation: Existing SNN-based Transformers mainly focus on single-image tasks while not effectively leveraging SNNs' efficiency in video-based vision tasks.

Method: SpikeVideoFormer, spike-driven Hamming attention (SDHA)

Result: State-of-the-art (SOTA) performance on diverse downstream video tasks with significant efficiency gains.

Conclusion: The proposed method achieves superior performance and efficiency in video tasks compared to existing SNN approaches and matches the performance of recent ANN-based methods.
...
### [195] [Learned Lightweight Smartphone ISP with Unpaired Data](https://arxiv.org/abs/2505.10420)
*Andrei Arhire,Radu Timofte*

Main category: cs.CV

TL;DR: This paper introduces a new method for training a learnable Image Signal Processor (ISP) without requiring pixel-wise aligned paired data, using an unpaired approach with multi-term loss guided by adversarial training.


<details>
  <summary>Details</summary>
Motivation: To address the difficulty and cost of acquiring pixel-wise aligned paired data for training a learned ISP.

Method: An unpaired training method using a multi-term loss function guided by adversarial training with multiple discriminators processing feature maps from pre-trained networks.

Result: High fidelity results across multiple evaluation metrics compared to paired training methods.

Conclusion: This unpaired learning strategy shows strong potential for training a lightweight neural network-based ISP suitable for mobile devices.
...
### [196] [Vision language models have difficulty recognizing virtual objects](https://arxiv.org/abs/2505.10453)
*Tyler Tran,Sangeet Khemlani,J. G. Trafton*

Main category: cs.CV

TL;DR: This paper explores whether state-of-the-art vision language models (VLMs) can adequately understand visuospatial properties of scenes by testing their ability to process virtual objects not depicted in images.


<details>
  <summary>Details</summary>
Motivation: To assess how well VLMs comprehend the visuospatial properties of scenes in processed images.

Method: Using prompts that include virtual objects (not shown in images) and evaluating if VLMs can update their representations and reason about the spatial relations between real and virtual objects.

Result: State-of-the-art VLMs were found to have inadequate ability to process virtual objects.

Conclusion: Current VLMs struggle with comprehending visuospatial properties of scenes, especially when dealing with virtual objects.
...
### [197] [Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting](https://arxiv.org/abs/2505.10473)
*Fengdi Zhang,Hongkun Cao,Ruqi Huang*

Main category: cs.CV

TL;DR: A new method called ControlGS is introduced which improves the quantity-quality performance of 3D Gaussian splatting while allowing user-adjustable trade-offs.


<details>
  <summary>Details</summary>
Motivation: Existing methods lack the ability for users to adjust the trade-off between Gaussian quantity and rendering quality according to their practical needs.

Method: ControlGS, an optimization method that provides semantically meaningful and cross-scene consistent control over the quantity-quality trade-off.

Result: ControlGS outperforms baselines by achieving higher rendering quality with fewer Gaussians and supports broad adjustment ranges.

Conclusion: ControlGS allows for intuitive and effective control over the trade-off between Gaussian quantity and rendering quality.
...
### [198] [Logos as a Well-Tempered Pre-train for Sign Language Recognition](https://arxiv.org/abs/2505.10481)
*Ilya Ovodov,Petr Surovtsev,Karina Kvanchiani,Alexander Kapitanov,Alexander Nagaev*

Main category: cs.CV

TL;DR: This paper introduces a large Russian Sign Language dataset named Logos to improve isolated sign language recognition tasks and explores cross-language transfer learning.


<details>
  <summary>Details</summary>
Motivation: The motivation is to overcome the challenges posed by limited data for individual sign languages and ambiguity in dataset labeling.

Method: The method involves creating a new dataset called Logos and exploring cross-language transfer learning approaches.

Result: The result shows that a pre-trained model on the Logos dataset can be used as a universal encoder for other language SLR tasks and improves trained model quality as a visual encoder for downstream tasks.

Conclusion: The study introduces a novel Russian Sign Language (RSL) dataset called Logos which surpasses others in size and vocabulary.
...
### [199] [UniEval: Unified Holistic Evaluation for Unified Multimodal Understanding and Generation](https://arxiv.org/abs/2505.10483)
*Yi Li,Haonan Wang,Qixiang Zhang,Boyu Xiao,Chenchang Hu,Hualiang Wang,Xiaomeng Li*

Main category: cs.CV

TL;DR: Introduce UniEval, the first evaluation framework for unified multimodal models without extra models, images, or annotations.


<details>
  <summary>Details</summary>
Motivation: Lack of a unified evaluation framework for unified multimodal understanding and generation models.

Method: Develop UniEval framework containing UniBench and UniScore metric.

Result: UniBench is more challenging than existing benchmarks, and UniScore aligns closely with human evaluations.

Conclusion: UniEval facilitates a simplified and unified evaluation process.
...
### [200] [CheXGenBench: A Unified Benchmark For Fidelity, Privacy and Utility of Synthetic Chest Radiographs](https://arxiv.org/abs/2505.10496)
*Raman Dutt,Pedro Sanchez,Yongchen Yao,Steven McDonagh,Sotirios A. Tsaftaris,Timothy Hospedales*

Main category: cs.CV

TL;DR: CheXGenBench is a comprehensive evaluation framework for synthetic chest radiograph generation that evaluates fidelity, privacy risks, and clinical utility of state-of-the-art text-to-image models.


<details>
  <summary>Details</summary>
Motivation: Existing evaluations of generative AI in the medical field suffer from methodological inconsistencies and disconnected assessment criteria.

Method: The framework uses standardized data partitioning and a unified evaluation protocol with over 20 quantitative metrics to analyze 11 leading text-to-image architectures.

Result: CheXGenBench reveals inefficiencies in current evaluation protocols, especially in assessing generative fidelity, and provides a standardized benchmark for the medical AI community.

Conclusion: The study establishes a new state-of-the-art and releases the CheXGenBench framework, models, and SynthCheX-75K dataset.
...
### [201] [MorphGuard: Morph Specific Margin Loss for Enhancing Robustness to Face Morphing Attacks](https://arxiv.org/abs/2505.10497)
*Iurii Medvedev,Nuno Goncalves*

Main category: cs.CV

TL;DR: We propose a novel method for training deep networks for face recognition with enhanced robustness to face morphing attacks.


<details>
  <summary>Details</summary>
Motivation: However, this progress has also increased its exposure to presentation attacks, including face morphing, which poses a serious security threat by allowing one identity to impersonate another.

Method: Our method modifies the classification task by introducing a dual-branch classification strategy that effectively handles the ambiguity in the labeling of face morphs.

Result: Our strategy has been validated on public benchmarks, demonstrating its effectiveness in enhancing robustness against face morphing attacks.

Conclusion: Our strategy has been validated on public benchmarks, demonstrating its effectiveness in enhancing robustness against face morphing attacks. Furthermore, our approach is universally applicable and can be integrated into existing face recognition training pipelines to improve classification-based recognition methods.
...
### [202] [Enhancing Multi-Image Question Answering via Submodular Subset Selection](https://arxiv.org/abs/2505.10533)
*Aaryan Sharma,Shivansh Gupta,Samar Agarwal,Vishak Prasad C.,Ganesh Ramakrishnan*

Main category: cs.CV

TL;DR: This paper proposes an enhancement for the retriever framework in the MIRAGE model by using submodular subset selection techniques to pre-select a subset of semantically relevant images.


<details>
  <summary>Details</summary>
Motivation: To address the challenges faced by large multimodal models in vision-language tasks involving multiple images, specifically in terms of scalability and retrieval performance.

Method: Using query-aware submodular functions like GraphCut to pre-select semantically relevant images before the main retrieval component.

Result: The method demonstrates improved effectiveness of the submodular-retriever pipeline, especially with large haystack sizes, through the use of anchor-based queries and data augmentation.

Conclusion: Enhancing the retriever framework with submodular subset selection techniques can significantly improve the performance of large multimodal models in multiple image question answering scenarios.
...
### [203] [Exploring Implicit Visual Misunderstandings in Multimodal Large Language Models through Attention Analysis](https://arxiv.org/abs/2505.10541)
*Pengfei Wang,Guohai Xu,Weinong Wang,Junjie Yang,Jie Lou,Yunhua Xue*

Main category: cs.CV

TL;DR: This paper defines implicit visual misunderstanding (IVM) in Multimodal Large Language Models (MLLMs) and introduces a new metric called 'attention accuracy' to better assess their visual comprehension.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks for MLLMs mainly focus on answer correctness but neglect whether the models truly understand the visual input.

Method: Decoupling visual and textual modalities within the causal attention module and analyzing the attention distribution.

Result: A novel metric called 'attention accuracy' and a benchmark for quantifying IVMs were introduced.

Conclusion: The proposed method provides a more reliable assessment of visual understanding in MLLMs and can be extended to unimodal scenarios.
...
### [204] [Does Feasibility Matter? Understanding the Impact of Feasibility on Synthetic Training Data](https://arxiv.org/abs/2505.10551)
*Yiwen Liu,Jessica Bader,Jae Myung Kim*

Main category: cs.CV

TL;DR: Investigating the necessity of enforcing feasibility in generating synthetic training data for CLIP-based classifiers.


<details>
  <summary>Details</summary>
Motivation: To examine if enforcing feasibility affects the generalization ability of models trained on synthetic data.

Method: Introducing VariReal, a pipeline that modifies source images to include feasible or infeasible attributes based on textual prompts.

Result: Feasibility has minimal effect on LoRA-fine-tuned CLIP performance with less than 0.3% difference in top-1 accuracy across three datasets.
...
### [205] [MathCoder-VL: Bridging Vision and Code for Enhanced Multimodal Mathematical Reasoning](https://arxiv.org/abs/2505.10557)
*Ke Wang,Junting Pan,Linda Wei,Aojun Zhou,Weikang Shi,Zimu Lu,Han Xiao,Yunqiao Yang,Houxing Ren,Mingjie Zhan,Hongsheng Li*

Main category: cs.CV

TL;DR: Propose using code as supervision for cross-modal alignment in large multimodal models (LMMs), creating FigCodifier and ImgCode-8.6M, the largest image-code dataset. Use FigCodifier to generate MM-MathInstruct-3M, a high-quality multimodal math instruction dataset. Train MathCoder-VL for multimodal math problem solving, achieving new SOTA results.


<details>
  <summary>Details</summary>
Motivation: Current LMMs struggle with multimodal mathematical reasoning due to lack of focus on intricate details of mathematical figures in existing datasets.

Method: Co-develop image-to-code model and dataset with model-in-the-loop approach, use FigCodifier to synthesize figures and create MM-MathInstruct-3M, train MathCoder-VL with ImgCode-8.6M and fine-tune on MM-MathInstruct-3M.

Result: MathCoder-VL achieves new SOTA across six metrics, outperforming GPT-4o and Claude 3.5 Sonnet in geometry problem-solving subset of MathVista by 8.9% and 9.2%, respectively.

Conclusion: This work highlights the effectiveness of using code as supervision for cross-modal alignment in advancing LMMs for multimodal math reasoning.
...
### [206] [End-to-End Vision Tokenizer Tuning](https://arxiv.org/abs/2505.10562)
*Wenxuan Wang,Fan Zhang,Yufeng Cui,Haiwen Diao,Zhuoyan Luo,Huchuan Lu,Jing Liu,Xinlong Wang*

Main category: cs.CV

TL;DR: A new method called ETT is proposed to optimize vision tokenizers end-to-end by jointly training them with downstream tasks.


<details>
  <summary>Details</summary>
Motivation: Existing vision tokenization methods assume that visual tokens can generalize well across different tasks, but they fail to consider task-specific requirements, leading to suboptimal performance.

Method: ETT leverages the visual embeddings of the tokenizer codebook and optimizes the vision tokenizers with both reconstruction and caption objectives.

Result: ETT achieves significant performance gains (2-6%) for multimodal understanding and visual generation tasks compared to frozen tokenizer baselines.

Conclusion: The proposed ETT method can improve the performance of vision tokenizers without modifying the original codebooks or architectures.
...
### [207] [Depth Anything with Any Prior](https://arxiv.org/abs/2505.10565)
*Zehan Wang,Siyu Chen,Lihe Yang,Jialei Wang,Ziang Zhang,Hengshuang Zhao,Zhou Zhao*

Main category: cs.CV

TL;DR: A framework combining metric depth prediction with relative geometric structures generates accurate depth maps.


<details>
  <summary>Details</summary>
Motivation: To create detailed metric depth maps for any scene.

Method: Coarse-to-fine pipeline with pixel-level metric alignment and distance-aware weighting followed by conditioned monocular depth estimation.

Result: Impressive zero-shot generalization across various tasks and datasets.

Conclusion: The approach shows flexibility and potential for future improvements with advancements in MDE models.
...
### [208] [3D-Fixup: Advancing Photo Editing with 3D Priors](https://arxiv.org/abs/2505.10566)
*Yen-Chi Cheng,Krishna Kumar Singh,Jae Shin Yoon,Alex Schwing,Liangyan Gui,Matheus Gadelha,Paul Guerrero,Nanxuan Zhao*

Main category: cs.CV

TL;DR: We introduce 3D-Fixup, a novel framework for 2D image editing guided by learned 3D priors. It enables complex edits like object translation and rotation.


<details>
  <summary>Details</summary>
Motivation: To overcome challenges in 3D-aware image editing due to limited 3D specification from a single image.

Method: Uses a training-based approach leveraging diffusion models and incorporates 3D guidance from an Image-to-3D model using video data pairs for generating training data.

Result: Achieves high-quality, identity-coherent 3D-aware edits, demonstrating the potential of diffusion models in realistic image manipulation.

Conclusion: Introduces a new method for 2D image editing guided by learned 3D priors, showing promise for more complex and realistic image manipulations.
...
### [209] [Study and improvement of search algorithms in two-players perfect information games](https://arxiv.org/abs/2505.09639)
*Quentin Cohen-Solal*
...
### [210] [Feature Relevancy, Necessity and Usefulness: Complexity and Algorithms](https://arxiv.org/abs/2505.09640)
...
### [211] [General Dynamic Goal Recognition](https://arxiv.org/abs/2505.09737)
...
### [212] [Explainability Through Human-Centric Design for XAI in Lung Cancer Detection](https://arxiv.org/abs/2505.09755)
...
### [213] [A Multimodal Multi-Agent Framework for Radiology Report Generation](https://arxiv.org/abs/2505.09787)
...
### [214] [Offline Reinforcement Learning for Microgrid Voltage Regulation](https://arxiv.org/abs/2505.09920)
...
### [215] ["There Is No Such Thing as a Dumb Question," But There Are Good Ones](https://arxiv.org/abs/2505.09923)
...
### [216] [Demystifying AI Agents: The Final Generation of Intelligence](https://arxiv.org/abs/2505.09932)
...
### [217] [Pre-Act: Multi-Step Planning and Reasoning Improves Acting in LLM Agents](https://arxiv.org/abs/2505.09970)
...
### [218] [The First MPDD Challenge: Multimodal Personality-aware Depression Detection](https://arxiv.org/abs/2505.10034)
...
### [219] [Leveraging Graph Retrieval-Augmented Generation to Support Learners' Understanding of Knowledge Concepts in MOOCs](https://arxiv.org/abs/2505.10074)
...
### [220] [From Text to Network: Constructing a Knowledge Graph of Taiwan-Based China Studies Using Generative AI](https://arxiv.org/abs/2505.10093)
*Hsuan-Lei Shao*
...
### [221] [A User Study Evaluating Argumentative Explanations in Diagnostic Decision Support](https://arxiv.org/abs/2505.10188)
...
### [222] [MASS: Multi-Agent Simulation Scaling for Portfolio Construction](https://arxiv.org/abs/2505.10278)
...
### [223] [Empirically evaluating commonsense intelligence in large language models with large-scale human judgments](https://arxiv.org/abs/2505.10309)
...
### [224] [A Comparative Study of SMT and MILP for the Nurse Rostering Problem](https://arxiv.org/abs/2505.10328)
...
### [225] [Plasticity as the Mirror of Empowerment](https://arxiv.org/abs/2505.10361)
...
### [226] [Evaluating Model Explanations without Ground Truth](https://arxiv.org/abs/2505.10399)
...
### [227] [AI Agents vs. Agentic AI: A Conceptual Taxonomy, Applications and Challenge](https://arxiv.org/abs/2505.10468)
...
### [228] [Towards a Deeper Understanding of Reasoning Capabilities in Large Language Models](https://arxiv.org/abs/2505.10543)
...
### [229] [Study and improvement of search algorithms in two-players perfect information games](https://arxiv.org/abs/2505.09639)
*Quentin Cohen-Solal*

Main category: cs.AI

TL;DR: 研究了适用于多种领域的博弈搜索算法，提出的新算法在多种游戏的性能测试中表现出色。


<details>
  <summary>Details</summary>
Motivation: 现有的搜索算法没有对它们的通用性能进行评价

Method: 提出了一种新的搜索算法，并评估了其在多种游戏上的性能

Result: 新提出的搜索算法在两种不同的搜索时间下都表现出色

Conclusion: 对于完美的信息两人零和博弈，在较短搜索时间内新提出的搜索算法在所有实验游戏中表现最佳；在中等搜索时间内，它在22个研究游戏中的17个上优于所有研究算法。
...
### [230] [Feature Relevancy, Necessity and Usefulness: Complexity and Algorithms](https://arxiv.org/abs/2505.09640)
*Tomás Capdevielle,Santiago Cifuentes*

Main category: cs.AI

TL;DR: This paper improves existing techniques for determining relevant and necessary features in classification models and introduces a new concept of 'usefulness' to explain feature importance across the entire model.


<details>
  <summary>Details</summary>
Motivation: To enhance the understanding of feature importance in complex models like neural networks.

Method: Improving existing algorithms for relevancy and necessity detection and introducing a new concept of usefulness with corresponding algorithms.

Result: Efficient algorithms were developed to detect necessity in complex models and usefulness in decision trees and other models. Experiments on three datasets were conducted to assess practical utility.

Conclusion: The paper successfully refined feature importance analysis in complex models and introduced a global measure of feature importance.
...
### [231] [General Dynamic Goal Recognition](https://arxiv.org/abs/2505.09737)
*Osher Elhadad,Reuth Mirsky*

Main category: cs.AI

TL;DR: This paper broadens the scope of goal recognition by introducing the General Dynamic GR problem and proposes a model-free goal-conditioned RL method for quick adaptation to various changing tasks.


<details>
  <summary>Details</summary>
Motivation: To enable real-time GR systems and promote further research in this area, especially in dynamic environments with numerous and constantly evolving goals.

Method: model-free goal-conditioned RL approach

Result: A broader definition of GR called General Dynamic GR.

Conclusion: The paper introduces the General Dynamic GR problem and uses a model-free goal-conditioned RL approach to facilitate quick adaptation for GR across different changing tasks.
...
### [232] [Explainability Through Human-Centric Design for XAI in Lung Cancer Detection](https://arxiv.org/abs/2505.09755)
*Amy Rafferty,Rishi Ramaesh,Ajitha Rajan*

Main category: cs.AI

TL;DR: Develop XpertXAI, an advanced model for diagnosing multiple lung pathologies from chest X-rays with better human-interpretable explanations.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations of opaque deep learning models in lung pathology detection and improve clinical adoption through interpretable AI.

Method: Introduce XpertXAI, a generalizable expert-driven model using InceptionV3, compare it with other methods including XCBs, and validate explanations against radiologist annotations.

Result: XpertXAI outperforms baselines in accuracy and provides concept-level explanations aligned with expert reasoning.

Conclusion: Demonstrates the potential of human-centric AI design in enhancing explainability across broader medical diagnostics.
...
### [233] [A Multimodal Multi-Agent Framework for Radiology Report Generation](https://arxiv.org/abs/2505.09787)
*Ziruo Yi,Ting Xiao,Mark V. Albert*

Main category: cs.AI

TL;DR: 提出了一种新的多模态多智能体框架用于放射学报告生成，该框架模拟了临床推理流程中的各个步骤，包括检索、初稿生成、视觉分析、细化和合成。实验表明，此方法在自动指标和基于大型语言模型的评估中都优于一个强大的基线模型，生成的报告更加准确、结构化且可解释。这项工作强调了与临床对齐的多智能体框架在支持可解释和值得信赖的临床人工智能应用方面的潜力。


<details>
  <summary>Details</summary>
Motivation: 提高临床工作流程效率并减轻放射科医生的工作负担，同时解决现有方法中存在的事实不一致、幻觉和跨模态错配等问题。

Method: 开发了一个多模态多智能体框架，每个智能体负责特定的任务如检索、初稿生成、视觉分析、细化和合成，这些任务模仿了临床推理的工作流程。

Result: 提出的框架在自动评价指标和基于大型语言模型的评估中表现优于现有技术，生成的报告更精准、结构化且易于理解。

Conclusion: 证明了与临床对齐的多智能体框架可以有效提升放射学报告生成的质量，有助于开发可解释和可信的临床人工智能应用。
...
### [234] [Offline Reinforcement Learning for Microgrid Voltage Regulation](https://arxiv.org/abs/2505.09920)
*Shan Yang,Yongli Zhu*

Main category: cs.AI

TL;DR: This paper studies offline reinforcement learning algorithms for microgrid voltage regulation with solar power penetration, showing feasibility and effectiveness on various offline datasets.


<details>
  <summary>Details</summary>
Motivation: To address the issue of lacking online environment interactions due to technical or safety reasons.

Method: Using different offline reinforcement learning algorithms for microgrid voltage regulation.

Result: The proposed approach is feasible and effective on different offline datasets, even with low-quality experience.

Conclusion: Offline reinforcement learning can be a practical solution for microgrid voltage regulation with solar power penetration without requiring online environment interactions.
...
### [235] ["There Is No Such Thing as a Dumb Question," But There Are Good Ones](https://arxiv.org/abs/2505.09923)
*Minjung Shin,Donghyun Kim,Jeh-Kwang Ryu*

Main category: cs.AI

TL;DR: This study defines good questions and proposes a systematic evaluation framework with two key dimensions: appropriateness and effectiveness. A rubric-based scoring system was developed based on these dimensions, which was validated using the CAUS and SQUARE datasets.


<details>
  <summary>Details</summary>
Motivation: There is limited research comprehensively assessing question quality.

Method: Proposed two key evaluation dimensions: appropriateness and effectiveness. Developed a rubric-based scoring system based on these dimensions. Validated the methodology using the CAUS and SQUARE datasets.

Result: The framework can access both well-formed and problematic questions while adapting to varied contexts.

Conclusion: This study establishes a flexible and comprehensive framework for question evaluation, taking a significant step toward integrating questioning behavior with structured analytical methods.
...
### [236] [Demystifying AI Agents: The Final Generation of Intelligence](https://arxiv.org/abs/2505.09932)
*Kevin J McNamara,Rhea Pritham Marpu*

Main category: cs.AI

TL;DR: This paper reviews the history of AI development and predicts that current AI agents may be the last generation of intelligence as we know it.


<details>
  <summary>Details</summary>
Motivation: To chronicle the remarkable journey of AI evolution and discuss its societal implications.

Method: Reviewing key technological milestones in AI development.

Result: AI agents represent a culminating phase in AI development, potentially constituting the 'final generation' of intelligence.

Conclusion: There is a critical need for wisdom and foresight in navigating the opportunities and challenges presented by this powerful new era of intelligence.
...
### [237] [Pre-Act: Multi-Step Planning and Reasoning Improves Acting in LLM Agents](https://arxiv.org/abs/2505.09970)
*Mrinal Rawat,Ambuje Gupta,Rushil Goomer,Alessandro Di Bari,Neha Gupta,Roberto Pieraccini*

Main category: cs.AI

TL;DR: Introduce Pre-Act, a novel method enhancing LLMs' agentic capabilities by creating multi-step execution plans with detailed reasoning, improving performance across different model sizes.


<details>
  <summary>Details</summary>
Motivation: To improve the performance of agentic systems in large and small language models.

Method: Developing Pre-Act that creates multi-step execution plans with reasoning, applicable to conversational and non-conversational agents.

Result: Pre-Act outperforms ReAct by 70% in Action Recall on the Almita dataset. Fine-tuned 70B model outperforms GPT-4 with significant improvements in action accuracy and goal completion rate.

Conclusion: Pre-Act significantly enhances both large and small models' performance in agentic systems, showing promising results in various evaluations.
...
### [238] [The First MPDD Challenge: Multimodal Personality-aware Depression Detection](https://arxiv.org/abs/2505.10034)
*Changzeng Fu,Zelin Fu,Xinhe Kuang,Jiacheng Dong,Qi Zhang,Kaifeng Su,Yikai Su,Wenbo Shi,Junfeng Yao,Yuliang Zhao,Shiqi Zhao,Jiadong Wang,Siyang Song,Chaoran Liu,Yuichiro Yoshikawa,Björn Schuller,Hiroshi Ishiguro*

Main category: cs.AI

TL;DR: This paper introduces the MPDD Challenge which aims to address the gap in current depression detection methods by incorporating multimodal data alongside individual difference factors.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this paper is the notable prevalence of depression among different age groups, especially college students and the elderly, and the fact that existing datasets and detection methods primarily focus on young adults, neglecting the broader age spectrum and individual differences that influence depression manifestation.

Method: The method involves using a baseline model that fuses audio and video modalities with individual difference information to detect depression manifestations in diverse populations.

Result: The result of this paper is the introduction of a new challenge that includes two tracks based on age-specific subsets, which aims to promote the development of more personalized and accurate depression detection methods.
...
### [239] [Leveraging Graph Retrieval-Augmented Generation to Support Learners' Understanding of Knowledge Concepts in MOOCs](https://arxiv.org/abs/2505.10074)
*Mohamed Abdelmagied,Mohamed Amine Chatti,Shoeb Joarder,Qurat Ul Ain,Rawaa Alatrash*

Main category: cs.AI

TL;DR: Proposes a Graph RAG pipeline using Educational Knowledge Graphs and Personal Knowledge Graphs to help learners understand knowledge concepts in MOOCs.


<details>
  <summary>Details</summary>
Motivation: MOOCs lack direct interaction, and LLMs used by learners can hallucinate, so RAG could help but is limited by unstructured materials and doesn't actively guide learners.

Method: Graph RAG pipeline leveraging EduKGs and PKGs with two methods: PKG-based Question Generation for personalized questions and EduKG-based Question Answering for answering selected questions.

Result: Evaluated by 3 instructors on 3 MOOCs in CourseMapper, showing potential for personalized learning experience.

Conclusion: Graph RAG has the potential to enhance personalized understanding of new knowledge concepts in MOOCs.
...
### [240] [From Text to Network: Constructing a Knowledge Graph of Taiwan-Based China Studies Using Generative AI](https://arxiv.org/abs/2505.10093)
*Hsuan-Lei Shao*

Main category: cs.AI

TL;DR: This study proposes an AI-assisted approach to transform unstructured academic texts into structured knowledge representations, enhancing access to China Studies literature and offering a scalable alternative to traditional ontology construction.


<details>
  <summary>Details</summary>
Motivation: The need to systematically revisit and reorganize decades of Taiwan based China Studies scholarship.

Method: Applying generative AI techniques and large language models to extract and standardize entity relation triples from peer reviewed China Studies articles, visualizing them through a lightweight D3.js based system to form a domain specific knowledge graph and vector database.

Result: A domain specific knowledge graph and vector database that allows users to explore conceptual nodes and semantic relationships across the corpus, revealing intellectual trajectories, thematic clusters, and research gaps.

Conclusion: Generative AI can augment area studies and digital humanities and support a reimagined scholarly infrastructure for regional knowledge systems.
...
### [241] [A User Study Evaluating Argumentative Explanations in Diagnostic Decision Support](https://arxiv.org/abs/2505.10188)
*Felix Liedeker,Olivia Sanchez-Graillet,Moana Seidler,Christian Brandt,Jörg Wellmer,Philipp Cimiano*

Main category: cs.AI

TL;DR: This paper explores different approaches to generating explanations in XAI and investigates doctors' perceptions of various types of AI-generated explanations in diagnostic decision support.
...
Method: User study with physicians including a survey and interviews to assess different types of explanations.

Result: The study identifies effective and useful explanations that enhance the diagnostic process.

Conclusion: Insights gained contribute to understanding the types of explanations most effective in diagnostic decision support.
...
### [242] [MASS: Multi-Agent Simulation Scaling for Portfolio Construction](https://arxiv.org/abs/2505.10278)
*Taian Guo,Haiyang Shen,Jinsheng Huang,Zhengyang Mao,Junyu Luo,Zhuoru Chen,Xuhui Liu,Bingyu Xia,Luchen Liu,Yun Ma,Ming Zhang*

Main category: cs.AI

TL;DR: This paper introduces MASS, a multi-agent system based on large language models for portfolio construction. It achieves stable and continuous excess returns through progressive scaling and end-to-end optimization, outperforming six state-of-the-art baselines.


<details>
  <summary>Details</summary>
Motivation: Existing multi-agent systems are limited to pure simulations or predefined workflows, reducing their applicability and effectiveness. This paper aims to overcome these limitations by introducing a more flexible and powerful approach for portfolio construction.

Method: MASS uses progressively increasing numbers of agents for large-scale simulations to better understand the market and optimizes agent distribution end-to-end using reverse optimization instead of relying on fixed workflows.

Result: Performance experiments, ablation studies, backtesting experiments, experiments on updated data and stock pools, scaling experiments, parameter sensitivity experiments, and visualization experiments show that MASS outperforms six state-of-the-art baselines on three challenging A-share stock pools.

Conclusion: The paper concludes that the paradigm established by MASS can be expanded to other tasks with similar characteristics, and the implementation has been open-sourced.
...
### [243] [Empirically evaluating commonsense intelligence in large language models with large-scale human judgments](https://arxiv.org/abs/2505.10309)
*Tuan Dung Nguyen,Duncan J. Watts,Mark E. Whiting*

Main category: cs.AI

TL;DR: Proposes a new method for evaluating AI common sense that accounts for human variability, finding smaller models outperform larger ones.


<details>
  <summary>Details</summary>
Motivation: The motivation is to incorporate empirically observed heterogeneity among humans into the evaluation of AI common sense, challenging the assumption that human common sense is homogeneous.

Method: The method involves measuring the correspondence between a model's judgment and that of a human population, treating LLMs as independent survey respondents or simulators of a hypothetical population.

Result: The results show that smaller, open-weight models are surprisingly more competitive than larger, proprietary frontier models in both cases of evaluation.

Conclusion: This paper concludes that most LLMs perform below the human median in individual commonsense competence and correlate modestly with real humans in simulating a hypothetical population.
...
### [244] [A Comparative Study of SMT and MILP for the Nurse Rostering Problem](https://arxiv.org/abs/2505.10328)
*Alvin Combrink,Stephie Do,Kristofer Bengtsson,Sabino Francesco Roselli,Martin Fabian*

Main category: cs.AI

TL;DR: This study compares SMT and MILP solvers for healthcare personnel scheduling, showing that SMT excels with varied shifts and personnel, but requires careful formulation.


<details>
  <summary>Details</summary>
Motivation: To apply Satisfiability Modulo Theories (SMT) to healthcare personnel scheduling, which has been understudied despite its challenges.

Method: Propose generic constraint formulations for SMT and MILP problems and compare state-of-the-art solvers Z3 and Gurobi on academic and real-world inspired rostering problems.

Result: MILP solver performs better with highly constrained or infeasible problems, while SMT solver performs better with varied shifts and personnel. SMT solver's performance is sensitive to the formulation of constraints.
...
### [245] [Plasticity as the Mirror of Empowerment](https://arxiv.org/abs/2505.10361)
*David Abel,Michael Bowling,André Barreto,Will Dabney,Shi Dong,Steven Hansen,Anna Harutyunyan,Khimya Khetarpal,Clare Lyle,Razvan Pascanu,Georgios Piliouras,Doina Precup,Jonathan Richens,Mark Rowland,Tom Schaul,Satinder Singh*

Main category: cs.AI

TL;DR: This paper introduces plasticity as a measure of how much an agent can be influenced by its past observations, and establishes its connection with empowerment.


<details>
  <summary>Details</summary>
Motivation: The paper aims to explore the concept of plasticity in agents, which is equally foundational as empowerment.

Method: The paper defines plasticity using a new information-theoretic quantity called the generalized directed information, which strictly generalizes the directed information introduced by Massey (1990).

Result: The paper finds that plasticity is the mirror of empowerment, and there is a tension between plasticity and empowerment.

Conclusion: This paper introduces plasticity as a measure of how much an agent can be influenced by its past observations, and establishes its connection with empowerment. It reveals a tension between plasticity and empowerment, suggesting that agent design should consider both.
...
### [246] [Evaluating Model Explanations without Ground Truth](https://arxiv.org/abs/2505.10399)
*Kaivalya Rawal,Zihao Fu,Eoin Delaney,Chris Russell*

Main category: cs.AI

TL;DR: 提出了一种新的解释评估框架AXE，无需依赖理想ground-truth解释或模型敏感性，可独立衡量解释质量。


<details>
  <summary>Details</summary>
Motivation: 现有解释评估框架存在局限性，难以选择合适的解释，因此需要新的原则来指导解释评估策略的发展。

Method: 提出了AXE（无ground-truth解释评估框架），并验证了其通过比较基准和检测解释公平性洗白的能力。

Result: AXE能够有效地评估和比较模型解释的质量，并且可以检测解释公平性洗白现象。

Conclusion: 提出了一种新的解释评估框架AXE，它不依赖于理想的ground-truth解释或模型敏感性，而是提供了一个独立的解释质量度量。
...
### [247] [AI Agents vs. Agentic AI: A Conceptual Taxonomy, Applications and Challenge](https://arxiv.org/abs/2505.10468)
*Ranjan Sapkota,Konstantinos I. Roumeliotis,Manoj Karkee*

Main category: cs.AI

TL;DR: This study compares AI Agents and Agentic AI, offering a conceptual taxonomy and application analysis.


<details>
  <summary>Details</summary>
Motivation: Clarify the differences in design philosophies and capabilities between AI Agents and Agentic AI.

Method: Provide a comparative analysis based on architectural evolution, operational mechanisms, interaction styles, and autonomy levels.

Result: Contrast application domains and examine challenges with proposed solutions.

Conclusion: Aim to offer a roadmap for developing robust, scalable, and explainable AI agent and Agentic AI-driven systems.
...
### [248] [Towards a Deeper Understanding of Reasoning Capabilities in Large Language Models](https://arxiv.org/abs/2505.10543)
*Annie Wong,Thomas Bäck,Aske Plaat,Niki van Stein,Anna V. Kononova*

Main category: cs.AI

TL;DR: 研究评估了不同提示技术对大语言模型在动态环境中适应能力的影响，发现较大的模型通常表现较好，但高级推理方法的效果不稳定且存在局限性。


<details>
  <summary>Details</summary>
Motivation: 评估自省、启发式突变和规划作为提示技术的有效性，测试大型语言模型在动态环境中的适应能力。

Method: 系统地评估自省、启发式突变和规划作为提示技术，并在各种开源语言模型上进行实验。

Result: 较大的模型通常表现优于较小的模型，但战略性的提示可以缩小性能差距；较长的提示对较小模型的基本反应任务有负面影响，而较大模型则表现出更强大的行为；先进的提示技术主要帮助较小模型在复杂游戏中表现更好，但对于已经高性能的大模型提升较少；高级推理方法的结果高度可变，虽然在推理和决策一致时能显著提高性能，但也引入了不稳定性可能导致大的性能下降。

Conclusion: 当前的大语言模型仍然存在关键领域的基本局限性，如规划、推理和空间协调，仅仅通过自我反思提示可能无法完全克服这些不足。
...
### [249] [LAS: Loss-less ANN-SNN Conversion for Fully Spike-Driven Large Language Models](https://arxiv.org/abs/2505.09659)
...
### [250] [Analog Foundation Models](https://arxiv.org/abs/2505.09663)
...
### [251] [Enabling Group Fairness in Graph Unlearning via Bi-level Debiasing](https://arxiv.org/abs/2505.09702)
...
### [252] [Energy-Efficient Federated Learning for AIoT using Clustering Methods](https://arxiv.org/abs/2505.09704)
...
### [253] [Training Deep Morphological Neural Networks as Universal Approximators](https://arxiv.org/abs/2505.09710)
...
### [254] [Out-of-distribution generalisation is hard: evidence from ARC-like tasks](https://arxiv.org/abs/2505.09716)
...
### [255] [Robust Federated Learning with Confidence-Weighted Filtering and GAN-Based Completion under Noisy and Incomplete Data](https://arxiv.org/abs/2505.09733)
...
### [256] [A Generative Neural Annealer for Black-Box Combinatorial Optimization](https://arxiv.org/abs/2505.09742)
...
### [257] [Community-based Multi-Agent Reinforcement Learning with Transfer and Active Exploration](https://arxiv.org/abs/2505.09756)
*Zhaoyang Shi*
...
### [258] [Self-Consuming Generative Models with Adversarially Curated Data](https://arxiv.org/abs/2505.09768)
...
### [259] [Lossless Compression for LLM Tensor Incremental Snapshots](https://arxiv.org/abs/2505.09810)
...
### [260] [Comparative Analysis of Stroke Prediction Models Using Machine Learning](https://arxiv.org/abs/2505.09812)
...
### [261] [Adversarial Attack on Large Language Models using Exponentiated Gradient Descent](https://arxiv.org/abs/2505.09820)
...
### [262] [Learning Kronecker-Structured Graphs from Smooth Signals](https://arxiv.org/abs/2505.09822)
...
### [263] [Causal Predictive Optimization and Generation for Business AI](https://arxiv.org/abs/2505.09847)
...
### [264] [Radiogenomic Bipartite Graph Representation Learning for Alzheimer's Disease Detection](https://arxiv.org/abs/2505.09848)
...
### [265] [ZENN: A Thermodynamics-Inspired Computational Framework for Heterogeneous Data-Driven Modeling](https://arxiv.org/abs/2505.09851)
...
### [266] [Chisme: Fully Decentralized Differentiated Deep Learning for Edge Intelligence](https://arxiv.org/abs/2505.09854)
...
### [267] [Predictability Shapes Adaptation: An Evolutionary Perspective on Modes of Learning in Transformers](https://arxiv.org/abs/2505.09855)
...
### [268] [LiDDA: Data Driven Attribution at LinkedIn](https://arxiv.org/abs/2505.09861)
...
### [269] [BINGO: A Novel Pruning Mechanism to Reduce the Size of Neural Networks](https://arxiv.org/abs/2505.09864)
*Aditya Panangat*
...
### [270] [Change Detection in Multivariate data streams: Online Analysis with Kernel-QuantTree](https://arxiv.org/abs/2410.13778)
...
### [271] [Comparing Exploration-Exploitation Strategies of LLMs and Humans: Insights from Standard Multi-armed Bandit Tasks](https://arxiv.org/abs/2505.09901)
...
### [272] [Adversarial Attacks in Multimodal Systems: A Practitioner's Survey](https://arxiv.org/abs/2505.03084)
...
### [273] [Avocado Price Prediction Using a Hybrid Deep Learning Model: TCN-MLP-Attention Architecture](https://arxiv.org/abs/2505.09907)
...
### [274] [Online Isolation Forest](https://arxiv.org/abs/2505.09593)
...
### [275] [Improving the Euclidean Diffusion Generation of Manifold Data by Mitigating Score Function Singularity](https://arxiv.org/abs/2505.09922)
...
### [276] [Reinforced Interactive Continual Learning via Real-time Noisy Human Feedback](https://arxiv.org/abs/2505.09925)
...
### [277] [Advanced Crash Causation Analysis for Freeway Safety: A Large Language Model Approach to Identifying Key Contributing Factors](https://arxiv.org/abs/2505.09949)
...
### [278] [Task-Core Memory Management and Consolidation for Long-term Continual Learning](https://arxiv.org/abs/2505.09952)
...
### [279] [TransPL: VQ-Code Transition Matrices for Pseudo-Labeling of Time Series Unsupervised Domain Adaptation](https://arxiv.org/abs/2505.09955)
...
### [280] [Approximated Behavioral Metric-based State Projection for Federated Reinforcement Learning](https://arxiv.org/abs/2505.09959)
...
### [281] [A Comprehensive Machine Learning Framework for Heart Disease Prediction: Performance Evaluation and Future Perspectives](https://arxiv.org/abs/2505.09969)
...
### [282] [AI2MMUM: AI-AI Oriented Multi-Modal Universal Model Leveraging Telecom Domain Large Model](https://arxiv.org/abs/2505.10003)
...
### [283] [Sample Complexity of Distributionally Robust Average-Reward Reinforcement Learning](https://arxiv.org/abs/2505.10007)
...
### [284] [ImagineBench: Evaluating Reinforcement Learning with Large Language Model Rollouts](https://arxiv.org/abs/2505.10010)
...
### [285] [Optimal normalization in quantum-classical hybrid models for anti-cancer drug response prediction](https://arxiv.org/abs/2505.10037)
...
### [286] [Rethinking Circuit Completeness in Language Models: AND, OR, and ADDER Gates](https://arxiv.org/abs/2505.10039)
...
### [287] [Instance-Prototype Affinity Learning for Non-Exemplar Continual Graph Learning](https://arxiv.org/abs/2505.10040)
...
### [288] [Financial Fraud Detection Using Explainable AI and Stacking Ensemble Methods](https://arxiv.org/abs/2505.10050)
...
### [289] [JointDistill: Adaptive Multi-Task Distillation for Joint Depth Estimation and Scene Segmentation](https://arxiv.org/abs/2505.10057)
...
### [290] [ChronoSteer: Bridging Large Language Model and Time Series Foundation Model via Synthetic Data](https://arxiv.org/abs/2505.10083)
...
### [291] [Learning Virtual Machine Scheduling in Cloud Computing through Language Agents](https://arxiv.org/abs/2505.10117)
...
### [292] [All You Need Is Synthetic Task Augmentation](https://arxiv.org/abs/2505.10120)
*Guillaume Godin*
...
### [293] [Enhancing the Performance of Global Model by Improving the Adaptability of Local Models in Federated Learning](https://arxiv.org/abs/2505.10125)
...
### [294] [Robust Federated Learning on Edge Devices with Domain Heterogeneity](https://arxiv.org/abs/2505.10128)
...
### [295] [Near Optimal Best Arm Identification for Clustered Bandits](https://arxiv.org/abs/2505.10147)
...
### [296] [ComplexFormer: Disruptively Advancing Transformer Inference Ability via Head-Specific Complex Vector Attention](https://arxiv.org/abs/2505.10222)
...
### [297] [QuXAI: Explainers for Hybrid Quantum Machine Learning Models](https://arxiv.org/abs/2505.10167)
...
### [298] [Does Scaling Law Apply in Time Series Forecasting?](https://arxiv.org/abs/2505.10172)
...
### [299] [Defect Detection in Photolithographic Patterns Using Deep Learning Models Trained on Synthetic Data](https://arxiv.org/abs/2505.10192)
...
### [300] [Superposition Yields Robust Neural Scaling](https://arxiv.org/abs/2505.10465)
...
### [301] [A multi-head deep fusion model for recognition of cattle foraging events using sound and movement signals](https://arxiv.org/abs/2505.10198)
...
### [302] [Parallel Scaling Law for Language Models](https://arxiv.org/abs/2505.10475)
...
### [303] [Informed Forecasting: Leveraging Auxiliary Knowledge to Boost LLM Performance on Time Series Forecasting](https://arxiv.org/abs/2505.10213)
...
### [304] [RouteNator: A Router-Based Multi-Modal Architecture for Generating Synthetic Training Data for Function Calling LLMs](https://arxiv.org/abs/2505.10495)
...
### [305] [MASSV: Multimodal Adaptation and Self-Data Distillation for Speculative Decoding of Vision-Language Models](https://arxiv.org/abs/2505.10526)
...
### [306] [SpecOffload: Unlocking Latent GPU Capacity for LLM Inference on Resource-Constrained Devices](https://arxiv.org/abs/2505.10259)
...
### [307] [Electric Bus Charging Schedules Relying on Real Data-Driven Targets Based on Hierarchical Deep Reinforcement Learning](https://arxiv.org/abs/2505.10262)
...
### [308] [Cutting Through Privacy: A Hyperplane-Based Data Reconstruction Attack in Federated Learning](https://arxiv.org/abs/2505.10264)
...
### [309] [RainPro-8: An Efficient Deep Learning Model to Estimate Rainfall Probabilities Over 8 Hours](https://arxiv.org/abs/2505.10271)
...
### [310] [Spike-timing-dependent Hebbian learning as noisy gradient descent](https://arxiv.org/abs/2505.10272)
...
### [311] [Optimizing Electric Bus Charging Scheduling with Uncertainties Using Hierarchical Deep Reinforcement Learning](https://arxiv.org/abs/2505.10296)
...
### [312] [Defending the Edge: Representative-Attention for Mitigating Backdoor Attacks in Federated Learning](https://arxiv.org/abs/2505.10297)
...
### [313] [PIF: Anomaly detection via preference embedding](https://arxiv.org/abs/2505.10441)
...
### [314] [Negative Metric Learning for Graphs](https://arxiv.org/abs/2505.10307)
...
### [315] [SEAL: Searching Expandable Architectures for Incremental Learning](https://arxiv.org/abs/2505.10457)
...
### [316] [Asynchronous Decentralized SGD under Non-Convexity: A Block-Coordinate Descent Framework](https://arxiv.org/abs/2505.10322)
*Yijie Zhou,Shi Pu*
...
### [317] [A Representation Learning Approach to Feature Drift Detection in Wireless Networks](https://arxiv.org/abs/2505.10325)
...
### [318] [Efficient Adaptation of Reinforcement Learning Agents to Sudden Environmental Change](https://arxiv.org/abs/2505.10330)
...
### [319] [Emergence of Structure in Ensembles of Random Neural Networks](https://arxiv.org/abs/2505.10331)
...
### [320] [An Introduction to Discrete Variational Autoencoders](https://arxiv.org/abs/2505.10344)
...
### [321] [Uniform Loss vs. Specialized Optimization: A Comparative Analysis in Multi-Task Learning](https://arxiv.org/abs/2505.10347)
...
### [322] [FactsR: A Safer Method for Producing High Quality Healthcare Documentation](https://arxiv.org/abs/2505.10360)
...
### [323] [Schreier-Coset Graph Propagation](https://arxiv.org/abs/2505.10392)
...
### [324] [Two-Stage Generative Model for Intracranial Aneurysm Meshes with Morphological Marker Conditioning](https://arxiv.org/abs/2505.10407)
...
### [325] [Decomposed Inductive Procedure Learning: Learning Academic Tasks with Human-Like Data Efficiency](https://arxiv.org/abs/2505.10422)
...
### [326] [The Power of Random Features and the Limits of Distribution-Free Gradient Descent](https://arxiv.org/abs/2505.10423)
...
### [327] [Learning to Think: Information-Theoretic Reinforcement Fine-Tuning for LLMs](https://arxiv.org/abs/2505.10425)
...
### [328] [Score-based diffusion nowcasting of GOES imagery](https://arxiv.org/abs/2505.10432)
...
### [329] [Identification and Optimal Nonlinear Control of Turbojet Engine Using Koopman Eigenfunction Model](https://arxiv.org/abs/2505.10438)
*David Grasev*
...
### [330] [Fine-tuning Diffusion Policies with Backpropagation Through Diffusion Timesteps](https://arxiv.org/abs/2505.10482)
...
### [331] [PnPXAI: A Universal XAI Framework Providing Automatic Explanations Across Diverse Modalities and Models](https://arxiv.org/abs/2505.10515)
...
### [332] [Fixing Incomplete Value Function Decomposition for Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2505.10484)
...
### [333] [Neural Thermodynamic Laws for Large Language Model Training](https://arxiv.org/abs/2505.10559)
...
### [334] [Pharmacophore-Conditioned Diffusion Model for Ligand-Based De Novo Drug Design](https://arxiv.org/abs/2505.10545)
...
### [335] [An AI-driven framework for the prediction of personalised health response to air pollution](https://arxiv.org/abs/2505.10556)
...
### [336] [LAS: Loss-less ANN-SNN Conversion for Fully Spike-Driven Large Language Models](https://arxiv.org/abs/2505.09659)
*Long Chen,Xiaotian Song,Yanan Sun*

Main category: cs.LG

TL;DR: 提出了一种无损ANN-SNN转换方法LAS，用于全尖峰驱动的大语言模型，该方法在多个模型上实现了无损转换，并在某些任务上提高了准确性。


<details>
  <summary>Details</summary>
Motivation: 现有的ANN到SNN的转换方法在处理基于ANN的大语言模型的极端激活异常值和不兼容的非线性操作时遇到困难。

Method: LAS引入了两种新型神经元来转换ANN基大语言模型的激活异常值和非线性操作，并定制了尖峰等价的Transformer组件以确保全尖峰转换且性能无损失。

Result: 在六个语言模型和两个视觉-语言模型上的实验结果表明，LAS实现了无损转换，在OPT-66B上甚至提高了WSC任务2%的准确性。

Conclusion: LAS是一种有效的无损ANN-SNN转换方法，适用于全尖峰驱动的大语言模型。
...
### [337] [Analog Foundation Models](https://arxiv.org/abs/2505.09663)
*Julian Büchel,Iason Chalas,Giovanni Acampa,An Chen,Omobayode Fagbohungbe,Sidney Tsai,Kaoutar El Maghraoui,Manuel Le Gallo,Abbas Rahimi,Abu Sebastian*

Main category: cs.LG

TL;DR: We present a method to adapt large language models for analog in-memory computing hardware, enabling them to maintain performance levels comparable to digital counterparts.


<details>
  <summary>Details</summary>
Motivation: To address the challenges introduced by AIMC, such as noisy computations and strict constraints on input and output quantization, and to enable state-of-the-art models to retain performance comparable to 4-bit weight, 8-bit activation baselines.

Method: Introduce a general and scalable method to robustly adapt LLMs for execution on noisy, low-precision analog hardware.

Result: State-of-the-art models can retain performance comparable to 4-bit weight, 8-bit activation baselines despite the presence of analog noise and quantization constraints. Additionally, analog foundation models can be quantized for inference on low-precision digital hardware.

Conclusion: Our work bridges the gap between high-capacity LLMs and efficient analog hardware, offering a path toward energy-efficient foundation models.
...
### [338] [Enabling Group Fairness in Graph Unlearning via Bi-level Debiasing](https://arxiv.org/abs/2505.09702)
*Yezi Liu,Prathyush Poduval,Wenjun Huang,Yang Ni,Hanning Chen,Mohsen Imani*

Main category: cs.LG

TL;DR: This paper studies the issue of fairness in graph unlearning, proposing a method called FGU which ensures both privacy and fairness while maintaining accuracy.


<details>
  <summary>Details</summary>
Motivation: The paper aims to address the potential for bias introduced during the graph unlearning process, especially when user information is removed from models.

Method: FGU trains shard models on partitioned subgraphs, removes requested data, and retrains shard models. It also uses a bi-level debiasing process for fairness.

Result: Experiments show FGU achieves better fairness, maintains privacy and accuracy, and is robust against diverse unlearning requests.

Conclusion: Graph unlearning can introduce bias, but FGU provides a solution that ensures fairness, privacy, and utility.
...
### [339] [Energy-Efficient Federated Learning for AIoT using Clustering Methods](https://arxiv.org/abs/2505.09704)
*Roberto Pereira,Fernanda Famá,Charalampos Kalalas,Paolo Dini*

Main category: cs.LG

TL;DR: This study investigates the energy consumption of federated learning in AIoT scenarios, focusing on pre-processing, communication, and local learning processes. It proposes two clustering-informed methods for device selection, which improve convergence rates and reduce energy use.


<details>
  <summary>Details</summary>
Motivation: Energy implications of federated learning in AIoT scenarios have been overlooked in existing literature.

Method: Proposes two clustering-informed methods for device selection to alleviate heterogeneity and speed up model training convergence.

Result: The proposed methods achieve high convergence rates while maintaining low energy consumption.

Conclusion: The study highlights the importance of considering energy consumption in federated learning within AIoT scenarios.
...
### [340] [Training Deep Morphological Neural Networks as Universal Approximators](https://arxiv.org/abs/2505.09710)
*Konstantinos Fotopoulos,Petros Maragos*

Main category: cs.LG

TL;DR: This paper investigates deep morphological neural networks (DMNNs), proposes several new architectures with constraints on their parameters, demonstrates their successful training and higher prunability compared to linear networks, and introduces a hybrid network architecture that accelerates gradient descent convergence.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of DMNNs with specific parameter constraints and improve their training and performance.

Method: Proposing new architectures with constraints on parameters, empirical testing, and comparison with linear networks.

Result: The proposed DMNNs can be successfully trained and are more prunable than linear networks. A hybrid architecture combining linear and morphological layers accelerates gradient descent convergence.

Conclusion: Successfully training DMNNs under specific constraints is achieved, but generalization capabilities remain limited.
...
### [341] [Out-of-distribution generalisation is hard: evidence from ARC-like tasks](https://arxiv.org/abs/2505.09716)
*George Dimitriadis. Spyridon Samothrakis*

Main category: cs.LG

TL;DR: Investigates out-of-distribution generalization and proposes new network architectures that succeed in OOD scenarios but still may fail to learn correct features for compositional generalization.


<details>
  <summary>Details</summary>
Motivation: To explore the ability of intelligent systems to discover invariant properties and perform composition, which is a key aspect of human and animal intelligence.

Method: Proposes two novel network architectures with specific biases to handle OOD scenarios.

Result: Two tasks with clear OOD metrics were explored where common neural networks failed, but the new architectures succeeded in OOD scenarios.

Conclusion: The study concludes that simply testing on an OOD setup isn't sufficient to confirm that an algorithm learns compositional structures from data.
...
### [342] [Robust Federated Learning with Confidence-Weighted Filtering and GAN-Based Completion under Noisy and Incomplete Data](https://arxiv.org/abs/2505.09733)
*Alpaslan Gokcen,Ali Boyaci*

Main category: cs.LG

TL;DR: This study introduces a federated learning method that addresses data quality issues like noise, class imbalance, and missing labels through adaptive noise cleaning, synthetic data generation, and robust model training, showing improved performance on benchmark datasets.


<details>
  <summary>Details</summary>
Motivation: To enhance the effectiveness of federated learning by addressing data quality challenges such as noisy labels, missing classes, and imbalanced distributions.

Method: Adaptive noise cleaning, collaborative conditional GAN-based synthetic data generation, and robust federated model training are used to improve data integrity.

Result: Significant improvements in federated model performance, especially macro-F1 Score, were observed on MNIST and Fashion-MNIST datasets under different noise and class imbalance conditions.

Conclusion: The proposed method effectively tackles common data quality problems, offering a robust, scalable, and privacy-preserving solution for various real-world federated learning applications.
...
### [343] [A Generative Neural Annealer for Black-Box Combinatorial Optimization](https://arxiv.org/abs/2505.09742)
*Yuan-Hang Zhang,Massimiliano Di Ventra*

Main category: cs.LG

TL;DR: 提出了一种新的生成式端到端求解器用于黑盒组合优化问题，在NP问题上强调了样本效率和解决方案质量。通过将黑盒目标视为能量函数并训练神经网络来模拟相关的玻尔兹曼分布，该方法在各种温度下学习能量景观结构并促进全局优化。实验验证表明其性能与最先进的黑盒优化器相当。


<details>
  <summary>Details</summary>
Motivation: 提出一种新的方法来解决黑盒组合优化问题，特别是在NP问题上的样本效率和解决方案质量。

Method: 将黑盒目标视为能量函数，并训练一个神经网络来模拟相关的玻尔兹曼分布。通过调节温度，网络可以捕捉从高温下的接近均匀分布到低温下集中在全局最优周围的尖锐峰值分布的连续分布，从而学习能量景观的结构并促进全局优化。

Result: 在有限和无限查询预算下的具有挑战性的组合任务上验证了该方法，表现出了与最先进的黑盒优化器相竞争的性能。

Conclusion: 提出的方法在样本效率和解决方案质量方面表现出色，特别是在黑盒组合优化问题上。
...
### [344] [Community-based Multi-Agent Reinforcement Learning with Transfer and Active Exploration](https://arxiv.org/abs/2505.09756)
*Zhaoyang Shi*

Main category: cs.LG

TL;DR: A novel MARL framework integrating community structures, transfer learning, and active learning with theoretical guarantees.


<details>
  <summary>Details</summary>
Motivation: To capture flexible coordination patterns and enable structured information sharing among agents in time-evolving networks with latent community structures.

Method: Each agent belongs to multiple overlapping communities maintaining shared policy and value functions, which are aggregated based on personalized membership weights. Actor-critic algorithms exploit this structure for policy updates and value learning.

Result: The framework supports transfer learning through membership estimation and active learning by prioritizing uncertain communities during exploration.

Conclusion: This is the first MARL framework that combines community structure, transferability, and active learning with provable guarantees.
...
### [345] [Self-Consuming Generative Models with Adversarially Curated Data](https://arxiv.org/abs/2505.09768)
*Xiukun Wei,Xueru Zhang*

Main category: cs.LG

TL;DR: Recent progress in generative models makes it hard to distinguish real data from synthetic one. This paper studies how these models evolve under self-consuming retraining loops with noisy and adversarially curated data. It analyzes impacts theoretically and designs attack algorithms for adversarial scenarios.


<details>
  <summary>Details</summary>
Motivation: To understand the evolution of generative models under self-consuming retraining loops with noisy and adversarially curated data.

Method: Theoretical analysis and design of attack algorithms for competitive adversarial scenarios.

Result: Experiments on both synthetic and real-world datasets demonstrate the effectiveness of the proposed algorithms.

Conclusion: This work provides insights into the robustness of the retraining process under noisy and adversarially curated data.
...
### [346] [Lossless Compression for LLM Tensor Incremental Snapshots](https://arxiv.org/abs/2505.09810)
*Daniel Waddington,Cornel Constantinescu*

Main category: cs.LG

TL;DR: This paper analyzes checkpoint data in Large Language Models (LLMs) and develops an efficient compression solution called Language Model Compressor (LMC).


<details>
  <summary>Details</summary>
Motivation: To optimize the checkpointing process in LLMs by reducing the volume of checkpoint data.

Method: Experimental analysis of checkpoint data, leveraging byte-grouping and Huffman encoding.

Result: LMC offers better compression performance than BZ2 with significantly less compression time. It achieves 2.78 GiB/s compression and 3.76 GiB/s decompression throughput with a 16-core parallel implementation.

Conclusion: The optimized checkpointing solution reduces CPU usage and allows higher-frequency checkpoints.
...
### [347] [Comparative Analysis of Stroke Prediction Models Using Machine Learning](https://arxiv.org/abs/2505.09812)
*Anastasija Tashkova,Stefan Eftimov,Bojan Ristov,Slobodan Kalajdziski*

Main category: cs.LG

TL;DR: This study evaluates machine learning models for predicting stroke risk based on demographic, clinical, and lifestyle data, finding high accuracy but low sensitivity, and proposes ways to enhance model reliability and interpretability.


<details>
  <summary>Details</summary>
Motivation: To address the global health challenge of stroke by developing reliable and interpretable machine learning models for early assessment of stroke risk.

Method: Evaluating multiple models (Logistic Regression, Random Forest, XGBoost) on the Stroke Prediction Dataset, addressing class imbalance and missing data issues.

Result: High accuracy achieved by the models, but sensitivity is limited for real-world clinical use. Influential predictive features identified.

Conclusion: The study contributes to improving machine learning-based stroke prediction with more reliable and interpretable models.
...
### [348] [Adversarial Attack on Large Language Models using Exponentiated Gradient Descent](https://arxiv.org/abs/2505.09820)
*Sajib Biswas,Mao Nishino,Samuel Jacob Chacko,Xiuwen Liu*

Main category: cs.LG

TL;DR: 提出了一种新的内在优化技术，使用指数梯度下降和Bregman投影方法，有效地提高了LLMs的安全性。


<details>
  <summary>Details</summary>
Motivation: 随着大规模语言模型（LLMs）的广泛应用，系统地理解它们对于提高其安全性和充分发挥其潜力至关重要。尽管许多模型使用强化学习从人类反馈（RLHF）等技术进行对齐，但它们仍然容易受到越狱攻击。

Method: 我们使用指数梯度下降和Bregman投影方法开发了一种新的内在优化技术，确保优化后的独热编码始终在概率单纯形内。

Result: 我们的技术在五个开源LLMs上使用四个公开可用的数据集进行了测试。结果表明，该技术在效率和成功率上都优于三种最先进的越狱技术。

Conclusion: 我们开发了一种新的内在优化技术，使用指数梯度下降和Bregman投影方法，确保优化后的独热编码始终在概率单纯形内。证明了该技术的收敛性，并实现了一个有效的算法，在多个广泛使用的LLMs上成功越狱。实验表明，所提出的技术在效率和成功率上都优于三种最先进的越狱技术。
...
### [349] [Learning Kronecker-Structured Graphs from Smooth Signals](https://arxiv.org/abs/2505.09822)
*Changhao Shi,Gal Mishne*

Main category: cs.LG

TL;DR: This paper proposes a method to learn Kronecker-structured product graphs from smooth signals.


<details>
  <summary>Details</summary>
Motivation: Graph learning is important in applying GSP when the domains are unknown. Existing methods are limited in modeling diverse dependency structures.

Method: An alternating scheme is proposed to optimize each factor graph.

Result: Experiments show that the proposed method is effective and outperforms existing methods.

Conclusion: The paper concludes that their proposed method can effectively learn Kronecker-structured product graphs from smooth signals, and it also performs well in learning factor graphs of the strong product.
...
### [350] [Causal Predictive Optimization and Generation for Business AI](https://arxiv.org/abs/2505.09847)
*Liyang Zhao,Olurotimi Seton,Himadeep Reddy Reddivari,Suvendu Jena,Shadow Zhao,Rachit Kumar,Changshuai Wei*

Main category: cs.LG

TL;DR: This paper presents a new approach called Causal Predictive Optimization and Generation for sales optimization and business AI. It has three layers: causal ML prediction, constraint optimization and contextual bandit optimization, and Generative AI with feedback-loop.


<details>
  <summary>Details</summary>
Motivation: Optimizing the sales process is crucial for the success of any B2B business.

Method: Introducing a principled approach called Causal Predictive Optimization and Generation, which includes three layers: prediction layer with causal ML, optimization layer with constraint optimization and contextual bandit, and serving layer with Generative AI and feedback-loop.

Result: The system was implemented and deployed in LinkedIn, showing significant improvements over legacy systems.

Conclusion: The proposed approach can be broadly applied in the field of sales optimization and business AI.
...
### [351] [Radiogenomic Bipartite Graph Representation Learning for Alzheimer's Disease Detection](https://arxiv.org/abs/2505.09848)
*Aditya Raj,Golrokh Mirzaei*

Main category: cs.LG

TL;DR: This study presents a novel method using radiogenomic data for Alzheimer's disease detection, introducing a heterogeneous bipartite graph representation learning that classifies AD into three stages and identifies key genes for each stage.


<details>
  <summary>Details</summary>
Motivation: To integrate imaging and genomic data to gain new insights into complex diseases like Alzheimer's.

Method: Developing a novel heterogeneous bipartite graph representation learning with two node types: genes and images.

Result: Effectively classifies Alzheimer's disease into three stages using a small dataset and identifies significant genes for each classification group.

Conclusion: The approach has potential for extending radiogenomic-based classification to other diseases.
...
### [352] [ZENN: A Thermodynamics-Inspired Computational Framework for Heterogeneous Data-Driven Modeling](https://arxiv.org/abs/2505.09851)
*Shun Wang,Shun-Li Shang,Zi-Kui Liu,Wenrui Hao*

Main category: cs.LG

TL;DR: 本研究提出了一种基于zentropy的神经网络(ZENN)，用于从异构数据中有效学习，展示了其在复杂数据集上的优越性能。


<details>
  <summary>Details</summary>
Motivation: 传统熵方法在处理异构数据集时面临挑战，尤其是当这些数据集具有内在差异时。为了应对这一挑战，研究扩展了zentropy理论到数据科学领域。

Method: 设计并实现了基于zentropy的神经网络(ZENN)，该网络同时学习能量和内在熵成分，捕捉多源数据的潜在结构。重新设计了神经网络架构以更好地反映多样数据集中的内在特性和变异性。

Result: ZENN在分类任务和能量景观重建上表现出色，特别是在预测高阶导数方面表现出了强大的泛化能力和鲁棒性。此外，ZENN成功地重构了Fe3Pt的Helmholtz能量景观，并捕获了关键的材料行为。

Conclusion: 研究引入了zentropy理论到数据科学领域，提出了基于zentropy的神经网络(ZENN)，能够更有效地从异构数据源学习。通过在分类任务和能量景观重建上的实验，展示了ZENN在复杂异构数据集上的优越泛化能力和鲁棒性。
...
### [353] [Chisme: Fully Decentralized Differentiated Deep Learning for Edge Intelligence](https://arxiv.org/abs/2505.09854)
*Harikrishna Kuttivelil,Katia Obraczka*

Main category: cs.LG

TL;DR: This paper introduces Chisme, a new suite of protocols for robust intelligence implementation at the network edge, addressing challenges of heterogeneous data distribution, episodic connectivity, and lack of infrastructure.


<details>
  <summary>Details</summary>
Motivation: Existing distributed learning approaches face challenges in resource-constrained and infrastructure-less environments, and gossip learning algorithms are not suitable for all contexts.

Method: Chisme includes both synchronous DFL and asynchronous GL variants, introducing a data similarity heuristic for opportunistic inference of affinity between agents and extending model aggregation and merge mechanisms for personalized training.

Result: Chisme methods outperform standard counterparts in model training over distributed and heterogeneous data in various network scenarios.

Conclusion: Chisme provides a robust solution for distributed learning at the network edge with consideration of data heterogeneity and network conditions.
...
### [354] [Predictability Shapes Adaptation: An Evolutionary Perspective on Modes of Learning in Transformers](https://arxiv.org/abs/2505.09855)
*Alexander Y. Ku,Thomas L. Griffiths,Stephanie C. Y. Chan*

Main category: cs.LG

TL;DR: This study explores the balance between in-weights learning (IWL) and in-context learning (ICL) in Transformer models, drawing parallels to genetic encoding and phenotypic plasticity in evolutionary biology. It finds that high environmental stability favors IWL, while high cue reliability enhances ICL efficacy.


<details>
  <summary>Details</summary>
Motivation: Understanding how Transformer models learn in different modes to improve training methodologies and model adaptability.

Method: Analogizing learning modes in Transformers to adaptive strategies in evolutionary biology, then experimenting with regression and classification tasks to examine the influence of environmental predictability on the ICL/IWL balance.

Result: High environmental stability strongly favors IWL, with a notable transition at maximum stability. High cue reliability boosts ICL effectiveness, especially under low stability. Learning dynamics indicate task-dependent temporal shifts between ICL and IWL.

Conclusion: The study highlights predictability as a key factor influencing adaptive strategies in Transformers, supporting a relative-cost hypothesis for learning mode transitions and providing new perspectives for ICL understanding and training method optimization.
...
### [355] [LiDDA: Data Driven Attribution at LinkedIn](https://arxiv.org/abs/2505.09861)
*John Bencina,Erkut Aykutlug,Yue Chen,Zerui Zhang,Stephanie Sorenson,Shao Tang,Changshuai Wei*

Main category: cs.LG

TL;DR: This paper introduces a unified transformer-based attribution approach for marketing intelligence, capable of handling different types of data and external factors. The implementation at LinkedIn shows substantial impact, with learnings applicable to marketing and ad tech.


<details>
  <summary>Details</summary>
Motivation: To develop a more effective data-driven attribution method that can handle various types of data and external factors for better marketing intelligence and business decisions.

Method: A unified transformer-based approach is proposed, capable of processing member-level data, aggregate-level data, and integrating external macro factors.

Result: The approach was implemented on a large scale at LinkedIn and demonstrated significant impact.

Conclusion: The introduced transformer-based attribution approach is effective and has broad applicability in the marketing and ad tech fields.
...
### [356] [BINGO: A Novel Pruning Mechanism to Reduce the Size of Neural Networks](https://arxiv.org/abs/2505.09864)
*Aditya Panangat*

Main category: cs.LG

TL;DR: BINGO introduces an accuracy-preserving pruning technique for neural networks that requires less computational resources compared to current methods.


<details>
  <summary>Details</summary>
Motivation: The high cost of training and operating large machine learning models limits contributions from non-wealthy individuals and increases consumer prices for AI.

Method: BINGO studies specific subsets of a neural network during training to determine the significance of each weight, generating a significance score for pruning insignificant weights in one step.

Result: BINGO reduces the computational and environmental costs associated with model pruning while maintaining accuracy.

Conclusion: BINGO offers a more efficient way to prune neural networks, democratizing access to AI development and reducing costs.
...
### [357] [Change Detection in Multivariate data streams: Online Analysis with Kernel-QuantTree](https://arxiv.org/abs/2410.13778)
*Michelangelo Olmo Nogara Notarianni,Filippo Leveni,Diego Stucchi,Luca Frittoli,Giacomo Boracchi*

Main category: cs.LG

TL;DR: A non-parametric change-detection algorithm called KQT-EWMA for monitoring multivariate data streams online.


<details>
  <summary>Details</summary>
Motivation: To develop a flexible and practical method for detecting changes in multivariate data streams.

Method: Combining Kernel-QuantTree histogram and EWMA statistic.

Result: Achieves detection delays comparable to or lower than state-of-the-art methods while controlling false alarms.

Conclusion: KQT-EWMA provides a new approach for non-parametric change detection with controlled false alarms.
...
### [358] [Comparing Exploration-Exploitation Strategies of LLMs and Humans: Insights from Standard Multi-armed Bandit Tasks](https://arxiv.org/abs/2505.09901)
*Ziyuan Zhang,Darcy Wang,Ningyuan Chen,Rodrigo Mansur,Vahid Sarhangian*

Main category: cs.LG

TL;DR: This paper investigates whether large language models (LLMs) exhibit similar decision-making behavior to humans in exploration-exploitation tasks. It finds that while reasoning enables LLMs to behave more like humans in simple tasks, they struggle with adaptability in complex, non-stationary environments.


<details>
  <summary>Details</summary>
Motivation: To examine if LLMs can simulate human decision-making behavior in exploration-exploitation tasks.

Method: Using interpretable choice models on canonical multi-armed bandit tasks to compare strategies of LLMs, humans, and MAB algorithms.

Result: Reasoning shifts LLMs towards more human-like behavior, showing similar levels of random and directed exploration in simple tasks but struggling with adaptability in complex, non-stationary environments.

Conclusion: LLMs show promise as simulators of human behavior and tools for automated decision-making but have limitations, especially in adaptability for complex tasks.
...
### [359] [Adversarial Attacks in Multimodal Systems: A Practitioner's Survey](https://arxiv.org/abs/2505.03084)
*Shashank Kapoor,Sanjay Surendranath Girija,Lakshit Arora,Dipen Pradhan,Ankit Shetgaonkar,Aman Raj*

Main category: cs.LG

TL;DR: This paper surveys adversarial attacks targeting four modalities: text, image, video, and audio.


<details>
  <summary>Details</summary>
Motivation: To provide a practitioner-focused view of the threat landscape and outline attack types for multimodal models.
...
Conclusion: This survey is the first of its kind and aims to help practitioners view the threat landscape and take preventive actions.
...
### [360] [Avocado Price Prediction Using a Hybrid Deep Learning Model: TCN-MLP-Attention Architecture](https://arxiv.org/abs/2505.09907)
*Linwei Zhang,LuFeng,Ruijia Liang*

Main category: cs.LG

TL;DR: A hybrid deep learning model called TCN-MLP-Attention is proposed to forecast Hass avocado prices. It combines Temporal Convolutional Networks (TCN), Multi-Layer Perceptrons (MLP), and Attention mechanisms to handle nonlinear and dynamic data. The model performs better than traditional methods with an RMSE of 1.23 and an MSE of 1.51.


<details>
  <summary>Details</summary>
Motivation: The increasing importance of agricultural product price forecasting due to the growing demand for healthy foods, particularly focusing on Hass avocados.

Method: Proposing a hybrid deep learning model named TCN-MLP-Attention that uses TCN for sequential feature extraction, MLP for nonlinear interactions, and Attention for dynamic feature weighting.

Result: The model achieved an RMSE of 1.23 and an MSE of 1.51, outperforming traditional methods.

Conclusion: The research provides a scalable and effective approach for time series forecasting in agricultural markets, offering insights into intelligent supply chain management and price strategy optimization.
...
### [361] [Online Isolation Forest](https://arxiv.org/abs/2505.09593)
*Filippo Leveni,Guilherme Weigert Cassales,Bernhard Pfahringer,Albert Bifet,Giacomo Boracchi*

Main category: cs.LG

TL;DR: We introduce Online-iForest, an efficient method for anomaly detection in streaming conditions.


<details>
  <summary>Details</summary>
Motivation: Existing anomaly detection methods are not suitable for streaming conditions due to impractical assumptions and inefficiency.

Method: Online-iForest

Result: Online-iForest performs well in experimental validation on real-world datasets and outperforms competitors in efficiency.

Conclusion: Online-iForest is efficient and competitive with both online and offline anomaly detection methods.
...
### [362] [Improving the Euclidean Diffusion Generation of Manifold Data by Mitigating Score Function Singularity](https://arxiv.org/abs/2505.09922)
*Zichen Liu,Wei Zhang,Tiejun Li*

Main category: cs.LG

TL;DR: This paper proposes two methods to improve the sampling accuracy of diffusion models on manifold-constrained data.


<details>
  <summary>Details</summary>
Motivation: To investigate direct sampling of Euclidean diffusion models for general manifold-constrained data without explicitly utilizing the structure of special manifolds.

Method: The paper proposes two methods: Niso-DM, which adds non-isotropic noise along the normal direction, and Tango-DM, which trains only the tangential component of the score function.

Result: Numerical experiments show superior performance of the proposed methods on distributions over various manifolds with complex geometries.

Conclusion: The paper concludes that their proposed methods, Niso-DM and Tango-DM, effectively improve the sampling accuracy of Euclidean diffusion models for data constrained on general manifolds.
...
### [363] [Reinforced Interactive Continual Learning via Real-time Noisy Human Feedback](https://arxiv.org/abs/2505.09925)
*Yutao Yang,Jie Zhou,Junsong Li,Qianjun Pan,Bihao Zhan,Qin Chen,Xipeng Qiu,Liang He*

Main category: cs.LG

TL;DR: This paper proposes RiCL, a Reinforced interactive Continual Learning framework leveraging Large Language Models to learn new skills from dynamic feedback, which outperforms existing methods on benchmark datasets contaminated with realistic noise patterns.


<details>
  <summary>Details</summary>
Motivation: Traditional continual learning approaches have limitations like using static datasets and assuming clean labels. This paper aims to address these issues by introducing a dynamic learning paradigm that can handle noisy feedback.

Method: RiCL includes a purifier for cleaning data, an interaction-aware optimization strategy for aligning AI behavior with human intent, and a noise-resistant contrastive learning module for robust representation.

Result: Experiments show that RiCL outperforms other methods on benchmark datasets with realistic noise patterns.

Conclusion: The proposed RiCL framework effectively learns new skills from dynamic feedback while retaining prior knowledge and handling noisy labels.
...
### [364] [Advanced Crash Causation Analysis for Freeway Safety: A Large Language Model Approach to Identifying Key Contributing Factors](https://arxiv.org/abs/2505.09949)
*Ahmed S. Abdelrahman,Mohamed Abdel-Aty,Samgyu Yang,Abdulrahman Faden*

Main category: cs.LG

TL;DR: 本研究利用大语言模型分析自由流交通碰撞数据，识别主要碰撞原因并验证其在交通安全策略制定中的应用潜力。


<details>
  <summary>Details</summary>
Motivation: 传统统计方法和机器学习模型难以捕捉影响交通碰撞复杂交互因素的独特特性，本研究旨在利用大语言模型更全面地分析碰撞成因及相关因素。

Method: 使用Q-Lora微调Llama3 8B模型，利用226篇相关研究创建的数据集，对自由-flow交通碰撞数据进行分析并实现无预标注数据的零样本分类。

Result: 大语言模型成功识别出酒驾、超速、攻击性驾驶和注意力不集中等主要碰撞原因，并通过事件数据（如道路养护）提供了更深刻的见解。问卷调查显示88.89%的研究人员同意该模型的实用性。

Conclusion: 大语言模型能有效识别导致交通事故的主要原因，并提供合理的解释。通过与现有研究的一致性验证了其实际应用价值和提升交通安全措施的潜力。
...
### [365] [Task-Core Memory Management and Consolidation for Long-term Continual Learning](https://arxiv.org/abs/2505.09952)
*Tianyu Huai,Jie Zhou,Yuxuan Cai,Qin Chen,Wen Wu,Xingjiao Wu,Xipeng Qiu,Liang He*

Main category: cs.LG

TL;DR: This paper introduces Long-CL, a novel framework for long-term continual learning inspired by human memory mechanisms. It addresses catastrophic forgetting issues in sequential learning and shows superior performance on newly created benchmarks.


<details>
  <summary>Details</summary>
Motivation: To improve continual learning in scenarios with a large number of sequential tasks and reduce catastrophic forgetting.

Method: Proposes a task-core memory management strategy and a long-term memory consolidation mechanism to manage knowledge retention and adaptation.

Result: Long-CL outperforms previous state-of-the-art methods by 7.4% and 6.5% AP on the constructed MMLongCL-Bench and TextLongCL-Bench benchmarks.

Conclusion: The proposed Long-CL framework demonstrates effective mitigation of catastrophic forgetting and superior performance in long-term continual learning tasks.
...
### [366] [TransPL: VQ-Code Transition Matrices for Pseudo-Labeling of Time Series Unsupervised Domain Adaptation](https://arxiv.org/abs/2505.09955)
*Jaeho Kim,Seulki Lee*

Main category: cs.LG

TL;DR: Introduce TransPL, a novel approach to address the challenges in unsupervised domain adaptation for time series data.


<details>
  <summary>Details</summary>
Motivation: Traditional pseudo-labeling strategies fail to capture temporal patterns and channel-wise shifts between domains.

Method: Model the joint distribution P(X,y) of the source domain through code transition matrices derived from vector quantization of time series patches and employ Bayes' rule for target domain adaptation.

Result: TransPL outperforms state-of-the-art pseudo-labeling methods on four time series UDA benchmarks with significant accuracy and F1 improvements.

Conclusion: TransPL offers explicit modeling of temporal transitions and channel-wise shifts, versatility towards different UDA scenarios, and explainable pseudo-label generation.
...
### [367] [Approximated Behavioral Metric-based State Projection for Federated Reinforcement Learning](https://arxiv.org/abs/2505.09959)
*Zengxia Guo,Bohui An,Zhongqi Lu*

Main category: cs.LG

TL;DR: This paper proposes FedRAG, a federated reinforcement learning framework that enhances performance by sharing approximated behavior metric-based state projection functions without exposing sensitive information.


<details>
  <summary>Details</summary>
Motivation: To improve Federated Reinforcement Learning (FRL) performance while protecting sensitive information.

Method: Introducing FedRAG, which learns a projection function of states for each client and aggregates parameters at a central server without sharing sensitive task-specific information.

Result: Conducted extensive experiments on the DeepMind Control Suite showing insightful results.

Conclusion: Sharing approximated behavior metric-based state projection functions is a promising way to enhance FRL performance while providing effective protection of sensitive information.
...
### [368] [A Comprehensive Machine Learning Framework for Heart Disease Prediction: Performance Evaluation and Future Perspectives](https://arxiv.org/abs/2505.09969)
*Ali Azimi Lamir,Shiva Razzagzadeh,Zeynab Rezaei*

Main category: cs.LG

TL;DR: This study uses a machine learning framework with Logistic Regression, KNN, and Random Forest to predict heart disease from a 303-sample dataset, finding that Random Forest performs best with 91% accuracy.


<details>
  <summary>Details</summary>
Motivation: To develop a machine learning-based method for predicting heart disease using a specific heart-disease dataset.

Method: Data preprocessing, model training using Logistic Regression, KNN, and Random Forest classifiers, hyperparameter tuning with GridSearchCV and RandomizedSearchCV.

Result: Random Forest classifier achieved the highest accuracy (91%) and F1-score (0.89) among all models, showing balanced performance across classes.

Conclusion: The proposed machine learning model shows promise for aiding clinical decision-making in heart disease prediction, though limitations like dataset size and generalizability suggest the need for further research with larger, more diverse datasets.
...
### [369] [AI2MMUM: AI-AI Oriented Multi-Modal Universal Model Leveraging Telecom Domain Large Model](https://arxiv.org/abs/2505.10003)
*Tianyu Jiao,Zhuoran Xiao,Yihang Huang,Chenhui Ye,Yijia Feng,Liyu Cai,Jiang Chang,Fangkun Liu,Yin Xu,Dazhi He,Yunfeng Guan,Wenjun Zhang*
...
<details>
  <summary>Details</summary>
Motivation: To design a universal model capable of processing multi-modal data and executing diverse air interface tasks in future wireless systems.

Method: AI2MMUM uses a LLM backbone with fine-tuning, frozen radio modality encoders, adapter layers, and lightweight task-specific heads. Task instructions include fixed keywords and learnable prefix prompts.

Result: AI2MMUM achieves SOTA performance across five representative physical environment/wireless channel-based downstream tasks using the WAIR-D and DeepMIMO datasets.
...
### [370] [Sample Complexity of Distributionally Robust Average-Reward Reinforcement Learning](https://arxiv.org/abs/2505.10007)
*Zijun Chen,Shengbo Wang,Nian Si*

Main category: cs.LG

TL;DR: This paper studies distributionally robust average-reward reinforcement learning, proposing two algorithms with near-optimal sample complexity for achieving stable long-term performance in robotics, operations research, and healthcare.


<details>
  <summary>Details</summary>
Motivation: The need for stable long-term performance in critical applications like robotics, operations research, and healthcare drives the study of distributionally robust average-reward reinforcement learning.

Method: Two algorithms are proposed: one reduces the problem to a DR discounted MDP, while the second introduces an anchoring state to stabilize transition kernels within the uncertainty set.

Result: Both algorithms achieve near-optimal sample complexity for estimating the optimal policy and robust average reward under certain divergence-based uncertainty sets.

Conclusion: These are the first finite-sample convergence guarantees for distributionally robust average-reward reinforcement learning.
...
### [371] [ImagineBench: Evaluating Reinforcement Learning with Large Language Model Rollouts](https://arxiv.org/abs/2505.10010)
*Jing-Cheng Pang,Kaiyuan Li,Yidi Wang,Si-Hang Yang,Shengyi Jiang,Yang Yu*

Main category: cs.LG

TL;DR: Introduce ImagineBench, the first comprehensive benchmark for evaluating offline RL algorithms that use real and LLM-generated rollouts.


<details>
  <summary>Details</summary>
Motivation: The challenge of RL's dependence on extensive real-world interaction data and the lack of a standard benchmark for evaluating offline RL algorithms leveraging both real and LLM-imaginary rollouts.

Method: Developed ImagineBench with datasets of environment-collected and LLM-imaginary rollouts, diverse domains, and natural language task instructions.

Result: Existing offline RL algorithms perform suboptimally on unseen tasks when using LLM-imaginary rollouts compared to real rollouts.

Conclusion: There is a need for algorithm advancements to better utilize LLM-imaginary rollouts and identified opportunities for future research.
...
### [372] [Optimal normalization in quantum-classical hybrid models for anti-cancer drug response prediction](https://arxiv.org/abs/2505.10037)
*Takafumi Ito,Lysenko Artem,Tatsuhiko Tsunoda*

Main category: cs.LG

TL;DR: This paper introduces a novel normalization strategy for Quantum-classical Hybrid Machine Learning models to improve their stability and performance in predicting anti-cancer drug responses, especially when dealing with small datasets.


<details>
  <summary>Details</summary>
Motivation: The need for effective data encoding in hybrid models to ensure stability and optimal performance in biomedical data analysis.

Method: Proposing a normalization function based on a moderated gradient version of the tanh function to transform neural network outputs.

Result: QHML models with the proposed normalization outperformed classical models in predicting drug responses using gene expression and drug response measurements.

Conclusion: This study demonstrates the potential of using quantum computers for biomedical data analysis through improved hybrid machine learning models.
...
### [373] [Rethinking Circuit Completeness in Language Models: AND, OR, and ADDER Gates](https://arxiv.org/abs/2505.10039)
*Hang Chen,Jiaying Zhu,Xinyu Yang,Wenya Wang*

Main category: cs.LG

TL;DR: This paper introduces a framework that combines noising-based and denoising-based interventions to identify and distinguish logic gates in neural networks, improving the faithfulness, completeness, and sparsity of circuit discovery.


<details>
  <summary>Details</summary>
Motivation: To address incompleteness issues in circuit discovery methods caused by OR gates not being fully detected.

Method: Systematically introducing three types of logic gates (AND, OR, ADDER) and decomposing circuits into combinations of these gates. Proposing a framework combining noising-based and denoising-based interventions.

Result: The framework can fully identify and distinguish logic gates within circuits, restoring their faithfulness, completeness, and sparsity. Fundamental properties of the logic gates, such as their proportions and contributions to outputs, were uncovered.

Conclusion: The proposed framework enhances mechanistic interpretability of neural networks by ensuring completeness in circuit discovery and exploring the behavior of logic gates in language model functionalities.
...
### [374] [Instance-Prototype Affinity Learning for Non-Exemplar Continual Graph Learning](https://arxiv.org/abs/2505.10040)
*Lei Song,Jiaxing Li,Shihan Guan,Youyong Kong*

Main category: cs.LG

TL;DR: This paper introduces Instance-Prototype Affinity Learning (IPAL), a novel approach for continual graph learning without using exemplars. It aims to improve knowledge retention and performance on node classification tasks.


<details>
  <summary>Details</summary>
Motivation: To address catastrophic forgetting in GNNs when learning continuously from new data, while avoiding issues like memory explosion and privacy concerns with rehearsal-based methods.

Method: Proposes IPAL which uses Topology-Integrated Gaussian Prototypes (TIGP) and Instance-Prototype Affinity Distillation (IPAD). Also enhances Prototype Contrastive Learning with Decision Boundary Perception (DBP).

Result: Demonstrated superior performance compared to existing methods on four node classification benchmarks, balancing plasticity and stability effectively.

Conclusion: IPAL provides an effective solution for non-exemplar continual graph learning, showing promise in maintaining model performance over time without forgetting past knowledge.
...
### [375] [Financial Fraud Detection Using Explainable AI and Stacking Ensemble Methods](https://arxiv.org/abs/2505.10050)
*Fahad Almalki,Mehedi Masud*

Main category: cs.LG

TL;DR: This research proposes a fraud detection framework that combines popular gradient boosting models with XAI techniques for better transparency and interpretability.


<details>
  <summary>Details</summary>
Motivation: The lack of transparency in traditional machine learning models makes it hard for organizations to meet regulatory requirements and earn stakeholders' trust.

Method: Stacking ensemble of XGBoost, LightGBM, and CatBoost models with XAI techniques including SHAP, LIME, PDP, and PFI.

Result: High performance with 99% accuracy and 0.99 AUC-ROC score on IEEE-CIS Fraud Detection dataset, surpassing several recent related approaches.

Conclusion: Combining high prediction accuracy with transparent interpretability is possible and could result in a more ethical and trustworthy solution in financial fraud detection.
...
### [376] [JointDistill: Adaptive Multi-Task Distillation for Joint Depth Estimation and Scene Segmentation](https://arxiv.org/abs/2505.10057)
*Tiancong Cheng,Ying Zhang,Yuxuan Liang,Roger Zimmermann,Zhiwen Yu,Bin Guo*

Main category: cs.LG

TL;DR: 提出了一种自适应蒸馏方法和基于知识轨迹的蒸馏损失来改进深度估计和场景分割的联合建模。在多个基准数据集上评估了该方法，结果表明其性能优于现有最先进的解决方案。


<details>
  <summary>Details</summary>
Motivation: 减少存储和训练努力的需求，提高统一建模的效果。

Method: 提出了一种自适应蒸馏方法和基于知识轨迹的蒸馏损失。

Result: 在Cityscapes和NYU-v2等基准数据集上的实验表明，该方法优于现有的最先进的解决方案。

Conclusion: 本研究提出的方法可以有效地改善深度估计和场景分割任务的联合建模。
...
### [377] [ChronoSteer: Bridging Large Language Model and Time Series Foundation Model via Synthetic Data](https://arxiv.org/abs/2505.10083)
*Chengsen Wang,Qi Qi,Zhongwen Rao,Lujia Pan,Jingyu Wang,Jianxin Liao*

Main category: cs.LG

TL;DR: This paper presents ChronoSteer, a multimodal time series forecasting model that integrates large language models and time series foundation models by using textual revision instructions to steer the output of TSFM, achieving superior performance.


<details>
  <summary>Details</summary>
Motivation: To address the limitation of conventional forecasting methods relying solely on unimodal time series data, the paper aims to leverage both temporal and textual information for better forecasting.

Method: A decoupled framework where LLM transforms textual events into revision instructions to guide TSFM's output. ChronoSteer is introduced as a multimodal TSFM that can be steered by these instructions. A two-stage training strategy based on synthetic data is used to handle data shortages.

Result: ChronoSteer, trained only on synthetic data, shows a 25.7% improvement in prediction accuracy over unimodal models and a 22.5% gain over the previous best multimodal method.

Conclusion: The integration of LLMs and TSFMs via textual revision instructions proves effective for multimodal time series forecasting.
...
### [378] [Learning Virtual Machine Scheduling in Cloud Computing through Language Agents](https://arxiv.org/abs/2505.10117)
*JieHao Wu,Ziwei Wang,Junjie Sheng,Wenhao Li,Xiangfei Wang,Jun Luo*

Main category: cs.LG

TL;DR: 提出了一种名为MiCo的分层语言代理框架，用于解决大规模复杂云环境中的虚拟机调度问题，实现了高效的策略生成与组合。


<details>
  <summary>Details</summary>
Motivation: 传统优化方法无法适应实时变化，领域专家设计的启发式方法策略僵化，现有的基于学习的方法通常缺乏通用性和可解释性。因此需要一种新的方法来解决在线动态多维装箱问题(ODMBP)。

Method: 提出了一个名为MiCo的分层语言代理框架，包括两个阶段：Option Miner 和 Option Composer。Option Miner 使用LLMs发现无上下文感知的策略；Option Composer 使用LLMs发现一种整合无上下文和有上下文策略的组合策略。

Result: 在真实企业数据集上的大量实验表明，MiCo在涉及超过10,000个虚拟机的大规模场景中达到了96.9%的竞争比。它在非平稳请求流和多样化配置下也保持了高绩效，验证了其在复杂和大规模云环境中的有效性。

Conclusion: MiCo框架通过引入大型语言模型驱动的启发式设计范式，成功解决了大规模复杂云环境中虚拟机调度的问题，在非平稳请求流和多样化配置下仍能保持高性能。
...
### [379] [All You Need Is Synthetic Task Augmentation](https://arxiv.org/abs/2505.10120)
*Guillaume Godin*

Main category: cs.LG

TL;DR: A new approach using synthetic tasks improves multitask molecular property prediction without requiring pretraining or feature injection.


<details>
  <summary>Details</summary>
Motivation: Injecting rule-based models like Random Forests into differentiable neural network frameworks remains an open challenge in machine learning.

Method: Jointly training a single Graph Transformer neural network on both sparse multitask molecular property experimental targets and synthetic targets derived from XGBoost models trained on Osmordred molecular descriptors.

Result: Consistent and significant performance improvement across all 19 molecular property prediction tasks. For 16 out of 19 targets, the multitask Graph Transformer outperforms the XGBoost single-task learner.

Conclusion: Synthetic task augmentation is an effective method for enhancing neural model performance in multitask molecular property prediction without the need for feature injection or pretraining.
...
### [380] [Enhancing the Performance of Global Model by Improving the Adaptability of Local Models in Federated Learning](https://arxiv.org/abs/2505.10125)
*Wujun Zhou,Shu Ding,ZeLin Li,Wei Wang*

Main category: cs.LG

TL;DR: This paper proposes a method to improve the performance of the global model in federated learning by enhancing the adaptability of local models through formulating a local training objective with a constraint.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of training local models with heterogeneous data distributions and data privacy issues in federated learning.

Method: Formulating the property of an appropriate local model into a local training objective with a constraint and proposing a feasible solution to train the local model.

Result: The proposed method significantly improves the adaptability of local models and results in a better-performed global model compared to baseline methods.

Conclusion: Enhancing the adaptability of local models can effectively improve the performance of the global model in federated learning.
...
### [381] [Robust Federated Learning on Edge Devices with Domain Heterogeneity](https://arxiv.org/abs/2505.10128)
*Huy Q. Le,Latif U. Khan,Choong Seon Hong*

Main category: cs.LG

TL;DR: This paper presents FedAPC, a new Federated Learning framework that improves generalization under domain heterogeneity by introducing prototype augmentation.
...
Method: FedAPC uses prototypes derived from augmented data to align local features with global prototypes, enhancing feature diversity and model robustness.

Result: The proposed method outperforms state-of-the-art baselines on Office-10 and Digits datasets.

Conclusion: FedAPC effectively improves the generalization ability of the global model in Federated Learning under domain heterogeneity.
...
### [382] [Near Optimal Best Arm Identification for Clustered Bandits](https://arxiv.org/abs/2505.10147)
*Yash,Nikhil Karamchandani,Avishek Ghosh*
...
### [383] [ComplexFormer: Disruptively Advancing Transformer Inference Ability via Head-Specific Complex Vector Attention](https://arxiv.org/abs/2505.10222)
*Jintian Shao,Hongyi Huang,Jiayi Wu,Beiwen Zhang,ZhiYu Wu,You Shan,MingKai Zheng*

Main category: cs.LG

TL;DR: This paper presents ComplexFormer, which improves Transformer models by introducing Complex Multi-Head Attention (CMHA) that allows each attention head to independently model semantic and positional differences.


<details>
  <summary>Details</summary>
Motivation: Existing Transformer models struggle to effectively integrate positional information while maintaining flexibility in multi-head attention.

Method: ComplexFormer introduces CMHA, which represents interactions as rotations and scaling in the complex plane. It also includes a per-head Euler transformation and an adaptive differential rotation mechanism.

Result: ComplexFormer outperforms strong baselines like RoPE-Transformers in language modeling, text generation, code generation, and mathematical reasoning tasks, achieving better performance and lower generation perplexity.
...
### [384] [QuXAI: Explainers for Hybrid Quantum Machine Learning Models](https://arxiv.org/abs/2505.10167)
*Saikat Barua,Mostafizur Rahman,Shehenaz Khaled,Md Jafor Sadek,Rafiul Islam,Shahnewaz Siddique*

Main category: cs.LG

TL;DR: This paper introduces QuXAI, a framework based on Q-MEDLEY, aimed at improving the explainability of hybrid quantum-classical machine learning models with quantized feature encoding.


<details>
  <summary>Details</summary>
Motivation: To address the lack of robust global and local explainability approaches for hybrid quantum-classical machine learning architectures.

Method: Creating HQML models with quantum feature maps, using Q-MEDLEY to combine feature-based inferences while preserving the quantum transformation stage and visualizing attributions.

Result: Q-MEDLEY effectively identifies influential classical aspects in HQML models, separates noise, and performs competitively in classical validation settings.

Conclusion: QuXAI improves the interpretability and reliability of HQML models, fostering greater confidence and responsible use of quantum-enhanced AI technology.
...
### [385] [Does Scaling Law Apply in Time Series Forecasting?](https://arxiv.org/abs/2505.10172)
*Zeyan Li,Libing Chen,Yin Tang*

Main category: cs.LG

TL;DR: This paper introduces Alinear, an ultra-lightweight time series forecasting model that uses fewer parameters but performs competitively compared to larger models. It features a horizon-aware adaptive decomposition mechanism and a progressive frequency attenuation strategy.


<details>
  <summary>Details</summary>
Motivation: To question whether scaling up model size is truly necessary for time series forecasting.

Method: Alinear model with adaptive decomposition and frequency attenuation strategies.

Result: Alinear outperforms large-scale models on multiple datasets while using less than 1% of their parameters, maintaining accuracy across short and long forecasting horizons.

Conclusion: The paper challenges the idea that bigger models are always better, suggesting a shift towards more efficient time series modeling approaches.
...
### [386] [Defect Detection in Photolithographic Patterns Using Deep Learning Models Trained on Synthetic Data](https://arxiv.org/abs/2505.10192)
*Prashant P. Shinde,Priyadarshini P. Pai,Shashishekar P. Adiga,K. Subramanya Mayya,Yongbeom Seo,Myungsoo Hwang,Heeyoung Go,Changmin Park*

Main category: cs.LG

TL;DR: This paper demonstrates that synthetic data can be used to train robust machine-learning models for defect detection in EUV pattering.


<details>
  <summary>Details</summary>
Motivation: The lack of defect-annotated quality data with good representation of smaller defects has prohibited deployment of deep learning based defect detection models in fabrication lines.

Method: Artificial generation of SEM images with known defect distributions and autonomous annotation were used to create a dataset for training and testing deep learning models. YOLOv8 was found to have the best performance in detecting smaller defects.

Result: YOLOv8 achieved the highest mean average precision of 96% in detecting smaller defects, followed by EfficientNet (83%) and SSD (77%). The model also correctly detected 84.6% of Bridge defects and 78.3% of Break defects in real SEM data.

Conclusion: Synthetic data generated from SEM images can be effectively used to train deep learning models for defect detection in EUV pattering.
...
### [387] [Superposition Yields Robust Neural Scaling](https://arxiv.org/abs/2505.10465)
*Yizhou liu,Ziming Liu,Jeff Gore*

Main category: cs.LG

TL;DR: Large language models (LLMs) perform better with larger sizes, but why? This paper finds that representation superposition is key. A toy model shows that under strong superposition, loss scales inversely with model dimension, matching real LLMs. This suggests that efficient training could be achieved with fewer resources.


<details>
  <summary>Details</summary>
Motivation: To understand the origin of the neural scaling law in LLMs, which states that loss decreases as a power law with model size.

Method: Constructed a toy model based on empirical principles of representation superposition and varying word/concept frequencies to study loss scaling with model size.

Result: Under weak superposition, loss scaling depends on feature frequency; under strong superposition, loss is inversely proportional to model dimension. Four families of open-sourced LLMs were analyzed and shown to exhibit strong superposition.

Conclusion: Representation superposition is an important mechanism for the neural scaling laws in LLMs, suggesting potential for more efficient training strategies and architectures.
...
### [388] [A multi-head deep fusion model for recognition of cattle foraging events using sound and movement signals](https://arxiv.org/abs/2505.10198)
*Mariano Ferrero,José Omar Chelotti,Luciano Sebastián Martinez-Rau,Leandro Vignolo,Martín Pires,Julio Ricardo Galli,Leonardo Luis Giovanini,Hugo Leonardo Rufiner*

Main category: cs.LG

TL;DR: This paper introduces a deep neural network that fuses acoustic and inertial signals to monitor feeding behaviors in grazing cattle, achieving better accuracy than previous methods.


<details>
  <summary>Details</summary>
Motivation: Monitoring feeding behavior is important for efficient herd management and resource use.

Method: A deep neural network based on the fusion of acoustic and inertial signals was developed.

Result: The model yielded an F1-score value of 0.802, representing a 14% increase compared to previous methods.

Conclusion: The proposed model has demonstrated superior performance compared to existing methods.
...
### [389] [Parallel Scaling Law for Language Models](https://arxiv.org/abs/2505.10475)
*Mouxiang Chen,Binyuan Hui,Zeyu Cui,Jiaxi Yang,Dayiheng Liu,Jianling Sun,Junyang Lin,Zhongxin Liu*

Main category: cs.LG

TL;DR: We introduce a novel parallel scaling (ParScale) method that improves inference efficiency by applying diverse transformations to inputs and executing model forward passes in parallel.


<details>
  <summary>Details</summary>
Motivation: To find a more efficient way to scale language models beyond increasing parameters or output tokens.

Method: Parallel scaling (ParScale), which applies diverse and learnable transformations to the input, executes forward passes in parallel, and aggregates the outputs.

Result: ParScale requires significantly less memory and latency increase compared to parameter scaling while achieving similar performance. It can also post-train an existing model to make it parallelly scaled.

Conclusion: ParScale offers a new perspective on scaling language models and could enable more powerful models in low-resource settings.
...
### [390] [Informed Forecasting: Leveraging Auxiliary Knowledge to Boost LLM Performance on Time Series Forecasting](https://arxiv.org/abs/2505.10213)
*Mohammadmahdi Ghasemloo,Alireza Moradi*

Main category: cs.LG

TL;DR: This paper proposes a new method to use large language models for time series forecasting by transferring structured temporal knowledge, showing better performance than without such knowledge transfer.
...
### [391] [RouteNator: A Router-Based Multi-Modal Architecture for Generating Synthetic Training Data for Function Calling LLMs](https://arxiv.org/abs/2505.10495)
*Vibha Belavadi,Tushar Vatsa,Dewang Sultania,Suhas Suresha,Ishita Verma,Cheng Chen,Tracy Holloway King,Michael Friedrich*

Main category: cs.LG

TL;DR: Introduces a novel method to generate synthetic data for fine-tuning LLMs in function calling tasks, improving performance significantly.


<details>
  <summary>Details</summary>
Motivation: Fine-tuning LLMs for function calling tasks without real user interaction data due to the lack of task-specific data and privacy constraints.

Method: A novel router-based architecture leveraging domain resources and language models to generate high-quality synthetic training data.

Result: Significant improvements in function classification accuracy and API parameter selection.

Conclusion: Models fine-tuned with our synthetic data outperform traditional approaches.
...
### [392] [MASSV: Multimodal Adaptation and Self-Data Distillation for Speculative Decoding of Vision-Language Models](https://arxiv.org/abs/2505.10526)
*Mugilan Ganesan,Shane Segal,Ankur Aggarwal,Nish Sinnadurai,Sean Lie,Vithursan Thangarasa*

Main category: cs.LG

TL;DR: Speculative decoding accelerates language model inference but faces challenges when applied to vision-language models (VLMs). A new method called MASSV is introduced to transform small language models into effective multimodal drafters for VLMs, achieving up to 30% increase in accepted length and up to 1.46x end-to-end inference speedups on visually-grounded tasks.


<details>
  <summary>Details</summary>
Motivation: To apply speculative decoding technique to vision-language models despite the challenges posed by the lack of architectural components in small language models to process visual inputs and mismatched token predictions.

Method: A two-phase approach named MASSV is used: first, connecting the target VLM's vision encoder to the draft model via a lightweight trainable projector; second, applying self-distilled visual instruction tuning using responses from the target VLM to align token predictions.

Result: MASSV increases accepted length by up to 30% and provides end-to-end inference speedups of up to 1.46x on visually-grounded tasks.

Conclusion: MASSV offers a scalable and architecture-compatible method for accelerating current and future VLMs.
...
### [393] [SpecOffload: Unlocking Latent GPU Capacity for LLM Inference on Resource-Constrained Devices](https://arxiv.org/abs/2505.10259)
*Xiangwen Zhuge,Xu Shen,Zeyu Wang,Fan Dang,Xuan Ding,Danyang Li,Yahui Han,Tianxiang Hao,Zheng Yang*

Main category: cs.LG

TL;DR: SpecOffload is a new method that improves the efficiency of large language model inference on devices with limited GPU memory by using speculative decoding, which enhances GPU core utilization and inference throughput.


<details>
  <summary>Details</summary>
Motivation: Existing systems offload model weights to CPU memory due to limited GPU memory, causing significant I/O overhead and inefficient GPU usage.

Method: SpecOffload embeds speculative decoding into offloading, using a draft model stored and executed on the GPU to accelerate inference.

Result: SpecOffload increases GPU core utilization by 4.49x and boosts inference throughput by 2.54x compared to the best baseline.

Conclusion: SpecOffload provides an efficient way to perform large language model inference on resource-constrained devices.
...
### [394] [Electric Bus Charging Schedules Relying on Real Data-Driven Targets Based on Hierarchical Deep Reinforcement Learning](https://arxiv.org/abs/2505.10262)
*Jiaju Qi,Lei Lei,Thorsteinn Jonsson,Lajos Hanzo*

Main category: cs.LG

TL;DR: This paper proposes a Hierarchical DRL method to solve the charging scheduling problem of Electric Buses (EBs), which can minimize charging costs while meeting charging targets.


<details>
  <summary>Details</summary>
Motivation: To overcome the challenge of long-range multi-phase planning with sparse reward in the charging scheduling problem of Electric Buses (EBs) based on Deep Reinforcement Learning (DRL).

Method: Proposed Hierarchical Double Deep Q-Network (HDDQN)-Hindsight Experience Replay (HER) algorithm for simultaneously solving the decision problems arising at different temporal resolutions.

Result: Minimizing the charging costs while meeting the charging target.

Conclusion: Proved that the flat policy constructed by superimposing the optimal high-level policy and the optimal low-level policy performs as well as the optimal policy of the original MDP.
...
### [395] [Cutting Through Privacy: A Hyperplane-Based Data Reconstruction Attack in Federated Learning](https://arxiv.org/abs/2505.10264)
*Francesco Diana,André Nusser,Chuan Xu,Giovanni Neglia*

Main category: cs.LG

TL;DR: This paper introduces a novel data reconstruction attack in Federated Learning that improves upon existing methods by leveraging a new geometric perspective to achieve perfect recovery of arbitrarily large data batches without prior knowledge of clients' data.


<details>
  <summary>Details</summary>
Motivation: To address the vulnerabilities in Federated Learning where a malicious central server can manipulate model updates to reconstruct clients' private training data.

Method: Introduces a new geometric perspective on fully connected layers to craft malicious model parameters.

Result: The method achieves perfect reconstruction of data batches two orders of magnitude larger than previous state-of-the-art methods.

Conclusion: The proposed attack demonstrates significant improvements in efficiency and scalability for data reconstruction in Federated Learning.
...
### [396] [RainPro-8: An Efficient Deep Learning Model to Estimate Rainfall Probabilities Over 8 Hours](https://arxiv.org/abs/2505.10271)
*Rafael Pablos Sarabia,Joachim Nyborg,Morten Birk,Jeppe Liborius Sjørup,Anders Lillevang Vesterholt,Ira Assent*

Main category: cs.LG

TL;DR: Develop a deep learning model for high-resolution precipitation forecasting in Europe.


<details>
  <summary>Details</summary>
Motivation: Radar-only models have short forecast lead times.

Method: Integrate multiple data sources and capture long-range interactions.

Result: The model surpasses operational NWP systems, extrapolation-based methods, and deep-learning nowcasting models.

Conclusion: This model sets a new standard for high-resolution precipitation forecasting in Europe.
...
### [397] [Spike-timing-dependent Hebbian learning as noisy gradient descent](https://arxiv.org/abs/2505.10272)
*Niklas Dexheimer,Sascha Gaudlitz,Johannes Schmidt-Hieber*

Main category: cs.LG

TL;DR: This paper explores a Hebbian spike-timing-dependent plasticity rule, relating it to noisy gradient descent and proving its ability to identify the presynaptic neuron with the highest activity.


<details>
  <summary>Details</summary>
Motivation: To understand learning rules accounting for precise spike-timing in biological neural networks.

Method: Relating the Hebbian spike-timing-dependent plasticity rule to noisy gradient descent with respect to a natural loss function on the probability simplex.

Result: The learning rule can eventually identify the presynaptic neuron with the highest activity.

Conclusion: An intrinsic connection between the learning rule and noisy mirror descent has been discovered.
...
### [398] [Optimizing Electric Bus Charging Scheduling with Uncertainties Using Hierarchical Deep Reinforcement Learning](https://arxiv.org/abs/2505.10296)
*Jiaju Qi,Lei Lei,Thorsteinn Jonsson,Dusit Niyato*

Main category: cs.LG

TL;DR: This paper presents a Hierarchical Deep Reinforcement Learning (HDRL) approach called DAC-MAPPO-E to optimize charging schedules for electric bus fleets.


<details>
  <summary>Details</summary>
Motivation: Optimizing electric bus charging schedules is challenging due to uncertainties in travel time, energy consumption, and fluctuating electricity prices.

Method: The paper proposes a HDRL approach that reformulates the original MDP into two augmented MDPs and introduces a novel HDRL algorithm called DAC-MAPPO-E.

Result: Experiments with real-world data show that DAC-MAPPO-E outperforms other methods in optimizing electric bus fleet charging schedules.

Conclusion: The proposed DAC-MAPPO-E algorithm addresses the scalability challenges of the Double Actor-Critic algorithm for large-scale electric bus fleets.
...
### [399] [Defending the Edge: Representative-Attention for Mitigating Backdoor Attacks in Federated Learning](https://arxiv.org/abs/2505.10297)
*Chibueze Peace Obioma,Youcheng Sun,Mustafa A. Mustafa*

Main category: cs.LG

TL;DR: This paper proposes FeRA, a novel defense mechanism for federated learning that uses cross-client attention to identify malicious clients based on feature representation anomalies, showing robust performance across various non-IID data distributions.


<details>
  <summary>Details</summary>
Motivation: The heterogeneity of edge devices in federated learning leads to non-IID data, making backdoor attack detection challenging.

Method: FeRA computes anomaly scores using representation reconstruction errors and cross-client attention to distinguish benign from malicious clients.

Result: FeRA effectively reduces backdoor attack success rates while maintaining high accuracy on the main task in various FL scenarios.

Conclusion: FeRA is model-agnostic, attack-agnostic, and does not require labeled reference data, making it suitable for heterogeneous and resource-limited edge environments.
...
### [400] [PIF: Anomaly detection via preference embedding](https://arxiv.org/abs/2505.10441)
*Filippo Leveni,Luca Magri,Giacomo Boracchi,Cesare Alippi*

Main category: cs.LG

TL;DR: A new anomaly detection method called PIF combines adaptive isolation methods with preference embedding to compute an anomaly score in a high dimensional space using PI-Forest. It shows favorable results compared to other techniques.


<details>
  <summary>Details</summary>
Motivation: To address the problem of detecting anomalies with respect to structured patterns by combining adaptive isolation methods with preference embedding.

Method: PIF method which uses PI-Forest to compute an anomaly score in a high dimensional space.

Result: Experiments on synthetic and real datasets show that PIF compares favorably with state-of-the-art techniques and PI-Forest is better at measuring arbitrary distances and isolating points in the preference space.

Conclusion: The proposed PIF method is effective for anomaly detection and PI-Forest shows improved performance in measuring distances and isolating points.
...
### [401] [Negative Metric Learning for Graphs](https://arxiv.org/abs/2505.10307)
*Yiyang Zhao,Chengpei Wu,Lilin Zhang,Ning Yang*

Main category: cs.LG

TL;DR: This paper introduces NML-GCL, a graph contrastive learning method that uses NMN to improve negative sample distinction and addresses the false negative issue without relying on human prior knowledge.


<details>
  <summary>Details</summary>
Motivation: Improve graph contrastive learning by reducing false negatives without using human prior knowledge.

Method: Introduce NML-GCL with NMN for building a negative metric space and use a joint training scheme with bi-level optimization for implicit self-supervision.

Result: Theoretical analysis and experiments on benchmarks show the superiority of the proposed method.

Conclusion: NML-GCL improves graph contrastive learning by distinguishing false negatives better through a learnable negative metric network and joint training with bi-level optimization.
...
### [402] [SEAL: Searching Expandable Architectures for Incremental Learning](https://arxiv.org/abs/2505.10457)
*Matteo Gambella,Vicente Javier Castro Solar,Manuel Roveri*

Main category: cs.LG

TL;DR: SEAL is a NAS-based framework for data-incremental learning that dynamically expands the model structure only when necessary and preserves stability through cross-distillation training after each expansion step.


<details>
  <summary>Details</summary>
Motivation: The key challenge in incremental learning is balancing plasticity and stability, which is especially difficult in resource-constrained environments.

Method: SEAL adapts the model structure dynamically based on a capacity estimation metric and jointly searches for both the architecture and the optimal expansion policy using NAS.

Result: SEAL effectively reduces forgetting and enhances accuracy while maintaining a lower model size compared to prior methods.

Conclusion: The results demonstrate the promise of combining NAS and selective expansion for efficient, adaptive learning in incremental scenarios.
...
### [403] [Asynchronous Decentralized SGD under Non-Convexity: A Block-Coordinate Descent Framework](https://arxiv.org/abs/2505.10322)
*Yijie Zhou,Shi Pu*

Main category: cs.LG

TL;DR: This paper presents a refined model of Asynchronous Decentralized Stochastic Gradient Descent (ADSGD) with practical assumptions. It analyzes the convergence of ADSGD and demonstrates its superior performance in wall-clock convergence time compared to existing methods.
...
Method: Introduces ADSGD model under practical assumptions, analyzes ASBCD as a tool, and proves the convergence of ADSGD.

Result: ADSGD shows better performance in wall-clock convergence time across different scenarios.

Conclusion: ADSGD is simple, efficient, and robust, making it suitable for real-world decentralized learning tasks.
...
### [404] [A Representation Learning Approach to Feature Drift Detection in Wireless Networks](https://arxiv.org/abs/2505.10325)
*Athanasios Tziouvaras,Blaz Bertalanic,George Floros,Kostas Kolomvatsos,Panagiotis Sarigiannidis,Carolina Fortuna*

Main category: cs.LG

TL;DR: This paper proposes ALERT, a method for detecting feature distribution changes in AI models used in wireless networks, which improves performance on wireless fingerprinting and link anomaly detection.


<details>
  <summary>Details</summary>
Motivation: To address the issue of feature distribution changes degrading AI model performance in real wireless network deployments.

Method: ALERT, which includes representation learning (using MLP), statistical testing (Kolmogorov-Smirnov and Population Stability Index tests), and utility assessment (a new function).

Result: The proposed method outperforms ten standard drift detection methods on two wireless network use cases.

Conclusion: ALERT effectively detects feature distribution changes and triggers model re-training to maintain AI model performance in wireless networks.
...
### [405] [Efficient Adaptation of Reinforcement Learning Agents to Sudden Environmental Change](https://arxiv.org/abs/2505.10330)
*Jonathan Clifford Balloch*

Main category: cs.LG

TL;DR: This dissertation demonstrates that efficient online adaptation for RL agents requires two key capabilities: prioritized exploration and sampling strategies and selective preservation of prior knowledge.


<details>
  <summary>Details</summary>
Motivation: Autonomous decision-making systems must operate in changing environments.

Method: Deep reinforcement learning methods with structured representations.

Result: The proposed method can help RL agents efficiently adapt their behavior when encountering novel environmental changes during deployment without catastrophically forgetting useful prior knowledge.

Conclusion: Efficient online adaptation for RL agents requires two key capabilities: prioritized exploration and sampling strategies and selective preservation of prior knowledge.
...
### [406] [Emergence of Structure in Ensembles of Random Neural Networks](https://arxiv.org/abs/2505.10331)
*Luca Muscarnera,Luigi Loreti,Giovanni Todeschini,Alessio Fumagalli,Francesco Regazzoni*

Main category: cs.LG

TL;DR: This study introduces a theoretical model to examine collective behaviors in random classifiers. It proves that under certain conditions, there's an optimal temperature for classification that doesn't depend on the teacher classifier or the number of classifiers.


<details>
  <summary>Details</summary>
Motivation: To understand the emergence of collective behaviors in random classifiers.

Method: Theoretical analysis and numerical confirmation using a Gaussian distribution and teacher perceptron.

Result: An optimal temperature for classification was found that is independent of the teacher classifier and the number of random classifiers.

Conclusion: The findings highlight the universal nature of the self-organizing behavior in random classifiers.
...
### [407] [An Introduction to Discrete Variational Autoencoders](https://arxiv.org/abs/2505.10344)
*Alan Jeffares,Liyuan Liu*

Main category: cs.LG

TL;DR: This tutorial introduces discrete variational autoencoders with categorical latent variables, providing a practical training recipe and example implementation.


<details>
  <summary>Details</summary>
Motivation: Discrete latent spaces have become popular in recent years, especially for text data, and this tutorial aims to make understanding them accessible to those with a basic math background.

Method: The tutorial derives the method step-by-step from first principles, focusing on VAEs with categorical latent variables.

Result: A concrete training recipe and an example implementation are provided.

Conclusion: This tutorial offers a rigorous yet practical introduction to discrete variational autoencoders.
...
### [408] [Uniform Loss vs. Specialized Optimization: A Comparative Analysis in Multi-Task Learning](https://arxiv.org/abs/2505.10347)
*Gabriel S. Gama,Valdir Grassi Jr*

Main category: cs.LG

TL;DR: Evaluate the effectiveness of Specialized Multi-Task Optimizers (SMTOs) against equally weighted tasks.


<details>
  <summary>Details</summary>
Motivation: Addressing critiques suggesting SMTOs' previous results were influenced by poor hyperparameter optimization and lack of regularization.
...
### [409] [FactsR: A Safer Method for Producing High Quality Healthcare Documentation](https://arxiv.org/abs/2505.10360)
*Victor Petrén Bach Hansen,Lasse Krogsbøll,Jonas Lyngsø,Mathias Baltzersen,Andreas Motzfeldt,Kevin Pelgrims,Lars Maaløe*

Main category: cs.LG

TL;DR: AI scribes currently generate notes after consultations using limited reasoning and risk inaccuracies. This paper introduces FactsR, which extracts clinical info in real-time and uses it to create more accurate and concise notes, improving patient safety and enabling real-time decision support.


<details>
  <summary>Details</summary>
Motivation: Current AI scribing methods for healthcare generate notes post-consultation with little reasoning, leading to potential inaccuracies and risks to patient safety due to clinician workload and fatigue. The motivation is to improve the accuracy and safety of these notes.

Method: FactsR, a method that extracts salient clinical information in real-time during consultations and uses this information recursively to generate the final note.

Result: The FactsR method results in more accurate and concise notes compared to existing methods, with the added benefit of enhancing real-time decision support.

Conclusion: Implementing the FactsR method can significantly enhance the accuracy and safety of AI-generated clinical notes by involving clinicians in the note generation process in real-time.
...
### [410] [Schreier-Coset Graph Propagation](https://arxiv.org/abs/2505.10392)
*Aryan Mishra,Lizhen Lin*

Main category: cs.LG

TL;DR: Graph Neural Networks (GNNs) face challenges due to over-squashing, which reduces the size of information from distant nodes. This paper presents Schrier-Coset Graph Propagation (SCGP), a method that enhances node features without changing graph topology. SCGP improves long-range message passing and shows better performance than some existing methods on various benchmarks, especially excelling in hierarchical and modular structures.


<details>
  <summary>Details</summary>
Motivation: To overcome the over-squashing issue in GNNs and improve long-range message passing.

Method: Introducing Schrier-Coset Graph Propagation (SCGP), a group-theoretic approach that augments node features through Schreier-coset embeddings.

Result: SCGP performs comparably or better than other methods like expander graph and rewired GNNs on standard benchmarks.

Conclusion: SCGP provides a scalable and efficient solution for improving GNNs' expressive power, particularly beneficial for hierarchical and modular graph structures.
...
### [411] [Two-Stage Generative Model for Intracranial Aneurysm Meshes with Morphological Marker Conditioning](https://arxiv.org/abs/2505.10407)
*Wenhao Ding,Choon Hwai Yap,Kangjun Ji,Simão Castro*

Main category: cs.LG

TL;DR: AneuG is a novel two-stage VAE-based IA mesh generator that can generate realistic intracranial aneurysm pouch shapes and parent vessels, with the ability to control specific morphological measurements.


<details>
  <summary>Details</summary>
Motivation: The lack of large IA image datasets and the limitations of existing shape generation methods make it necessary to develop a new method for generating realistic IA shapes with physiological realism and controllable morphological measurements.

Method: AneuG uses a two-stage VAE-based approach. The first stage generates low-dimensional GHD tokens to encode and reconstruct aneurysm pouch shapes, while the second stage generates parent vessels conditioned on GHD tokens.

Result: AneuG can generate realistic IA shapes with physiological realism and can be conditioned to have specific clinically relevant morphological measurements.

Conclusion: AneuG is a promising tool for training networks to predict blood flow forces in real-time and for studying the effects of specific clinical shape parameters on fluid dynamics.
...
### [412] [Decomposed Inductive Procedure Learning: Learning Academic Tasks with Human-Like Data Efficiency](https://arxiv.org/abs/2505.10422)
*Daniel Weitekamp,Christopher MacLellan,Erik Harpstead,Kenneth Koedinger*

Main category: cs.LG

TL;DR: This study explores whether human learners' rapid learning from tens of examples can be attributed to their ability to use multiple specialized learning mechanisms. By comparing reinforcement learning with a more data-efficient symbolic rule induction approach in online tutoring environments, the research finds that decomposing learning into multiple distinct mechanisms greatly enhances data efficiency, aligning it with human learning.


<details>
  <summary>Details</summary>
Motivation: To understand why human learners can learn rapidly from a small number of examples compared to data-driven deep learning approaches that require thousands of examples.

Method: Ablation analysis of inductive human learning simulations in online tutoring environments comparing reinforcement learning with a 3-mechanism symbolic rule induction approach.

Result: Decomposing learning into multiple distinct mechanisms significantly improves data efficiency, bringing it in line with human learning.
...
### [413] [The Power of Random Features and the Limits of Distribution-Free Gradient Descent](https://arxiv.org/abs/2505.10423)
*Ari Karchmer,Eran Malach*

Main category: cs.LG

TL;DR: This paper explores the connection between gradient-based optimization of neural networks and random feature methods, showing that neural networks trained with stochastic gradient descent can approximate functions using polynomial-sized random feature combinations, but highlights the limitations of distribution-free learning.


<details>
  <summary>Details</summary>
Motivation: To understand the relationship between neural network optimization and random feature methods and to explore the limitations of distribution-free learning.

Method: Analyzing the relationship between gradient-based optimization and random feature methods, introducing a new theoretical framework called average probabilistic dimension complexity (adc).

Result: Proved that a polynomial-sized combination of random features can approximate the target function, demonstrated an infinite separation between adc and standard dimension complexity.

Conclusion: The findings reveal fundamental limitations of distribution-free learning in neural networks trained by gradient descent, emphasizing the importance of making assumptions about data distributions in practice.
...
### [414] [Learning to Think: Information-Theoretic Reinforcement Fine-Tuning for LLMs](https://arxiv.org/abs/2505.10425)
*Jingyao Wang,Wenwen Qiang,Zeen Song,Changwen Zheng,Hui Xiong*

Main category: cs.LG

TL;DR: Introduces L2T, a method to enhance large language models' reasoning while reducing computational costs by optimizing token usage.


<details>
  <summary>Details</summary>
Motivation: Existing methods neglect the balance between reasoning effectiveness and computational efficiency, often resulting in unnecessarily long reasoning chains and wasted tokens.

Method: An information-theoretic reinforcement fine-tuning framework called Learning to Think (L2T).

Result: L2T improves performance on several reasoning benchmarks and base models, showing benefits across different tasks.

Conclusion: L2T optimizes large language models to improve both reasoning effectiveness and computational efficiency.
...
### [415] [Score-based diffusion nowcasting of GOES imagery](https://arxiv.org/abs/2505.10432)
*Randy J. Chase,Katherine Haynes,Lander Ver Hoef,Imme Ebert-Uphoff*

Main category: cs.LG

TL;DR: This paper explores the use of score-based diffusion models for nowcasting clouds and precipitation using geostationary infrared imagery. The authors compare three types of diffusion models and find that the residual correction diffusion model (CorrDiff) performs best, outperforming other models and traditional methods.


<details>
  <summary>Details</summary>
Motivation: Traditional numerical weather prediction requires sub-grid parameterizations which are challenging. Early machine learning methods often produced blurry forecasts.

Method: The authors explore three types of diffusion models: standard score-based diffusion model (Diff), residual correction diffusion model (CorrDiff), and latent diffusion model (LDM). They experiment with these models for nowcasting geostationary infrared imagery.

Result: The diffusion models were able to advect existing clouds, generate and decay clouds, and even initiate convective clouds. The CorrDiff approach outperformed other models and traditional methods on root mean squared error.

Conclusion: Score-based diffusion models show promise for nowcasting clouds and precipitation. The CorrDiff approach performed best among the tested models.
...
### [416] [Identification and Optimal Nonlinear Control of Turbojet Engine Using Koopman Eigenfunction Model](https://arxiv.org/abs/2505.10438)
*David Grasev*

Main category: cs.LG

TL;DR: This paper discusses the limitations of conventional experimental methods for deriving gas turbine models and proposes new identification techniques using data from standard engine operation. It estimates rotor dynamics, maps dynamics into a Koopman eigenfunction space, and designs a globally optimal nonlinear feedback controller, which outperforms other controllers in reference tracking and disturbance rejection.


<details>
  <summary>Details</summary>
Motivation: To overcome the challenges in deriving physics-based models for gas turbine engines by using data-driven approaches.

Method: Employing identification techniques based on data collected from standard engine operation, estimating rotor dynamics using sparse identification of nonlinear dynamics, mapping dynamics into a Koopman eigenfunction space, and designing a globally optimal nonlinear feedback controller.

Result: The proposed method resulted in a better performance tuning and the designed controller outperformed other benchmark controllers in reference tracking and disturbance rejection under different conditions.

Conclusion: Data-driven approaches can effectively address the limitations of conventional methods in deriving gas turbine models and designing superior controllers.
...
### [417] [Fine-tuning Diffusion Policies with Backpropagation Through Diffusion Timesteps](https://arxiv.org/abs/2505.10482)
*Ningyuan Yang,Jiaxuan Gao,Feng Gao,Yi Wu,Chao Yu*

Main category: cs.LG

TL;DR: A novel framework called NCDPO is introduced to improve the sample efficiency and final performance of diffusion policies in diverse scenarios.


<details>
  <summary>Details</summary>
Motivation: Existing diffusion policies suffer from sub-optimal and limited demonstration data, leading to potential failures. Reinforcement learning-based fine-tuning faces challenges in adapting PPO to diffusion models due to computational intractability.
...
Result: NCDPO shows comparable sample efficiency to MLP+PPO when training from scratch and outperforms existing methods in various benchmarks.

Conclusion: The proposed NCDPO framework improves the performance and robustness of diffusion policies in complex decision-making tasks.
...
### [418] [PnPXAI: A Universal XAI Framework Providing Automatic Explanations Across Diverse Modalities and Models](https://arxiv.org/abs/2505.10515)
*Seongun Kim,Sol A Kim,Geonhyeong Kim,Enver Menadjiev,Chanwoo Lee,Seongwook Chung,Nari Kim,Jaesik Choi*

Main category: cs.LG

TL;DR: A universal XAI framework named PnPXAI is introduced to support diverse data modalities and neural network models.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of existing XAI frameworks such as limited flexibility, restricted number of supported methods, and sub-optimal recommendations.

Method: PnPXAI automatically detects model architectures, recommends explanation methods, and optimizes hyperparameters.

Result: The framework's effectiveness is validated through user surveys and its versatility is showcased across domains like medicine and finance.

Conclusion: PnPXAI provides a flexible and optimal solution for XAI technology adoption in real-world applications.
...
### [419] [Fixing Incomplete Value Function Decomposition for Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2505.10484)
*Andrea Baisero,Rupali Bhati,Shuo Liu,Aathira Pillai,Christopher Amato*

Main category: cs.LG

TL;DR: Value function decomposition methods for cooperative multi-agent reinforcement learning.
...
Method: Presenting a novel family of value function decomposition models called QFIX, which expands the representation capabilities of prior models with a thin "fixing" layer.

Result: QFIX enhances the performance of prior methods, learns more stably, performs better than its main competitor QPLEX, and achieves this while employing the simplest and smallest mixing models.

Conclusion: QFIX is a simple yet effective solution for value function decomposition in cooperative multi-agent reinforcement learning.
...
### [420] [Neural Thermodynamic Laws for Large Language Model Training](https://arxiv.org/abs/2505.10559)
*Ziming Liu,Yizhou Liu,Jeff Gore,Max Tegmark*

Main category: cs.LG

TL;DR: This paper introduces Neural Thermodynamic Laws (NTL), a new framework providing insights into large language model training dynamics. Theoretically, it shows how thermodynamic concepts emerge from river-valley loss landscapes, while practically, it gives guidance on creating learning rate schedules.


<details>
  <summary>Details</summary>
Motivation: To explore the laws underlying large language models beyond neural scaling laws.

Method: Introduces Neural Thermodynamic Laws framework which demonstrates thermodynamic quantities and principles emerging from river-valley loss landscapes.

Result: Key thermodynamic quantities and principles naturally appear under certain assumptions, and practical guidelines for learning rate schedules are derived.

Conclusion: The introduction of Neural Thermodynamic Laws provides a novel perspective on understanding large language model training dynamics.
...
### [421] [Pharmacophore-Conditioned Diffusion Model for Ligand-Based De Novo Drug Design](https://arxiv.org/abs/2505.10545)
*Amira Alakhdar,Barnabas Poczos,Newell Washburn*

Main category: cs.LG

TL;DR: PharmaDiff is a pharmacophore-conditioned diffusion model for 3D molecular generation that integrates atom-based pharmacophore representation into the generative process, demonstrating superior performance in matching 3D pharmacophore constraints and achieving higher docking scores.


<details>
  <summary>Details</summary>
Motivation: Developing bioactive molecules for novel targets without structural or functional data is challenging. The motivation is to present an alternative approach using pharmacophore modeling.

Method: PharmaDiff uses a transformer-based architecture to integrate an atom-based representation of the 3D pharmacophore into the generative process for 3D molecular graphs.

Result: PharmaDiff outperforms ligand-based drug design methods in matching 3D pharmacophore constraints and achieves higher docking scores across a range of proteins without needing target protein structures.

Conclusion: PharmaDiff offers a powerful and flexible framework for rational drug design by combining pharmacophore modeling with 3D generative techniques.
...
### [422] [An AI-driven framework for the prediction of personalised health response to air pollution](https://arxiv.org/abs/2505.10556)
*Nazanin Zounemat Kermani,Sadjad Naderi,Claire H. Dilliway,Claire E. Heaney,Shrreya Behll,Boyang Chen,Hisham Abubakar-Waziri,Alexandra E. Porter,Marc Chadeau-Hyam,Fangxin Fang,Ian M. Adcock,Kian Fan Chung,Christopher C. Pain*

Main category: cs.LG

TL;DR: Recent advances in personal sensing and AI enable a novel workflow to predict personalized health responses to pollution.


<details>
  <summary>Details</summary>
Motivation: Air pollution and climate change cause serious health issues, and monitoring these is crucial.

Method: Integrating wearable data with environmental data and using an Adversarial Autoencoder neural network to predict health responses.

Result: The AI model accurately predicts health responses and transfer learning enhances its generalization.

Conclusion: This approach shows promise for personalized health monitoring and prediction.
...
### [423] [Sybil-based Virtual Data Poisoning Attacks in Federated Learning](https://arxiv.org/abs/2505.09983)
...
### [424] [Sybil-based Virtual Data Poisoning Attacks in Federated Learning](https://arxiv.org/abs/2505.09983)
*Changxun Zhu,Qilong Wu,Lingjuan Lyu,Shibei Xue*

Main category: cs.CR

TL;DR: This paper presents a novel sybil-based virtual data poisoning attack in federated learning, which reduces computational complexity using gradient matching and targets different model acquisition scenarios.


<details>
  <summary>Details</summary>
Motivation: To address the high cost of existing poisoning attack methods in federated learning.

Method: Proposes a sybil-based virtual data poisoning attack with a focus on reducing neural network computational complexity through gradient matching, and designs three schemes for target model acquisition in different scenarios.

Result: The proposed method outperforms other attack algorithms, especially in obtaining a global target model under non-independent uniformly distributed data.

Conclusion: A new sybil-based virtual data poisoning attack is introduced, which effectively reduces computational costs and achieves better performance than previous methods.
